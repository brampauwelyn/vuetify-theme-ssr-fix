...
declare const VCombobox: {
    new (...args: any[]): {
        ...
        $emit: ((event: "update:focused", focused: boolean) => void) & ((event: "update:menu", value: boolean) => void) & ((event: "update:search", value: string) => void);
        $el: any;
...
}>>> & vue.VNodeProps & vue.AllowedComponentProps & vue.ComponentCustomProps & (new <T_1 extends readonly any[], Item = ItemType<T_1>, ReturnObject extends boolean = true, Multiple extends boolean = false, V extends Value<Item, ReturnObject, Multiple> = Value<Item, ReturnObject, Multiple>>(props: {
    items?: T_1 | undefined;
