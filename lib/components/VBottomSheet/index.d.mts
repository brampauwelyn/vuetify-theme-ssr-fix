...
declare const VBottomSheet: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "onUpdate:modelValue"?: ((value: boolean) => any) | undefined;
        }, "absolute" | "location" | "origin" | "inset" | "transition" | "zIndex" | "style" | "eager" | "disabled" | "modelValue" | "locationStrategy" | "scrollStrategy" | "activatorProps" | "openOnClick" | "openOnHover" | "openOnFocus" | "closeOnContentClick" | "closeOnBack" | "contained" | "noClickAnimation" | "persistent" | "scrim" | "fullscreen" | "retainFocus" | "scrollable">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
