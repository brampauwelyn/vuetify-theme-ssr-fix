...
declare const VSnackbar: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "onUpdate:modelValue"?: ((v: boolean) => any) | undefined;
        }, "absolute" | "location" | "origin" | "transition" | "zIndex" | "style" | "eager" | "disabled" | "timeout" | "vertical" | "rounded" | "variant" | "modelValue" | "locationStrategy" | "activatorProps" | "openOnClick" | "openOnHover" | "openOnFocus" | "closeOnContentClick" | "closeOnBack" | "contained" | "multiLine">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
