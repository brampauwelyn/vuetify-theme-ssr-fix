...
var l
const o=function(e,t){const a=t?.rtl??zt,l=a[e.current.value]??!1
return{isRtl:l,rtl:a,rtlClasses:l?"v-locale--is-rtl":"v-locale--is-ltr"}}(a,e)
return{...a,...o}}function Jt(){const e=t.inject(Xt)
if(!e)throw new Error("[Vuetify] Could not find injected locale instance")
return e}function Qt(){const e=t.inject(Xt)
if(!e)throw new Error("[Vuetify] Could not find injected rtl instance")
return{isRtl:e.isRtl,rtlClasses:e.rtlClasses}}const ea=Symbol.for("vuetify:theme"),ta=a({theme:String},"theme")
function aa(e){const a={defaultTheme:"light",variations:{colors:[],lighten:0,darken:0},themes:{light:{dark:!1,colors:{background:"#FFFFFF",surface:"#FFFFFF","surface-bright":"#FFFFFF","surface-variant":"#424242","on-surface-variant":"#EEEEEE",primary:"#1867C0","primary-darken-1":"#1F5592",secondary:"#48A9A6","secondary-darken-1":"#018786",error:"#B00020",info:"#2196F3",success:"#4CAF50",warning:"#FB8C00"},variables:{"border-color":"#000000","border-opacity":.12,"high-emphasis-opacity":.87,"medium-emphasis-opacity":.6,"disabled-opacity":.38,"idle-opacity":.04,"hover-opacity":.04,"focus-opacity":.12,"selected-opacity":.08,"activated-opacity":.12,"pressed-opacity":.12,"dragged-opacity":.08,"theme-kbd":"#212529","theme-on-kbd":"#FFFFFF","theme-code":"#F5F5F5","theme-on-code":"#000000"}},dark:{dark:!0,colors:{background:"#121212",surface:"#212121","surface-bright":"#ccbfd6","surface-variant":"#a3a3a3","on-surface-variant":"#424242",primary:"#2196F3","primary-darken-1":"#277CC1",secondary:"#54B6B2","secondary-darken-1":"#48A9A6",error:"#CF6679",info:"#2196F3",success:"#4CAF50",warning:"#FB8C00"},variables:{"border-color":"#FFFFFF","border-opacity":.12,"high-emphasis-opacity":1,"medium-emphasis-opacity":.7,"disabled-opacity":.5,"idle-opacity":.1,"hover-opacity":.04,"focus-opacity":.12,"selected-opacity":.08,"activated-opacity":.12,"pressed-opacity":.16,"dragged-opacity":.08,"theme-kbd":"#212529","theme-on-kbd":"#FFFFFF","theme-code":"#343434","theme-on-code":"#CCCCCC"}}}},l=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:a
if(!e)return{...a,isDisabled:!0}
const t={}
for(const[l,o]of Object.entries(e.themes??{})){const e=o.dark||"dark"===l?a.themes?.dark:a.themes?.light
t[l]=L(e,o)}return L(a,{...e,themes:t})}(e),n=t.ref(l.defaultTheme),r=t.ref(l.themes),i=t.computed((()=>{const e={}
...
if(t)for(const a of["lighten","darken"]){const n="lighten"===a?ot:nt
for(const r of g(l.variations[a],1))o.colors[`${e}-${a}-${r}`]=et(n(Ue(t),r))}}for(const e of Object.keys(o.colors)){if(/^on-[a-z]/.test(e)||o.colors[`on-${e}`])continue
const t=`on-${e}`,a=Ue(o.colors[e])
o.colors[t]=st(a)}}return e})),s=t.computed((()=>i.value[n.value])),u=t.computed((()=>{const e=[]
s.value.dark&&na(e,":root",["color-scheme: dark"]),na(e,":root",ra(s.value))
for(const[t,a]of Object.entries(i.value))na(e,`.v-theme--${t}`,["color-scheme: "+(a.dark?"dark":"normal"),...ra(a)])
...
return t.provide(ea,r),r}function oa(){St("useTheme")
...
return{x:s-(o+l.left),y:u-(n+l.top),sx:p,sy:f,speed:g}}const Va=pa("fab-transition","center center","out-in"),Sa=pa("dialog-bottom-transition"),wa=pa("dialog-top-transition"),ka=pa("fade-transition"),xa=pa("scale-transition"),Na=pa("scroll-x-transition"),Ca=pa("scroll-x-reverse-transition"),_a=pa("scroll-y-transition"),Ia=pa("scroll-y-reverse-transition"),Pa=pa("slide-x-transition"),Ba=pa("slide-x-reverse-transition"),Aa=pa("slide-y-transition"),Ra=pa("slide-y-reverse-transition"),Ta=fa("expand-transition",ma()),Ea=fa("expand-x-transition",ma("",!0)),Da=a({defaults:Object,disabled:Boolean,reset:[Number,String],root:[Boolean,String],scoped:Boolean},"VDefaultsProvider"),$a=gt(!1)({name:"VDefaultsProvider",props:Da(),setup(e,a){let{slots:l}=a
...
function Fa(e){return{dimensionStyles:t.computed((()=>({height:h(e.height),maxHeight:h(e.maxHeight),maxWidth:h(e.maxWidth),minHeight:h(e.minHeight),minWidth:h(e.minWidth),width:h(e.width)})))}}const La=a({aspectRatio:[String,Number],contentClass:String,inline:Boolean,...l(),...Ma()},"VResponsive"),Oa=gt()({name:"VResponsive",props:La(),setup(e,a){let{slots:l}=a
const{aspectStyles:o}=function(e){return{aspectStyles:t.computed((()=>{const t=Number(e.aspectRatio)
return t?{paddingBottom:String(1/t*100)+"%"}:void 0}))}}(e),{dimensionStyles:n}=Fa(e)
return At((()=>t.createVNode("div",{class:["v-responsive",{"v-responsive--inline":e.inline},e.class],style:[n.value,e.style]},[t.createVNode("div",{class:"v-responsive__sizer",style:o.value},null),l.additional?.(),l.default&&t.createVNode("div",{class:["v-responsive__content",e.contentClass]},[l.default()])]))),{}}}),za=a({transition:{type:[Boolean,String,Object],default:"fade-transition",validator:e=>!0!==e}},"transition"),ja=(e,a)=>{let{slots:l}=a
...
function Ha(e,t){const a=e._observe?.[t.instance.$.uid]
a&&(a.observer.unobserve(e),delete e._observe[t.instance.$.uid])}const Wa={mounted:function(e,t){if(!n)return
...
!o||a.quiet&&!r.init||a.once&&!i&&!r.init||o(i,l,n),i&&a.once?Ha(e,t):r.init=!0}),r)
e._observe=Object(e._observe),e._observe[t.instance.$.uid]={init:!1,observer:i},i.observe(e)},unmounted:Ha},Ua=a({alt:String,cover:Boolean,draggable:{type:[Boolean,String],default:void 0},eager:Boolean,gradient:String,lazySrc:String,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},sizes:String,src:{type:[String,Object],default:""},crossorigin:String,referrerpolicy:String,srcset:String,position:String,...La(),...l(),...za()},"VImg"),Ya=gt()({name:"VImg",directives:{intersect:Wa},props:Ua(),emits:{loadstart:e=>!0,load:e=>!0,error:e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return t.createVNode(ja,{transition:e.transition,appear:!0},{default:()=>[t.withDirectives(l?t.createVNode("picture",{class:"v-img__picture"},[l,a]):a,[[t.vShow,"loaded"===u.value]])]})},k=()=>t.createVNode(ja,{transition:e.transition},{default:()=>[v.value.lazySrc&&"loaded"!==u.value&&t.createVNode("img",{class:["v-img__img","v-img__img--preload",S.value],style:{objectPosition:e.position},src:v.value.lazySrc,alt:e.alt,crossorigin:e.crossorigin,referrerpolicy:e.referrerpolicy,draggable:e.draggable},null)]}),x=()=>o.placeholder?t.createVNode(ja,{transition:e.transition,appear:!0},{default:()=>[("loading"===u.value||"error"===u.value&&!o.error)&&t.createVNode("div",{class:"v-img__placeholder"},[o.placeholder()])]}):null,N=()=>o.error?t.createVNode(ja,{transition:e.transition,appear:!0},{default:()=>["error"===u.value&&t.createVNode("div",{class:"v-img__error"},[o.error()])]}):null,C=()=>e.gradient?t.createVNode("div",{class:"v-img__gradient",style:{backgroundImage:`linear-gradient(${e.gradient})`}},null):null,_=t.shallowRef(!1)
{const e=t.watch(p,(t=>{t&&(requestAnimationFrame((()=>{requestAnimationFrame((()=>{_.value=!0}))})),e())}))}return At((()=>{const a=Oa.filterProps(e)
return t.withDirectives(t.createVNode(Oa,t.mergeProps({class:["v-img",{"v-img--booting":!_.value},e.class],style:[{width:h("auto"===e.width?c.value:e.width)},e.style]},a,{aspectRatio:p.value,"aria-label":e.alt,role:e.alt?"img":void 0}),{additional:()=>t.createVNode(t.Fragment,null,[t.createVNode(w,null,null),t.createVNode(k,null,null),t.createVNode(C,null,null),t.createVNode(x,null,null),t.createVNode(N,null,null)]),default:o.default}),[[t.resolveDirective("intersect"),{handler:f,options:e.options},null,{once:!0}]])})),{currentSrc:i,image:s,state:u,naturalWidth:c,naturalHeight:d}}}),Ga=a({border:[Boolean,Number,String]},"border")
function qa(e){let a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:wt()
...
return o}))
return{borderClasses:l}}function Ka(e){return Y((()=>{const t=[],a={}
...
var l
return e.value.text&&(je(e.value.text)?(a.color=e.value.text,a.caretColor=e.value.text):t.push(`text-${e.value.text}`)),{colorClasses:t,colorStyles:a}}))}function Xa(e,a){const l=t.computed((()=>({text:t.isRef(e)?e.value:a?e[a]:null}))),{colorClasses:o,colorStyles:n}=Ka(l)
return{textColorClasses:o,textColorStyles:n}}function Za(e,a){const l=t.computed((()=>({background:t.isRef(e)?e.value:a?e[a]:null}))),{colorClasses:o,colorStyles:n}=Ka(l)
...
function Qa(e){return{elevationClasses:t.computed((()=>{const a=t.isRef(e)?e.value:e.elevation,l=[]
return null==a||l.push(`elevation-${a}`),l}))}}const el=a({rounded:{type:[Boolean,Number,String],default:void 0}},"rounded")
...
return o}))
return{roundedClasses:l}}const al=[null,"prominent","default","comfortable","compact"],ll=a({absolute:Boolean,collapse:Boolean,color:String,density:{type:String,default:"default",validator:e=>al.includes(e)},extended:Boolean,extensionHeight:{type:[Number,String],default:48},flat:Boolean,floating:Boolean,height:{type:[Number,String],default:64},image:String,title:String,...Ga(),...l(),...Ja(),...el(),...ua({tag:"header"}),...ta()},"VToolbar"),ol=gt()({name:"VToolbar",props:ll(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=Za(t.toRef(e,"color")),{borderClasses:r}=qa(e),{elevationClasses:i}=Qa(e),{roundedClasses:s}=tl(e),{themeClasses:u}=la(e),{rtlClasses:c}=Qt(),d=t.shallowRef(!(!e.extended&&!l.extension?.())),v=t.computed((()=>parseInt(Number(e.height)+("prominent"===e.density?Number(e.height):0)-("comfortable"===e.density?8:0)-("compact"===e.density?16:0),10))),p=t.computed((()=>d.value?parseInt(Number(e.extensionHeight)+("prominent"===e.density?Number(e.extensionHeight):0)-("comfortable"===e.density?4:0)-("compact"===e.density?8:0),10):0))
return vt({VBtn:{variant:"text"}}),At((()=>{const a=!(!e.title&&!l.title),f=!(!l.image&&!e.image),m=l.extension?.()
return d.value=!(!e.extended&&!m),t.createVNode(e.tag,{class:["v-toolbar",{"v-toolbar--absolute":e.absolute,"v-toolbar--collapse":e.collapse,"v-toolbar--flat":e.flat,"v-toolbar--floating":e.floating,[`v-toolbar--density-${e.density}`]:!0},o.value,r.value,i.value,s.value,u.value,c,e.class],style:[n.value,e.style]},{default:()=>[f&&t.createVNode("div",{key:"image",class:"v-toolbar__image"},[l.image?t.createVNode($a,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},l.image):t.createVNode(Ya,{key:"image-img",cover:!0,src:e.image},null)]),t.createVNode($a,{defaults:{VTabs:{height:h(v.value)}}},{default:()=>[t.createVNode("div",{class:"v-toolbar__content",style:{height:h(v.value)}},[l.prepend&&t.createVNode("div",{class:"v-toolbar__prepend"},[l.prepend?.()]),a&&t.createVNode(da,{key:"title",text:e.title},{text:l.title}),l.default?.(),l.append&&t.createVNode("div",{class:"v-toolbar__append"},[l.append?.()])])]}),t.createVNode($a,{defaults:{VTabs:{height:h(p.value)}}},{default:()=>[t.createVNode(Ta,null,{default:()=>[d.value&&t.createVNode("div",{class:"v-toolbar__extension",style:{height:h(p.value)}},[m])]})]})]})})),{contentHeight:v,extensionHeight:p}}}),nl=a({scrollTarget:{type:String},scrollThreshold:{type:[String,Number],default:300}},"scroll")
function rl(){const e=t.shallowRef(!1)
t.onMounted((()=>{window.requestAnimationFrame((()=>{e.value=!0}))}))
return{ssrBootStyles:t.computed((()=>e.value?void 0:{transition:"none !important"})),isBooted:t.readonly(e)}}const il=a({scrollBehavior:String,modelValue:{type:Boolean,default:!0},location:{type:String,default:"top",validator:e=>["top","bottom"].includes(e)},...ll(),...$t(),...nl(),height:{type:[Number,String],default:64}},"VAppBar"),sl=gt()({name:"VAppBar",props:il(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
const{ssrBootStyles:g}=rl(),{layoutItemStyles:h}=Ft({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.toRef(e,"location"),layoutSize:m,elementSize:t.shallowRef(void 0),active:n,absolute:t.toRef(e,"absolute")})
...
function dl(e){let a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:wt()
...
return{colorClasses:o,colorStyles:n,variantClasses:l}}const gl=a({divided:Boolean,...Ga(),...l(),...cl(),...Ja(),...el(),...ua(),...ta(),...fl()},"VBtnGroup"),hl=gt()({name:"VBtnGroup",props:gl(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=la(e),{densityClasses:n}=dl(e),{borderClasses:r}=qa(e),{elevationClasses:i}=Qa(e),{roundedClasses:s}=tl(e)
...
return t.watch(u,(e=>{o.emit("group:selected",{value:e})})),{id:n,isSelected:u,toggle:()=>r.select(n,!u.value),select:e=>r.select(n,e),selectedClass:c,value:i,disabled:s,group:r}}function Sl(e,a){let l=!1
const o=t.reactive([]),n=Ht(e,"modelValue",[],(e=>null==e?[]:wl(o,T(e))),(t=>{const a=function(e,t){const a=[]
...
n.value=a??!l?[t]:[]}},disabled:t.toRef(e,"disabled"),prev:()=>s(o.length-1),next:()=>s(1),isSelected:e=>n.value.includes(e),selectedClass:t.computed((()=>e.selectedClass)),items:t.computed((()=>o)),getItemIndex:e=>function(e,t){const a=wl(e,[t])
...
const{isSelected:o,next:n,prev:r,select:i,selected:s}=Sl(e,kl)
...
function $l(e){return L({defaultSet:"mdi",sets:{...Dl,mdi:_l},aliases:{...Cl,vuetify:["M8.2241 14.2009L12 21L22 3H14.4459L8.2241 14.2009Z",["M7.26303 12.4733L7.00113 12L2 3H12.5261C12.5261 3 12.5261 3 12.5261 3L7.26303 12.4733Z",.6]],"vuetify-outline":"svg:M7.26 12.47 12.53 3H2L7.26 12.47ZM14.45 3 8.22 14.2 12 21 22 3H14.45ZM18.6 5 12 16.88 10.51 14.2 15.62 5ZM7.26 8.35 5.4 5H9.13L7.26 8.35Z"}},e)}const Ml=["x-small","small","default","large","x-large"],Fl=a({size:{type:[String,Number],default:"default"}},"size")
function Ll(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:wt()
return Y((()=>{let a,l
return G(Ml,e.size)?a=`${t}--size-${e.size}`:e.size&&(l={width:h(e.size),height:h(e.size)}),{sizeClasses:a,sizeStyles:l}}))}const Ol=a({color:String,start:Boolean,end:Boolean,icon:Il,...l(),...Fl(),...ua({tag:"i"}),...ta()},"VIcon"),zl=gt()({name:"VIcon",props:Ol(),setup(e,a){let{attrs:l,slots:o}=a
...
return{component:a.sets[n??a.defaultSet].component,icon:r}}))}})(t.computed((()=>n.value||e.icon))),{sizeClasses:s}=Ll(e),{textColorClasses:u,textColorStyles:c}=Xa(t.toRef(e,"color"))
...
t.onBeforeUnmount((()=>{n.disconnect()})),t.watch(l,((e,t)=>{t&&(n.unobserve(t),o.value=!1),e&&n.observe(e)}),{flush:"post"})}return{intersectionRef:l,isIntersecting:o}}const Hl=a({bgColor:String,color:String,indeterminate:[Boolean,String],modelValue:{type:[Number,String],default:0},rotate:{type:[Number,String],default:0},width:{type:[Number,String],default:4},...l(),...Fl(),...ua({tag:"div"}),...ta()},"VProgressCircular"),Wl=gt()({name:"VProgressCircular",props:Hl(),setup(e,a){let{slots:l}=a
const o=2*Math.PI*20,n=t.ref(),{themeClasses:r}=la(e),{sizeClasses:i,sizeStyles:s}=Ll(e),{textColorClasses:u,textColorStyles:c}=Xa(t.toRef(e,"color")),{textColorClasses:d,textColorStyles:v}=Xa(t.toRef(e,"bgColor")),{intersectionRef:p,isIntersecting:f}=jl(),{resizeRef:m,contentRect:g}=Rt(),y=t.computed((()=>Math.max(0,Math.min(100,parseFloat(e.modelValue))))),b=t.computed((()=>Number(e.width))),V=t.computed((()=>s.value?Number(e.size):g.value?g.value.width:Math.max(b.value,32))),S=t.computed((()=>20/(1-b.value/V.value)*2)),w=t.computed((()=>b.value/V.value*S.value)),k=t.computed((()=>h((100-y.value)/100*o)))
return t.watchEffect((()=>{p.value=n.value,m.value=n.value})),At((()=>t.createVNode(e.tag,{ref:n,class:["v-progress-circular",{"v-progress-circular--indeterminate":!!e.indeterminate,"v-progress-circular--visible":f.value,"v-progress-circular--disable-shrink":"disable-shrink"===e.indeterminate},r.value,i.value,u.value,e.class],style:[s.value,c.value,e.style],role:"progressbar","aria-valuemin":"0","aria-valuemax":"100","aria-valuenow":e.indeterminate?void 0:y.value},{default:()=>[t.createVNode("svg",{style:{transform:`rotate(calc(-90deg + ${Number(e.rotate)}deg))`},xmlns:"http://www.w3.org/2000/svg",viewBox:`0 0 ${S.value} ${S.value}`},[t.createVNode("circle",{class:["v-progress-circular__underlay",d.value],style:v.value,fill:"transparent",cx:"50%",cy:"50%",r:20,"stroke-width":w.value,"stroke-dasharray":o,"stroke-dashoffset":0},null),t.createVNode("circle",{class:"v-progress-circular__overlay",fill:"transparent",cx:"50%",cy:"50%",r:20,"stroke-width":w.value,"stroke-dasharray":o,"stroke-dashoffset":k.value},null)]),l.default&&t.createVNode("div",{class:"v-progress-circular__content"},[l.default({value:y.value})])]}))),{}}}),Ul={center:"center",top:"bottom",bottom:"top",left:"right",right:"left"},Yl=a({location:String},"location")
...
const{side:t,align:n}=ie(e.location.split(" ").length>1?e.location:`${e.location} center`,o)
...
return{locationStyles:n}}const ql=a({absolute:Boolean,active:{type:Boolean,default:!0},bgColor:String,bgOpacity:[Number,String],bufferValue:{type:[Number,String],default:0},clickable:Boolean,color:String,height:{type:[Number,String],default:4},indeterminate:Boolean,max:{type:[Number,String],default:100},modelValue:{type:[Number,String],default:0},reverse:Boolean,stream:Boolean,striped:Boolean,roundedBar:Boolean,...l(),...Yl({location:"top"}),...el(),...ua(),...ta()},"VProgressLinear"),Kl=gt()({name:"VProgressLinear",props:ql(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=Ht(e,"modelValue"),{isRtl:n,rtlClasses:r}=Qt(),{themeClasses:i}=la(e),{locationStyles:s}=Gl(e),{textColorClasses:u,textColorStyles:c}=Xa(e,"color"),{backgroundColorClasses:d,backgroundColorStyles:v}=Za(t.computed((()=>e.bgColor||e.color))),{backgroundColorClasses:p,backgroundColorStyles:f}=Za(e,"color"),{roundedClasses:m}=tl(e),{intersectionRef:g,isIntersecting:y}=jl(),b=t.computed((()=>parseInt(e.max,10))),V=t.computed((()=>parseInt(e.height,10))),S=t.computed((()=>parseFloat(e.bufferValue)/b.value*100)),w=t.computed((()=>parseFloat(o.value)/b.value*100)),k=t.computed((()=>n!==e.reverse)),x=t.computed((()=>e.indeterminate?"fade-transition":"slide-x-transition")),N=t.computed((()=>null==e.bgOpacity?e.bgOpacity:parseFloat(e.bgOpacity)))
...
function yo(e){ho||e.keyCode!==V.enter&&e.keyCode!==V.space||(ho=!0,po(e))}function bo(e){ho=!1,mo(e)}function Vo(e){ho&&(ho=!1,mo(e))}function So(e,t,a){const{value:l,modifiers:o}=t,n=vo(l)
...
e.addEventListener("touchstart",po,{passive:!0}),e.addEventListener("touchend",mo,{passive:!0}),e.addEventListener("touchmove",go,{passive:!0}),e.addEventListener("touchcancel",mo),e.addEventListener("mousedown",po),e.addEventListener("mouseup",mo),e.addEventListener("mouseleave",mo),e.addEventListener("keydown",yo),e.addEventListener("keyup",bo),e.addEventListener("blur",Vo),e.addEventListener("dragstart",mo,{passive:!0})}else!n&&a&&wo(e)}function wo(e){e.removeEventListener("mousedown",po),e.removeEventListener("touchstart",po),e.removeEventListener("touchend",mo),e.removeEventListener("touchmove",go),e.removeEventListener("touchcancel",mo),e.removeEventListener("mouseup",mo),e.removeEventListener("mouseleave",mo),e.removeEventListener("keydown",yo),e.removeEventListener("keyup",bo),e.removeEventListener("dragstart",mo),e.removeEventListener("blur",Vo)}const ko={mounted:function(e,t){So(e,t,!1)},unmounted:function(e){delete e._ripple,wo(e)},updated:function(e,t){if(t.value===t.oldValue)return
So(e,t,vo(t.oldValue))}},xo=a({active:{type:Boolean,default:void 0},symbol:{type:null,default:kl},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Il,appendIcon:Il,block:Boolean,slim:Boolean,stacked:Boolean,ripple:{type:[Boolean,Object],default:!0},text:String,...Ga(),...l(),...cl(),...Ma(),...Ja(),...bl(),...Xl(),...Yl(),...eo(),...el(),...oo(),...Fl(),...ua({tag:"button"}),...ta(),...fl({variant:"elevated"})},"VBtn"),No=gt()({name:"VBtn",directives:{Ripple:ko},props:xo(),emits:{"group:selected":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{themeClasses:n}=la(e),{borderClasses:r}=qa(e),{colorClasses:i,colorStyles:s,variantClasses:u}=ml(e),{densityClasses:c}=dl(e),{dimensionStyles:d}=Fa(e),{elevationClasses:v}=Qa(e),{loaderClasses:p}=Zl(e),{locationStyles:f}=Gl(e),{positionClasses:m}=to(e),{roundedClasses:g}=tl(e),{sizeClasses:h,sizeStyles:y}=Ll(e),b=Vl(e,e.symbol,!1),V=lo(e,l),S=t.computed((()=>void 0!==e.active?e.active:V.isLink.value?V.isActive?.value:b?.isSelected.value)),w=t.computed((()=>b?.disabled.value||e.disabled)),k=t.computed((()=>"elevated"===e.variant&&!(e.disabled||e.flat||e.border))),x=t.computed((()=>{if(void 0!==e.value&&"symbol"!=typeof e.value)return Object(e.value)===e.value?JSON.stringify(e.value,null,0):e.value}))
...
return t.withDirectives(t.createVNode(a,{type:"a"===a?void 0:"button",class:["v-btn",b?.selectedClass.value,{"v-btn--active":S.value,"v-btn--block":e.block,"v-btn--disabled":w.value,"v-btn--elevated":k.value,"v-btn--flat":e.flat,"v-btn--icon":!!e.icon,"v-btn--loading":e.loading,"v-btn--slim":e.slim,"v-btn--stacked":e.stacked},n.value,r.value,I?i.value:void 0,c.value,v.value,p.value,m.value,g.value,h.value,u.value,e.class],style:[I?s.value:void 0,d.value,f.value,y.value,e.style],disabled:w.value||void 0,href:V.href.value,onClick:N,value:x.value},{default:()=>[pl(!0,"v-btn"),!e.icon&&l&&t.createVNode("span",{key:"prepend",class:"v-btn__prepend"},[o.prepend?t.createVNode($a,{key:"prepend-defaults",disabled:!e.prependIcon,defaults:{VIcon:{icon:e.prependIcon}}},o.prepend):t.createVNode(zl,{key:"prepend-icon",icon:e.prependIcon},null)]),t.createVNode("span",{class:"v-btn__content","data-no-activator":""},[!o.default&&_?t.createVNode(zl,{key:"content-icon",icon:e.icon},null):t.createVNode($a,{key:"content-defaults",disabled:!_,defaults:{VIcon:{icon:e.icon}}},{default:()=>[o.default?.()??e.text]})]),!e.icon&&C&&t.createVNode("span",{key:"append",class:"v-btn__append"},[o.append?t.createVNode($a,{key:"append-defaults",disabled:!e.appendIcon,defaults:{VIcon:{icon:e.appendIcon}}},o.append):t.createVNode(zl,{key:"append-icon",icon:e.appendIcon},null)]),!!e.loading&&t.createVNode("span",{key:"loader",class:"v-btn__loader"},[o.loader?.()??t.createVNode(Wl,{color:"boolean"==typeof e.loading?void 0:e.loading,indeterminate:!0,size:"23",width:"2"},null)])]}),[[t.resolveDirective("ripple"),!w.value&&e.ripple,null]])})),{}}}),Co=a({...xo({icon:"$menu",variant:"text"})},"VAppBarNavIcon"),_o=gt()({name:"VAppBarNavIcon",props:Co(),setup(e,a){let{slots:l}=a
...
return At((()=>t.createVNode(da,t.mergeProps(e,{class:"v-app-bar-title"}),l))),{}}}),Po=ht("v-alert-title"),Bo=["success","info","warning","error"],Ao=a({border:{type:[Boolean,String],validator:e=>"boolean"==typeof e||["top","end","bottom","start"].includes(e)},borderColor:String,closable:Boolean,closeIcon:{type:Il,default:"$close"},closeLabel:{type:String,default:"$vuetify.close"},icon:{type:[Boolean,String,Function,Object],default:null},modelValue:{type:Boolean,default:!0},prominent:Boolean,title:String,text:String,type:{type:String,validator:e=>Bo.includes(e)},...l(),...cl(),...Ma(),...Ja(),...Yl(),...eo(),...el(),...ua(),...ta(),...fl({variant:"flat"})},"VAlert"),Ro=gt()({name:"VAlert",props:Ao(),emits:{"click:close":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=Ht(e,"modelValue"),r=t.computed((()=>{if(!1!==e.icon)return e.type?e.icon??`$${e.type}`:e.icon})),i=t.computed((()=>({color:e.color??e.type,variant:e.variant}))),{themeClasses:s}=la(e),{colorClasses:u,colorStyles:c,variantClasses:d}=ml(i),{densityClasses:v}=dl(e),{dimensionStyles:p}=Fa(e),{elevationClasses:f}=Qa(e),{locationStyles:m}=Gl(e),{positionClasses:g}=to(e),{roundedClasses:h}=tl(e),{textColorClasses:y,textColorStyles:b}=Xa(t.toRef(e,"borderColor")),{t:V}=Jt(),S=t.computed((()=>({"aria-label":V(e.closeLabel),onClick(e){n.value=!1,l("click:close",e)}})))
return()=>{const a=!(!o.prepend&&!r.value),l=!(!o.title&&!e.title),i=!(!o.close&&!e.closable)
return n.value&&t.createVNode(e.tag,{class:["v-alert",e.border&&{"v-alert--border":!!e.border,[`v-alert--border-${!0===e.border?"start":e.border}`]:!0},{"v-alert--prominent":e.prominent},s.value,u.value,v.value,f.value,g.value,h.value,d.value,e.class],style:[c.value,p.value,m.value,e.style],role:"alert"},{default:()=>[pl(!1,"v-alert"),e.border&&t.createVNode("div",{key:"border",class:["v-alert__border",y.value],style:b.value},null),a&&t.createVNode("div",{key:"prepend",class:"v-alert__prepend"},[o.prepend?t.createVNode($a,{key:"prepend-defaults",disabled:!r.value,defaults:{VIcon:{density:e.density,icon:r.value,size:e.prominent?44:28}}},o.prepend):t.createVNode(zl,{key:"prepend-icon",density:e.density,icon:r.value,size:e.prominent?44:28},null)]),t.createVNode("div",{class:"v-alert__content"},[l&&t.createVNode(Po,{key:"title"},{default:()=>[o.title?.()??e.title]}),o.text?.()??e.text,o.default?.()]),o.append&&t.createVNode("div",{key:"append",class:"v-alert__append"},[o.append()]),i&&t.createVNode("div",{key:"close",class:"v-alert__close"},[o.close?t.createVNode($a,{key:"close-defaults",defaults:{VBtn:{icon:e.closeIcon,size:"x-small",variant:"text"}}},{default:()=>[o.close?.({props:S.value})]}):t.createVNode(No,t.mergeProps({key:"close-btn",icon:e.closeIcon,size:"x-small",variant:"text"},S.value),null)])]})}}}),To=a({text:String,clickable:Boolean,...l(),...ta()},"VLabel"),Eo=gt()({name:"VLabel",props:To(),setup(e,a){let{slots:l}=a
return At((()=>t.createVNode("label",{class:["v-label",{"v-label--clickable":e.clickable},e.class],style:e.style},[e.text,l.default?.()]))),{}}}),Do=Symbol.for("vuetify:selection-control-group"),$o=a({color:String,disabled:{type:Boolean,default:null},defaultsTarget:String,error:Boolean,id:String,inline:Boolean,falseIcon:Il,trueIcon:Il,ripple:{type:Boolean,default:!0},multiple:{type:Boolean,default:null},name:String,readonly:{type:Boolean,default:null},modelValue:null,type:String,valueComparator:{type:Function,default:p},...l(),...cl(),...ta()},"SelectionControlGroup"),Mo=a({...$o({defaultsTarget:"VSelectionControl"})},"VSelectionControlGroup"),Fo=gt()({name:"VSelectionControlGroup",props:Mo(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=Ht(e,"modelValue"),n=Nt(),r=t.computed((()=>e.id||`v-selection-control-group-${n}`)),i=t.computed((()=>e.name||r.value)),s=new Set
return t.provide(Do,{modelValue:o,forceUpdate:()=>{s.forEach((e=>e()))},onForceUpdate:e=>{s.add(e),t.onScopeDispose((()=>{s.delete(e)}))}}),vt({[e.defaultsTarget]:{color:t.toRef(e,"color"),disabled:t.toRef(e,"disabled"),density:t.toRef(e,"density"),error:t.toRef(e,"error"),inline:t.toRef(e,"inline"),modelValue:o,multiple:t.computed((()=>!!e.multiple||null==e.multiple&&Array.isArray(o.value))),name:i,falseIcon:t.toRef(e,"falseIcon"),trueIcon:t.toRef(e,"trueIcon"),readonly:t.toRef(e,"readonly"),ripple:t.toRef(e,"ripple"),type:t.toRef(e,"type"),valueComparator:t.toRef(e,"valueComparator")}}),At((()=>t.createVNode("div",{class:["v-selection-control-group",{"v-selection-control-group--inline":e.inline},e.class],style:e.style,role:"radio"===e.type?"radiogroup":void 0},[l.default?.()]))),{}}}),Lo=a({label:String,baseColor:String,trueValue:null,falseValue:null,value:null,...l(),...$o()},"VSelectionControl")
const Oo=gt()({name:"VSelectionControl",directives:{Ripple:ko},inheritAttrs:!1,props:Lo(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{group:n,densityClasses:r,icon:i,model:s,textColorClasses:u,textColorStyles:c,backgroundColorClasses:d,backgroundColorStyles:v,trueValue:p}=function(e){const a=t.inject(Do,void 0),{densityClasses:l}=dl(e),o=Ht(e,"modelValue"),n=t.computed((()=>void 0!==e.trueValue?e.trueValue:void 0===e.value||e.value)),r=t.computed((()=>void 0!==e.falseValue&&e.falseValue)),i=t.computed((()=>!!e.multiple||null==e.multiple&&Array.isArray(o.value))),s=t.computed({get(){const t=a?a.modelValue.value:o.value
return i.value?T(t).some((t=>e.valueComparator(t,n.value))):e.valueComparator(t,n.value)},set(t){if(e.readonly)return
const l=t?n.value:r.value
let s=l
i.value&&(s=t?[...T(o.value),l]:T(o.value).filter((t=>!e.valueComparator(t,n.value)))),a?a.modelValue.value=s:o.value=s}}),{textColorClasses:u,textColorStyles:c}=Xa(t.computed((()=>{if(!e.error&&!e.disabled)return s.value?e.color:e.baseColor}))),{backgroundColorClasses:d,backgroundColorStyles:v}=Za(t.computed((()=>!s.value||e.error||e.disabled?void 0:e.color))),p=t.computed((()=>s.value?e.trueIcon:e.falseIcon))
...
return At((()=>{const a=C(Oo.filterProps(e),["modelValue"])
return t.createVNode(Oo,t.mergeProps(a,{modelValue:n.value,"onUpdate:modelValue":[e=>n.value=e,r],class:["v-checkbox-btn",e.class],style:e.style,type:"checkbox",falseIcon:i.value,trueIcon:s.value,"aria-checked":o.value?"mixed":void 0}),l)})),{}}})
function Ho(e){const{t:a}=Jt()
...
return t.createVNode(zl,{icon:e[`${o}Icon`],"aria-label":i,onClick:r},null)}}}const Wo=a({active:Boolean,color:String,messages:{type:[Array,String],default:()=>[]},...l(),...za({transition:{component:Aa,leaveAbsolute:!0,group:!0}})},"VMessages"),Uo=gt()({name:"VMessages",props:Wo(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>T(e.messages))),{textColorClasses:n,textColorStyles:r}=Xa(t.computed((()=>e.color)))
return At((()=>t.createVNode(ja,{transition:e.transition,tag:"div",class:["v-messages",n.value,e.class],style:[r.value,e.style],role:"alert","aria-live":"polite"},{default:()=>[e.active&&o.value.map(((e,a)=>t.createVNode("div",{class:"v-messages__message",key:`${a}-${o.value}`},[l.message?l.message({message:e}):e])))]}))),{}}}),Yo=a({focused:Boolean,"onUpdate:focused":K()},"focus")
function Go(e){let a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:wt()
const l=Ht(e,"focused"),o=t.computed((()=>({[`${a}--focused`]:l.value})))
function n(){l.value=!0}function r(){l.value=!1}return{focusClasses:o,isFocused:l,focus:n,blur:r}}const qo=Symbol.for("vuetify:form"),Ko=a({disabled:Boolean,fastFail:Boolean,readonly:Boolean,modelValue:{type:Boolean,default:null},validateOn:{type:String,default:"input"}},"form")
function Xo(){return t.inject(qo,null)}const Zo=a({disabled:{type:Boolean,default:null},error:Boolean,errorMessages:{type:[Array,String],default:()=>[]},maxErrors:{type:[Number,String],default:1},name:String,label:String,readonly:{type:Boolean,default:null},rules:{type:Array,default:()=>[]},modelValue:null,validateOn:String,validationValue:null,...Yo()},"validation")
function Jo(e){let a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:wt(),l=arguments.length>2&&void 0!==arguments[2]?arguments[2]:Nt()
const o=Ht(e,"modelValue"),n=t.computed((()=>void 0===e.validationValue?o.value:e.validationValue)),r=Xo(),i=t.ref([]),s=t.shallowRef(!0),u=t.computed((()=>!(!T(""===o.value?null:o.value).length&&!T(""===n.value?null:n.value).length))),c=t.computed((()=>!!(e.disabled??r?.isDisabled.value))),d=t.computed((()=>!!(e.readonly??r?.isReadonly.value))),v=t.computed((()=>e.errorMessages?.length?T(e.errorMessages).concat(i.value).slice(0,Math.max(0,+e.maxErrors)):i.value)),p=t.computed((()=>{let t=(e.validateOn??r?.validateOn.value)||"input"
"lazy"===t&&(t="input lazy")
...
else if(e.focused){const a=t.watch((()=>e.focused),(e=>{e||V(),a()}))}}))})),jt((()=>p.value.blur),(()=>{t.watch((()=>e.focused),(e=>{e||V()}))})),t.watch(f,(()=>{r?.update(h.value,f.value,v.value)})),{errorMessages:v,isDirty:u,isDisabled:c,isReadonly:d,isPristine:s,isValid:f,isValidating:m,reset:y,resetValidation:b,validate:V,validationClasses:g}}const Qo=a({id:String,appendIcon:Il,centerAffix:{type:Boolean,default:!0},prependIcon:Il,hideDetails:[Boolean,String],hideSpinButtons:Boolean,hint:String,persistentHint:Boolean,messages:{type:[Array,String],default:()=>[]},direction:{type:String,default:"horizontal",validator:e=>["horizontal","vertical"].includes(e)},"onClick:prepend":K(),"onClick:append":K(),...l(),...cl(),...Zo()},"VInput"),en=gt()({name:"VInput",props:{...Qo()},emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
const{densityClasses:r}=dl(e),{rtlClasses:i}=Qt(),{InputIcon:s}=Ho(e),u=Nt(),c=t.computed((()=>e.id||`input-${u}`)),d=t.computed((()=>`${c.value}-messages`)),{errorMessages:v,isDirty:p,isDisabled:f,isReadonly:m,isPristine:g,isValid:h,isValidating:y,reset:b,resetValidation:V,validate:S,validationClasses:w}=Jo(e,"v-input",c),k=t.computed((()=>({id:c,messagesId:d,isDirty:p,isDisabled:f,isReadonly:m,isPristine:g,isValid:h,isValidating:y,reset:b,resetValidation:V,validate:S}))),x=t.computed((()=>e.errorMessages?.length||!g.value&&v.value.length?v.value:e.hint&&(e.persistentHint||e.focused)?e.hint:e.messages))
...
return t.createVNode("div",{class:["v-input",`v-input--${e.direction}`,{"v-input--center-affix":e.centerAffix,"v-input--hide-spin-buttons":e.hideSpinButtons},r.value,i,w.value,e.class],style:e.style},[a&&t.createVNode("div",{key:"prepend",class:"v-input__prepend"},[o.prepend?.(k.value),e.prependIcon&&t.createVNode(s,{key:"prepend-icon",name:"prepend"},null)]),o.default&&t.createVNode("div",{class:"v-input__control"},[o.default?.(k.value)]),l&&t.createVNode("div",{key:"append",class:"v-input__append"},[e.appendIcon&&t.createVNode(s,{key:"append-icon",name:"append"},null),o.append?.(k.value)]),u&&t.createVNode("div",{class:"v-input__details"},[t.createVNode(Uo,{id:d.value,active:n,messages:x.value},{message:o.message}),o.details?.(k.value)])])})),{reset:b,resetValidation:V,validate:S,isValid:h,errorMessages:v}}}),tn=a({...Qo(),...C(zo(),["inline"])},"VCheckbox"),an=gt()({name:"VCheckbox",inheritAttrs:!1,props:tn(),emits:{"update:modelValue":e=>!0,"update:focused":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const n=Ht(e,"modelValue"),{isFocused:r,focus:i,blur:s}=Go(e),u=Nt(),c=t.computed((()=>e.id||`checkbox-${u}`))
return At((()=>{const[a,u]=R(l),d=en.filterProps(e),v=jo.filterProps(e)
return t.createVNode(en,t.mergeProps({class:["v-checkbox",e.class]},a,d,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,id:c.value,focused:r.value,style:e.style}),{...o,default:e=>{let{id:a,messagesId:l,isDisabled:r,isReadonly:c}=e
return t.createVNode(jo,t.mergeProps(v,{id:a.value,"aria-describedby":l.value,disabled:r.value,readonly:c.value},u,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,onFocus:i,onBlur:s}),o)}})})),{}}}),ln=a({start:Boolean,end:Boolean,icon:Il,image:String,text:String,...l(),...cl(),...el(),...Fl(),...ua(),...ta(),...fl({variant:"flat"})},"VAvatar"),on=gt()({name:"VAvatar",props:ln(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=la(e),{colorClasses:n,colorStyles:r,variantClasses:i}=ml(e),{densityClasses:s}=dl(e),{roundedClasses:u}=tl(e),{sizeClasses:c,sizeStyles:d}=Ll(e)
return At((()=>t.createVNode(e.tag,{class:["v-avatar",{"v-avatar--start":e.start,"v-avatar--end":e.end},o.value,n.value,s.value,u.value,c.value,i.value,e.class],style:[r.value,d.value,e.style]},{default:()=>[e.image?t.createVNode(Ya,{key:"image",src:e.image,alt:"",cover:!0},null):e.icon?t.createVNode(zl,{key:"icon",icon:e.icon},null):l.default?.()??e.text,pl(!1,"v-avatar")]}))),{}}}),nn=Symbol.for("vuetify:v-chip-group"),rn=a({column:Boolean,filter:Boolean,valueComparator:{type:Function,default:p},...l(),...yl({selectedClass:"v-chip--selected"}),...ua(),...ta(),...fl({variant:"tonal"})},"VChipGroup"),sn=gt()({name:"VChipGroup",props:rn(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=la(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=Sl(e,nn)
return vt({VChip:{color:t.toRef(e,"color"),disabled:t.toRef(e,"disabled"),filter:t.toRef(e,"filter"),variant:t.toRef(e,"variant")}}),At((()=>t.createVNode(e.tag,{class:["v-chip-group",{"v-chip-group--column":e.column},o.value,e.class],style:e.style},{default:()=>[l.default?.({isSelected:n,select:r,next:i,prev:s,selected:u.value})]}))),{}}}),un=a({activeClass:String,appendAvatar:String,appendIcon:Il,closable:Boolean,closeIcon:{type:Il,default:"$delete"},closeLabel:{type:String,default:"$vuetify.close"},draggable:Boolean,filter:Boolean,filterIcon:{type:String,default:"$complete"},label:Boolean,link:{type:Boolean,default:void 0},pill:Boolean,prependAvatar:String,prependIcon:Il,ripple:{type:[Boolean,Object],default:!0},text:String,modelValue:{type:Boolean,default:!0},onClick:K(),onClickOnce:K(),...Ga(),...l(),...cl(),...Ja(),...bl(),...el(),...oo(),...Fl(),...ua({tag:"span"}),...ta(),...fl({variant:"tonal"})},"VChip"),cn=gt()({name:"VChip",directives:{Ripple:ko},props:un(),emits:{"click:close":e=>!0,"update:modelValue":e=>!0,"group:selected":e=>!0,click:e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{t:r}=Jt(),{borderClasses:i}=qa(e),{colorClasses:s,colorStyles:u,variantClasses:c}=ml(e),{densityClasses:d}=dl(e),{elevationClasses:v}=Qa(e),{roundedClasses:p}=tl(e),{sizeClasses:f}=Ll(e),{themeClasses:m}=la(e),g=Ht(e,"modelValue"),h=Vl(e,nn,!1),y=lo(e,l),b=t.computed((()=>!1!==e.link&&y.isLink.value)),V=t.computed((()=>!e.disabled&&!1!==e.link&&(!!h||e.link||y.isClickable.value))),S=t.computed((()=>({"aria-label":r(e.closeLabel),onClick(e){e.stopPropagation(),g.value=!1,o("click:close",e)}})))
...
return g.value&&t.withDirectives(t.createVNode(a,{class:["v-chip",{"v-chip--disabled":e.disabled,"v-chip--label":e.label,"v-chip--link":V.value,"v-chip--filter":x,"v-chip--pill":e.pill},m.value,i.value,_?s.value:void 0,d.value,v.value,p.value,f.value,c.value,h?.selectedClass.value,e.class],style:[_?u.value:void 0,e.style],disabled:e.disabled||void 0,draggable:e.draggable,href:y.href.value,tabindex:V.value?0:void 0,onClick:w,onKeydown:V.value&&!b.value&&k},{default:()=>[pl(V.value,"v-chip"),x&&t.createVNode(Ea,{key:"filter"},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-chip__filter"},[n.filter?t.createVNode($a,{key:"filter-defaults",disabled:!e.filterIcon,defaults:{VIcon:{icon:e.filterIcon}}},n.filter):t.createVNode(zl,{key:"filter-icon",icon:e.filterIcon},null)]),[[t.vShow,h.isSelected.value]])]}),C&&t.createVNode("div",{key:"prepend",class:"v-chip__prepend"},[n.prepend?t.createVNode($a,{key:"prepend-defaults",disabled:!N,defaults:{VAvatar:{image:e.prependAvatar,start:!0},VIcon:{icon:e.prependIcon,start:!0}}},n.prepend):t.createVNode(t.Fragment,null,[e.prependIcon&&t.createVNode(zl,{key:"prepend-icon",icon:e.prependIcon,start:!0},null),e.prependAvatar&&t.createVNode(on,{key:"prepend-avatar",image:e.prependAvatar,start:!0},null)])]),t.createVNode("div",{class:"v-chip__content"},[n.default?.({isSelected:h?.isSelected.value,selectedClass:h?.selectedClass.value,select:h?.select,toggle:h?.toggle,value:h?.value.value,disabled:e.disabled})??e.text]),o&&t.createVNode("div",{key:"append",class:"v-chip__append"},[n.append?t.createVNode($a,{key:"append-defaults",disabled:!l,defaults:{VAvatar:{end:!0,image:e.appendAvatar},VIcon:{end:!0,icon:e.appendIcon}}},n.append):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(zl,{key:"append-icon",end:!0,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(on,{key:"append-avatar",end:!0,image:e.appendAvatar},null)])]),r&&t.createVNode("div",t.mergeProps({key:"close",class:"v-chip__close"},S.value),[n.close?t.createVNode($a,{key:"close-defaults",defaults:{VIcon:{icon:e.closeIcon,size:"x-small"}}},n.close):t.createVNode(zl,{key:"close-icon",icon:e.closeIcon,size:"x-small"},null)])]}),[[t.resolveDirective("ripple"),V.value&&e.ripple,null]])}}}),dn=Symbol.for("vuetify:list")
function vn(){const e=t.inject(dn,{hasPrepend:t.shallowRef(!1),updateHasPrepend:()=>null}),a={hasPrepend:t.shallowRef(!1),updateHasPrepend:e=>{e&&(a.hasPrepend.value=e)}}
return t.provide(dn,a),e}function pn(){return t.inject(dn,null)}const fn={open:e=>{let{id:t,value:a,opened:l,parents:o}=e
if(a){const e=new Set
e.add(t)
let a=o.get(t)
for(;null!=a;)e.add(a),a=o.get(a)
return e}return l.delete(t),l},select:()=>null},mn={open:e=>{let{id:t,value:a,opened:l,parents:o}=e
if(a){let e=o.get(t)
for(l.add(t);null!=e&&e!==t;)l.add(e),e=o.get(e)
return l}return l.delete(t),l},select:()=>null},gn={open:mn.open,select:e=>{let{id:t,value:a,opened:l,parents:o}=e
if(!a)return l
const n=[]
let r=o.get(t)
for(;null!=r;)n.push(r),r=o.get(r)
return new Set(n)}},hn=e=>{const a={select:a=>{let{id:l,value:o,selected:n}=a
...
case"leaf":return(e=>{const a=hn(e)
return{select:e=>{let{id:l,selected:o,children:n,...r}=e
return l=t.toRaw(l),n.has(l)?o:a.select({id:l,selected:o,children:n,...r})},in:a.in,out:a.out}})(e.mandatory)
case"independent":return hn(e.mandatory)
...
switch(e.openStrategy){case"list":return gn
case"single":return fn
case"multiple":default:return mn}})),s=Ht(e,"selected",e.selected,(e=>r.value.in(e,l.value,o.value)),(e=>r.value.out(e,l.value,o.value)))
...
return t.provide(bn,d),d.root},kn=(e,a)=>{const l=t.inject(bn,Vn),o=Symbol(Nt()),n=t.computed((()=>void 0!==e.value?e.value:o)),r={...l,id:n,open:(e,t)=>l.root.open(n.value,e,t),openOnSelect:(e,t)=>l.root.openOnSelect(n.value,e,t),isOpen:t.computed((()=>l.root.opened.value.has(n.value))),parent:t.computed((()=>l.root.parents.value.get(n.value))),select:(e,t)=>l.root.select(n.value,e,t),isSelected:t.computed((()=>"on"===l.root.selected.value.get(t.toRaw(n.value)))),isIndeterminate:t.computed((()=>"indeterminate"===l.root.selected.value.get(n.value))),isLeaf:t.computed((()=>!l.root.children.value.get(n.value))),isGroupActivator:l.isGroupActivator}
return!l.isGroupActivator&&l.root.register(n.value,l.id.value,a),t.onBeforeUnmount((()=>{!l.isGroupActivator&&l.root.unregister(n.value)})),a&&t.provide(bn,r),r},xn=mt({name:"VListGroupActivator",setup(e,a){let{slots:l}=a
return(()=>{const e=t.inject(bn,Vn)
t.provide(bn,{...e,isGroupActivator:!0})})(),()=>l.default?.()}}),Nn=a({activeColor:String,baseColor:String,color:String,collapseIcon:{type:Il,default:"$collapse"},expandIcon:{type:Il,default:"$expand"},prependIcon:Il,appendIcon:Il,fluid:Boolean,subgroup:Boolean,title:String,value:null,...l(),...ua()},"VListGroup"),Cn=gt()({name:"VListGroup",props:Nn(),setup(e,a){let{slots:l}=a
const{isOpen:o,open:n,id:r}=kn(t.toRef(e,"value"),!0),i=t.computed((()=>`v-list-group--id-${String(r.value)}`)),s=pn(),{isBooted:u}=rl()
...
return At((()=>t.createVNode(e.tag,{class:["v-list-group",{"v-list-group--prepend":s?.hasPrepend.value,"v-list-group--fluid":e.fluid,"v-list-group--subgroup":e.subgroup,"v-list-group--open":o.value},e.class],style:e.style},{default:()=>[l.activator&&t.createVNode($a,{defaults:p.value},{default:()=>[t.createVNode(xn,null,{default:()=>[l.activator({props:d.value,isOpen:o.value})]})]}),t.createVNode(ja,{transition:{component:Ta},disabled:!u.value},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-list-group__items",role:"group","aria-labelledby":i.value},[l.default?.()]),[[t.vShow,o.value]])]})]}))),{}}}),_n=ht("v-list-item-subtitle"),In=ht("v-list-item-title"),Pn=a({active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Il,baseColor:String,disabled:Boolean,lines:String,link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Il,ripple:{type:[Boolean,Object],default:!0},slim:Boolean,subtitle:[String,Number,Boolean],title:[String,Number,Boolean],value:null,onClick:K(),onClickOnce:K(),...Ga(),...l(),...cl(),...Ma(),...Ja(),...el(),...oo(),...ua(),...ta(),...fl({variant:"text"})},"VListItem"),Bn=gt()({name:"VListItem",directives:{Ripple:ko},props:Pn(),emits:{click:e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
const r=lo(e,l),i=t.computed((()=>void 0===e.value?r.href.value:e.value)),{select:s,isSelected:u,isIndeterminate:c,isGroupActivator:d,root:v,parent:p,openOnSelect:f}=kn(i,!1),m=pn(),g=t.computed((()=>!1!==e.active&&(e.active||r.isActive?.value||u.value))),h=t.computed((()=>!1!==e.link&&r.isLink.value)),y=t.computed((()=>!e.disabled&&!1!==e.link&&(e.link||r.isClickable.value||null!=e.value&&!!m))),b=t.computed((()=>e.rounded||e.nav)),V=t.computed((()=>e.color??e.activeColor)),S=t.computed((()=>({color:g.value?V.value??e.baseColor:e.baseColor,variant:e.variant})))
t.watch((()=>r.isActive?.value),(e=>{e&&null!=p.value&&v.open(p.value,!0),e&&f(e)}),{immediate:!0})
const{themeClasses:w}=la(e),{borderClasses:k}=qa(e),{colorClasses:x,colorStyles:N,variantClasses:C}=ml(S),{densityClasses:_}=dl(e),{dimensionStyles:I}=Fa(e),{elevationClasses:P}=Qa(e),{roundedClasses:B}=tl(b),A=t.computed((()=>e.lines?`v-list-item--${e.lines}-line`:void 0)),R=t.computed((()=>({isActive:g.value,select:s,isSelected:u.value,isIndeterminate:c.value})))
...
var d,v
return m?.updateHasPrepend(c),e.activeColor&&(d="active-color",v=["color","base-color"],v=Array.isArray(v)?v.slice(0,-1).map((e=>`'${e}'`)).join(", ")+` or '${v.at(-1)}'`:`'${v}'`,t.warn(`[Vuetify UPGRADE] '${d}' is deprecated, use ${v} instead.`)),t.withDirectives(t.createVNode(a,{class:["v-list-item",{"v-list-item--active":g.value,"v-list-item--disabled":e.disabled,"v-list-item--link":y.value,"v-list-item--nav":e.nav,"v-list-item--prepend":!c&&m?.hasPrepend.value,"v-list-item--slim":e.slim,[`${e.activeClass}`]:e.activeClass&&g.value},w.value,k.value,x.value,_.value,P.value,A.value,B.value,C.value,e.class],style:[N.value,I.value,e.style],href:r.href.value,tabindex:y.value?m?-2:0:void 0,onClick:T,onKeydown:y.value&&!h.value&&E},{default:()=>[pl(y.value||g.value,"v-list-item"),c&&t.createVNode("div",{key:"prepend",class:"v-list-item__prepend"},[o.prepend?t.createVNode($a,{key:"prepend-defaults",disabled:!u,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon},VListItemAction:{start:!0}}},{default:()=>[o.prepend?.(R.value)]}):t.createVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(on,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(zl,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)]),t.createVNode("div",{class:"v-list-item__spacer"},null)]),t.createVNode("div",{class:"v-list-item__content","data-no-activator":""},[l&&t.createVNode(In,{key:"title"},{default:()=>[o.title?.({title:e.title})??e.title]}),n&&t.createVNode(_n,{key:"subtitle"},{default:()=>[o.subtitle?.({subtitle:e.subtitle})??e.subtitle]}),o.default?.(R.value)]),s&&t.createVNode("div",{key:"append",class:"v-list-item__append"},[o.append?t.createVNode($a,{key:"append-defaults",disabled:!i,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon},VListItemAction:{end:!0}}},{default:()=>[o.append?.(R.value)]}):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(zl,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(on,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)]),t.createVNode("div",{class:"v-list-item__spacer"},null)])]}),[[t.resolveDirective("ripple"),y.value&&e.ripple]])})),{}}}),An=a({color:String,inset:Boolean,sticky:Boolean,title:String,...l(),...ua()},"VListSubheader"),Rn=gt()({name:"VListSubheader",props:An(),setup(e,a){let{slots:l}=a
const{textColorClasses:o,textColorStyles:n}=Xa(t.toRef(e,"color"))
return At((()=>{const a=!(!l.default&&!e.title)
return t.createVNode(e.tag,{class:["v-list-subheader",{"v-list-subheader--inset":e.inset,"v-list-subheader--sticky":e.sticky},o.value,e.class],style:[{textColorStyles:n},e.style]},{default:()=>[a&&t.createVNode("div",{class:"v-list-subheader__text"},[l.default?.()??e.title])]})})),{}}}),Tn=a({color:String,inset:Boolean,length:[Number,String],thickness:[Number,String],vertical:Boolean,...l(),...ta()},"VDivider"),En=gt()({name:"VDivider",props:Tn(),setup(e,a){let{attrs:l}=a
const{themeClasses:o}=la(e),{textColorClasses:n,textColorStyles:r}=Xa(t.toRef(e,"color")),i=t.computed((()=>{const t={}
...
return At((()=>t.createVNode("hr",{class:[{"v-divider":!0,"v-divider--inset":e.inset,"v-divider--vertical":e.vertical},o.value,n.value,e.class],style:[i.value,r.value,e.style],"aria-orientation":l.role&&"separator"!==l.role?void 0:e.vertical?"vertical":"horizontal",role:`${l.role||"separator"}`},null))),{}}}),Dn=a({items:Array,returnObject:Boolean},"VListChildren"),$n=gt()({name:"VListChildren",props:Dn(),setup(e,a){let{slots:l}=a
return vn(),()=>l.default?.()??e.items?.map((a=>{let{children:o,props:n,type:r,raw:i}=a
if("divider"===r)return l.divider?.({props:n})??t.createVNode(En,n,null)
if("subheader"===r)return l.subheader?.({props:n})??t.createVNode(Rn,n,null)
const s={subtitle:l.subtitle?e=>l.subtitle?.({...e,item:i}):void 0,prepend:l.prepend?e=>l.prepend?.({...e,item:i}):void 0,append:l.append?e=>l.append?.({...e,item:i}):void 0,title:l.title?e=>l.title?.({...e,item:i}):void 0},u=Cn.filterProps(n)
return o?t.createVNode(Cn,t.mergeProps({value:n?.value},u),{activator:a=>{let{props:o}=a
const r={...n,...o,value:e.returnObject?i:n.value}
return l.header?l.header({props:r}):t.createVNode(Bn,r,s)},default:()=>t.createVNode($n,{items:o},l)}):l.item?l.item({props:n}):t.createVNode(Bn,t.mergeProps(n,{value:e.returnObject?i:n.value}),s)}))}}),Mn=a({items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemChildren:{type:[Boolean,String,Array,Function],default:"children"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},returnObject:Boolean,valueComparator:{type:Function,default:p}},"list-items")
function Fn(e,t){const a=m(t,e.itemTitle,t),l=m(t,e.itemValue,a),o=m(t,e.itemChildren),n={title:a,value:l,...!0===e.itemProps?"object"!=typeof t||null==t||Array.isArray(t)?void 0:"children"in t?C(t,["children"]):t:m(t,e.itemProps)}
return{title:String(n.title??""),value:n.value,props:n,children:Array.isArray(o)?Ln(e,o):void 0,raw:t}}function Ln(e,t){const a=[]
for(const l of t)a.push(Fn(e,l))
return a}function On(e){const a=t.computed((()=>Ln(e,e.items))),l=t.computed((()=>a.value.some((e=>null===e.value))))
return{items:a,transformIn:function(t){return l.value||(t=t.filter((e=>null!==e))),t.map((t=>e.returnObject&&"string"==typeof t?Fn(e,t):a.value.find((a=>e.valueComparator(t,a.value)))||Fn(e,t)))},transformOut:function(t){return e.returnObject?t.map((e=>{let{raw:t}=e
return t})):t.map((e=>{let{value:t}=e
return t}))}}}function zn(e,t){const a=m(t,e.itemType,"item"),l=function(e){return"string"==typeof e||"number"==typeof e||"boolean"==typeof e}(t)?t:m(t,e.itemTitle),o=m(t,e.itemValue,void 0),n=m(t,e.itemChildren),r={title:l,value:o,...!0===e.itemProps?C(t,["children"]):m(t,e.itemProps)}
return{type:a,title:r.title,value:r.value,props:r,children:"item"===a&&n?jn(e,n):void 0,raw:t}}function jn(e,t){const a=[]
for(const l of t)a.push(zn(e,l))
return a}const Hn=a({baseColor:String,activeColor:String,activeClass:String,bgColor:String,disabled:Boolean,lines:{type:[Boolean,String],default:"one"},slim:Boolean,nav:Boolean,...Sn({selectStrategy:"single-leaf",openStrategy:"list"}),...Ga(),...l(),...cl(),...Ma(),...Ja(),itemType:{type:String,default:"type"},...Mn(),...el(),...ua(),...ta(),...fl({variant:"text"})},"VList"),Wn=gt()({name:"VList",props:Hn(),emits:{"update:selected":e=>!0,"update:opened":e=>!0,"click:open":e=>!0,"click:select":e=>!0},setup(e,a){let{slots:l}=a
const{items:o}=function(e){return{items:t.computed((()=>jn(e,e.items)))}}(e),{themeClasses:n}=la(e),{backgroundColorClasses:r,backgroundColorStyles:i}=Za(t.toRef(e,"bgColor")),{borderClasses:s}=qa(e),{densityClasses:u}=dl(e),{dimensionStyles:c}=Fa(e),{elevationClasses:d}=Qa(e),{roundedClasses:v}=tl(e),{open:p,select:f}=wn(e),m=t.computed((()=>e.lines?`v-list--${e.lines}-line`:void 0)),g=t.toRef(e,"activeColor"),h=t.toRef(e,"baseColor"),y=t.toRef(e,"color")
vn(),vt({VListGroup:{activeColor:g,baseColor:h,color:y},VListItem:{activeClass:t.toRef(e,"activeClass"),activeColor:g,baseColor:h,color:y,density:t.toRef(e,"density"),disabled:t.toRef(e,"disabled"),lines:t.toRef(e,"lines"),nav:t.toRef(e,"nav"),slim:t.toRef(e,"slim"),variant:t.toRef(e,"variant")}})
...
N("last")}e.preventDefault()}}function N(e){if(V.value)return ee(V.value,e)}return At((()=>t.createVNode(e.tag,{ref:V,class:["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav},n.value,r.value,s.value,u.value,d.value,m.value,v.value,e.class],style:[i.value,c.value,e.style],tabindex:e.disabled||b.value?-1:0,role:"listbox","aria-activedescendant":void 0,onFocusin:S,onFocusout:w,onFocus:k,onKeydown:x},{default:()=>[t.createVNode($n,{items:o.value,returnObject:e.returnObject},l)]}))),{open:p,select:f,focus:N}}}),Un=ht("v-list-img"),Yn=a({start:Boolean,end:Boolean,...l(),...ua()},"VListItemAction"),Gn=gt()({name:"VListItemAction",props:Yn(),setup(e,a){let{slots:l}=a
return At((()=>t.createVNode(e.tag,{class:["v-list-item-action",{"v-list-item-action--start":e.start,"v-list-item-action--end":e.end},e.class],style:e.style},l))),{}}}),qn=a({start:Boolean,end:Boolean,...l(),...ua()},"VListItemMedia"),Kn=gt()({name:"VListItemMedia",props:qn(),setup(e,a){let{slots:l}=a
...
function Xn(e,t){return{x:e.x+t.x,y:e.y+t.y}}function Zn(e,t){if("top"===e.side||"bottom"===e.side){const{side:a,align:l}=e
return Xn({x:"left"===l?0:"center"===l?t.width/2:"right"===l?t.width:l,y:"top"===a?0:"bottom"===a?t.height:a},t)}if("left"===e.side||"right"===e.side){const{side:a,align:l}=e
return Xn({x:"left"===a?0:"right"===a?t.width:a,y:"top"===l?0:"center"===l?t.height/2:"bottom"===l?t.height:l},t)}return Xn({x:t.width/2,y:t.height/2},t)}const Jn={static:function(){},connected:function(e,a,l){(Array.isArray(e.target.value)||function(e){for(;e;){if("fixed"===window.getComputedStyle(e).position)return!0
e=e.offsetParent}return!1}(e.target.value))&&Object.assign(l.value,{position:"fixed",top:0,[e.isRtl?"right":"left"]:0})
const{preferredAnchor:o,preferredOrigin:n}=Y((()=>{const t=ie(a.location,e.isRtl),l="overlap"===a.origin?t:"auto"===a.origin?ue(t):ie(a.origin,e.isRtl)
...
return a.y-=parseFloat(e.style.top||0),a}(e.contentEl.value,e.isRtl),v=_t(e.contentEl.value)
...
function m(e){const l=new pe(a),o=Zn(e.anchor,t),n=Zn(e.origin,l)
...
return Object.assign(l.value,{"--v-overlay-anchor-origin":`${f.anchor.side} ${f.anchor.align}`,transformOrigin:`${f.origin.side} ${f.origin.align}`,top:h(er(y)),left:e.isRtl?void 0:h(er(g)),right:e.isRtl?h(er(-g)):void 0,minWidth:h("y"===w?Math.min(r.value,t.width):r.value),maxWidth:h(tr(E(b.x,r.value===1/0?0:r.value,s.value))),maxHeight:h(tr(E(b.y,i.value===1/0?0:i.value,u.value)))}),{available:b,contentBox:a}}return t.watch([e.target,e.contentEl],((e,t)=>{let[a,l]=e,[o,n]=t
...
a.height>t.y&&requestAnimationFrame((()=>{p(),requestAnimationFrame((()=>{p()}))}))})),{updateLocation:p}}},Qn=a({locationStrategy:{type:[String,Function],default:"static",validator:e=>"function"==typeof e||e in Jn},location:{type:String,default:"bottom"},origin:{type:String,default:"auto"},offset:[Number,String,Array]},"VOverlay-location-strategies")
function er(e){return Math.round(e*devicePixelRatio)/devicePixelRatio}function tr(e){return Math.ceil(e*devicePixelRatio)/devicePixelRatio}let ar=!0
const lr=[]
let or=-1
function nr(){cancelAnimationFrame(or),or=requestAnimationFrame((()=>{const e=lr.shift()
e&&e(),lr.length?nr():ar=!0}))}const rr={none:null,close:function(e){sr(e.targetEl.value??e.contentEl.value,(function(t){e.isActive.value=!1}))},block:function(e,a){const l=e.root.value?.offsetParent,o=[...new Set([..._t(e.targetEl.value,a.contained?l:void 0),..._t(e.contentEl.value,a.contained?l:void 0)])].filter((e=>!e.classList.contains("v-overlay-scroll-blocked"))),n=window.innerWidth-document.documentElement.offsetWidth,r=(i=l||document.documentElement,It(i)&&i)
var i
...
o=l/(1e3/60)>2},!ar||lr.length?(lr.push(a),nr()):(ar=!1,a(),nr())}r=("undefined"==typeof requestIdleCallback?e=>e():requestIdleCallback)((()=>{l.run((()=>{sr(e.targetEl.value??e.contentEl.value,(e=>{o?(cancelAnimationFrame(n),n=requestAnimationFrame((()=>{n=requestAnimationFrame((()=>{i(e)}))}))):i(e)}))}))})),t.onScopeDispose((()=>{"undefined"!=typeof cancelIdleCallback&&cancelIdleCallback(r),cancelAnimationFrame(n)}))}},ir=a({scrollStrategy:{type:[String,Function],default:"block",validator:e=>"function"==typeof e||e in rr}},"VOverlay-scroll-strategies")
function sr(e,a){const l=[document,..._t(e)]
l.forEach((e=>{e.addEventListener("scroll",a,{passive:!0})})),t.onScopeDispose((()=>{l.forEach((e=>{e.removeEventListener("scroll",a)}))}))}const ur=Symbol.for("vuetify:v-menu"),cr=a({closeDelay:[Number,String],openDelay:[Number,String]},"delay")
function dr(e,t){const a={},l=l=>()=>{if(!o)return Promise.resolve(!0)
const n="openDelay"===l
...
return{runCloseDelay:l("closeDelay"),runOpenDelay:l("openDelay")}}const vr=a({target:[String,Object],activator:[String,Object],activatorProps:{type:Object,default:()=>({})},openOnClick:{type:Boolean,default:void 0},openOnHover:Boolean,openOnFocus:{type:Boolean,default:void 0},closeOnContentClick:Boolean,...cr()},"VOverlay-activator")
function pr(e,a){let{isActive:l,isTop:n}=a
const r=St("useActivator"),i=t.ref()
let s=!1,u=!1,c=!0
const d=t.computed((()=>e.openOnFocus||null==e.openOnFocus&&e.openOnHover)),v=t.computed((()=>e.openOnClick||null==e.openOnClick&&!e.openOnHover&&!d.value)),{runOpenDelay:p,runCloseDelay:f}=dr(e,(t=>{t!==(e.openOnHover&&s||d.value&&u)||e.openOnHover&&l.value&&!n.value||(l.value!==t&&(c=!0),l.value=t)})),m=t.ref(),g=e=>{e.stopPropagation(),i.value=e.currentTarget||e.target,l.value||(m.value=[e.clientX,e.clientY]),l.value=!l.value},h=e=>{e.sourceCapabilities?.firesTouchEvents||(s=!0,i.value=e.currentTarget||e.target,p())},y=e=>{s=!1,f()},V=e=>{!1!==le(e.target,":focus-visible")&&(u=!0,e.stopPropagation(),i.value=e.currentTarget||e.target,p())},S=e=>{u=!1,e.stopPropagation(),f()},w=t.computed((()=>{const t={}
...
if(e.openOnHover&&(a.onMouseenter=()=>{s=!0,p()},a.onMouseleave=()=>{s=!1,f()}),d.value&&(a.onFocusin=()=>{u=!0,p()},a.onFocusout=()=>{u=!1,f()}),e.closeOnContentClick){const e=t.inject(ur,null)
...
const C=t.ref(),_=t.computed((()=>"cursor"===e.target&&m.value?m.value:C.value?b(C.value):fr(e.target,r)||i.value)),I=t.computed((()=>Array.isArray(_.value)?void 0:_.value))
let P
...
a&&Ve(a,t.mergeProps(n.value,l))}function s(){const t=fr(arguments.length>0&&void 0!==arguments[0]?arguments[0]:e.activator,a)
return o.value=t?.nodeType===Node.ELEMENT_NODE?t:void 0,o.value}t.watch((()=>e.activator),((e,a)=>{if(a&&e!==a){const e=s(a)
e&&i(e)}e&&t.nextTick((()=>r()))}),{immediate:!0}),t.watch((()=>e.activatorProps),(()=>{r()})),t.onScopeDispose((()=>{i()}))}(e,r,{activatorEl:i,activatorEvents:w})}))):P&&P.stop()}),{flush:"post",immediate:!0}),t.onScopeDispose((()=>{P?.stop()})),{activatorEl:i,activatorRef:N,target:_,targetEl:I,targetRef:C,activatorEvents:w,contentEvents:k,scrimEvents:x}}function fr(e,t){if(!e)return
let a
if("parent"===e){let e=t?.proxy?.$el?.parentNode
for(;e?.hasAttribute("data-no-activator");)e=e.parentNode
a=e}else a="string"==typeof e?document.querySelector(e):"$el"in e?e.$el:e
return a}const mr=["sm","md","lg","xl","xxl"],gr=Symbol.for("vuetify:display"),hr={mobileBreakpoint:"lg",thresholds:{xs:0,sm:600,md:960,lg:1280,xl:1920,xxl:2560}}
function yr(e){return o&&!e?window.innerWidth:"object"==typeof e&&e.clientWidth||0}function br(e){return o&&!e?window.innerHeight:"object"==typeof e&&e.clientHeight||0}function Vr(e){const t=o&&!e?window.navigator.userAgent:"ssr"
function a(e){return Boolean(t.match(e))}return{android:a(/android/i),ios:a(/iphone|ipad|ipod/i),cordova:a(/cordova/i),electron:a(/electron/i),chrome:a(/chrome/i),edge:a(/edge/i),firefox:a(/firefox/i),opera:a(/opera/i),win:a(/win/i),mac:a(/mac/i),linux:a(/linux/i),touch:r,ssr:"ssr"===t}}function Sr(e,a){const{thresholds:l,mobileBreakpoint:n}=function(){return L(hr,arguments.length>0&&void 0!==arguments[0]?arguments[0]:hr)}(e),r=t.shallowRef(br(a)),i=t.shallowRef(Vr(a)),s=t.reactive({}),u=t.shallowRef(yr(a))
function c(){r.value=br(),u.value=yr()}return t.watchEffect((()=>{const e=u.value<l.sm,t=u.value<l.md&&!e,a=u.value<l.lg&&!(t||e),o=u.value<l.xl&&!(a||t||e),c=u.value<l.xxl&&!(o||a||t||e),d=u.value>=l.xxl,v=e?"xs":t?"sm":a?"md":o?"lg":c?"xl":"xxl",p="number"==typeof n?n:l[n],f=u.value<p
s.xs=e,s.sm=t,s.md=a,s.lg=o,s.xl=c,s.xxl=d,s.smAndUp=!e,s.mdAndUp=!(e||t),s.lgAndUp=!(e||t||a),s.xlAndUp=!(e||t||a||o),s.smAndDown=!(a||o||c||d),s.mdAndDown=!(o||c||d),s.lgAndDown=!(c||d),s.xlAndDown=!d,s.name=v,s.height=r.value,s.width=u.value,s.mobile=f,s.mobileBreakpoint=n,s.platform=i.value,s.thresholds=l})),o&&window.addEventListener("resize",c,{passive:!0}),{...t.toRefs(s),update:function(){c(),i.value=Vr()},ssr:!!a}}const wr=a({mobileBreakpoint:[Number,String]},"display")
function kr(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:wt()
const l=t.inject(gr)
...
return{...l,displayClasses:n,mobile:o}}function xr(){if(!o)return t.shallowRef(!1)
const{ssr:e}=kr()
if(e){const e=t.shallowRef(!1)
return t.onMounted((()=>{e.value=!0})),e}return t.shallowRef(!0)}const Nr=a({eager:Boolean},"lazy")
function Cr(e,a){const l=t.shallowRef(!1),o=t.computed((()=>l.value||e.eager||a.value))
return t.watch(a,(()=>l.value=!0)),{isBooted:l,hasContent:o,onAfterLeave:function(){e.eager||(l.value=!1)}}}function _r(){const e=St("useScopeId").vnode.scopeId
return{scopeId:e?{[e]:""}:void 0}}const Ir=Symbol.for("vuetify:stack"),Pr=t.reactive([])
function Br(){return!0}function Ar(e,t,a){if(!e||!1===Rr(e,a))return!1
const l=yt(t)
if("undefined"!=typeof ShadowRoot&&l instanceof ShadowRoot&&l.host===e.target)return!1
const o=("object"==typeof a.value&&a.value.include||(()=>[]))()
return o.push(t),!o.some((t=>t?.contains(e.target)))}function Rr(e,t){return("object"==typeof t.value&&t.value.closeConditional||Br)(e)}function Tr(e,t){const a=yt(e)
...
return n||(n=document.createElement("div"),n.className="v-overlay-container",l.appendChild(n)),n}))}}(t.computed((()=>e.attach||e.contained))),{themeClasses:c}=la(e),{rtlClasses:d,isRtl:v}=Qt(),{hasContent:p,onAfterLeave:f}=Cr(e,s),m=Za(t.computed((()=>"string"==typeof e.scrim?e.scrim:null))),{globalTop:g,localTop:y,stackStyles:b}=function(e,a,l){const o=St("useStack"),n=!l,r=t.inject(Ir,void 0),i=t.reactive({activeChildren:new Set})
t.provide(Ir,i)
const s=t.shallowRef(+a.value)
jt(e,(()=>{const e=Pr.at(-1)?.[1]
s.value=e?e+10:+a.value,n&&Pr.push([o.uid,s.value]),r?.activeChildren.add(o.uid),t.onScopeDispose((()=>{if(n){const e=t.toRaw(Pr).findIndex((e=>e[0]===o.uid))
Pr.splice(e,1)}r?.activeChildren.delete(o.uid)}))}))
const u=t.shallowRef(!0)
n&&t.watchEffect((()=>{const e=Pr.at(-1)?.[0]===o.uid
setTimeout((()=>u.value=e))}))
const c=t.computed((()=>!i.activeChildren.size))
return{globalTop:t.readonly(u),localTop:c,stackStyles:t.computed((()=>({zIndex:s.value})))}}(s,t.toRef(e,"zIndex"),e._disableGlobalStack),{activatorEl:V,activatorRef:S,target:w,targetEl:k,targetRef:x,activatorEvents:N,contentEvents:C,scrimEvents:_}=pr(e,{isActive:s,isTop:y}),{dimensionStyles:I}=Fa(e),P=xr(),{scopeId:B}=_r()
...
function r(e){n.value?.(e)}return o&&(jt((()=>!(!a.isActive.value||!e.locationStrategy)),(o=>{t.watch((()=>e.locationStrategy),o),t.onScopeDispose((()=>{n.value=void 0})),"function"==typeof e.locationStrategy?n.value=e.locationStrategy(a,e,l)?.updateLocation:n.value=Jn[e.locationStrategy](a,e,l)?.updateLocation})),window.addEventListener("resize",r,{passive:!0}),t.onScopeDispose((()=>{window.removeEventListener("resize",r),n.value=void 0}))),{contentStyles:l,updateLocation:n}}(e,{isRtl:v,contentEl:R,target:w,isActive:s})
...
let l
t.watchEffect((async()=>{l?.stop(),a.isActive.value&&e.scrollStrategy&&(l=t.effectScope(),await t.nextTick(),l.active&&l.run((()=>{"function"==typeof e.scrollStrategy?e.scrollStrategy(a,e,l):rr[e.scrollStrategy]?.(a,e,l)})))})),t.onScopeDispose((()=>{l?.stop()}))}(e,{root:A,contentEl:R,targetEl:k,isActive:s,updateLocation:E}),o&&t.watch(s,(e=>{e?window.addEventListener("keydown",M):window.removeEventListener("keydown",M)}),{immediate:!0})
const F=ao()
jt((()=>e.closeOnBack),(()=>{!function(e,a){let l,n,r=!1
function i(e){e.state?.replaced||(r=!0,setTimeout((()=>r=!1)))}o&&(t.nextTick((()=>{window.addEventListener("popstate",i),l=e?.beforeEach(((e,t,l)=>{no?r?a(l):l():setTimeout((()=>r?a(l):l())),no=!0})),n=e?.afterEach((()=>{no=!1}))})),t.onScopeDispose((()=>{window.removeEventListener("popstate",i),l?.(),n?.()})))}(F,(t=>{g.value&&s.value?(t(!1),e.persistent?O():s.value=!1):t()}))}))
const L=t.ref()
...
e&&e!==document.scrollingElement&&(L.value=e.scrollTop)}})),At((()=>t.createVNode(t.Fragment,null,[l.activator?.({isActive:s.value,props:t.mergeProps({ref:S,targetRef:x},N.value,e.activatorProps)}),P.value&&p.value&&t.createVNode(t.Teleport,{disabled:!u.value,to:u.value},{default:()=>[t.createVNode("div",t.mergeProps({class:["v-overlay",{"v-overlay--absolute":e.absolute||e.contained,"v-overlay--active":s.value,"v-overlay--contained":e.contained},c.value,d,e.class],style:[b.value,{top:h(L.value)},e.style],ref:A},B,n),[t.createVNode(Dr,t.mergeProps({color:m,modelValue:s.value&&!!e.scrim},_.value),null),t.createVNode(ja,{appear:!0,persisted:!0,transition:e.transition,target:w.value,onAfterLeave:()=>{f(),r("afterLeave")}},{default:()=>[t.withDirectives(t.createVNode("div",t.mergeProps({ref:R,class:["v-overlay__content",e.contentClass],style:[I.value,T.value]},C.value,e.contentProps),[l.default?.({isActive:s})]),[[t.vShow,s.value],[t.resolveDirective("click-outside"),{handler:D,closeConditional:$,include:()=>[V.value]}]])]})])]})]))),{activatorEl:V,target:w,animateClick:O,contentEl:R,globalTop:g,localTop:y,updateLocation:E}}}),Fr=Symbol("Forwarded refs")
function Lr(e,t){let a=e
for(;a;){const e=Reflect.getOwnPropertyDescriptor(a,t)
if(e)return e
a=Object.getPrototypeOf(a)}}function Or(e){for(var t=arguments.length,a=new Array(t>1?t-1:0),l=1;l<t;l++)a[l-1]=arguments[l]
return e[Fr]=a,new Proxy(e,{get(e,t){if(Reflect.has(e,t))return Reflect.get(e,t)
...
const a=Lr(e.value,t)??("_"in e.value?Lr(e.value._?.setupState,t):void 0)
if(a)return a}for(const e of a){const a=e.value&&e.value[Fr]
if(!a)continue
const l=a.slice()
for(;l.length;){const e=l.shift(),a=Lr(e.value,t)
if(a)return a
const o=e.value&&e.value[Fr]
o&&l.push(...o)}}}}})}const zr=a({id:String,...C($r({closeDelay:250,closeOnContentClick:!0,locationStrategy:"connected",openDelay:300,scrim:!1,scrollStrategy:"reposition",transition:{component:ha}}),["absolute"])},"VMenu"),jr=gt()({name:"VMenu",props:zr(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=Ht(e,"modelValue"),{scopeId:n}=_r(),r=Nt(),i=t.computed((()=>e.id||`v-menu-${r}`)),s=t.ref(),u=t.inject(ur,null),c=t.shallowRef(0)
...
a&&o.value?"ArrowDown"===t.key?(t.preventDefault(),ee(a,"next")):"ArrowUp"===t.key&&(t.preventDefault(),ee(a,"prev")):["ArrowDown","ArrowUp"].includes(t.key)&&(o.value=!0,t.preventDefault(),setTimeout((()=>setTimeout((()=>f(t))))))}t.provide(ur,{register(){++c.value},unregister(){--c.value},closeParents(){setTimeout((()=>{c.value||(o.value=!1,u?.closeParents())}),40)}}),t.watch(o,(e=>{e?(u?.register(),document.addEventListener("focusin",d,{once:!0})):(u?.unregister(),document.removeEventListener("focusin",d))}))
...
return t.createVNode($a,{root:"VMenu"},{default:()=>[l.default?.(...a)]})}})})),Or({id:i,ΨopenChildren:c},s)}}),Hr=a({active:Boolean,max:[Number,String],value:{type:[Number,String],default:0},...l(),...za({transition:{component:Aa}})},"VCounter"),Wr=gt()({name:"VCounter",functional:!0,props:Hr(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>e.max?`${e.value} / ${e.max}`:String(e.value)))
return At((()=>t.createVNode(ja,{transition:e.transition},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-counter",e.class],style:e.style},[l.default?l.default({counter:o.value,max:e.max,value:e.value}):o.value]),[[t.vShow,e.active]])]}))),{}}}),Ur=a({floating:Boolean,...l()},"VFieldLabel"),Yr=gt()({name:"VFieldLabel",props:Ur(),setup(e,a){let{slots:l}=a
return At((()=>t.createVNode(Eo,{class:["v-field-label",{"v-field-label--floating":e.floating},e.class],style:e.style,"aria-hidden":e.floating||void 0},l))),{}}}),Gr=["underlined","outlined","filled","solo","solo-inverted","solo-filled","plain"],qr=a({appendInnerIcon:Il,bgColor:String,clearable:Boolean,clearIcon:{type:Il,default:"$clear"},active:Boolean,centerAffix:{type:Boolean,default:void 0},color:String,baseColor:String,dirty:Boolean,disabled:{type:Boolean,default:null},error:Boolean,flat:Boolean,label:String,persistentClear:Boolean,prependInnerIcon:Il,reverse:Boolean,singleLine:Boolean,variant:{type:String,default:"filled",validator:e=>Gr.includes(e)},"onClick:clear":K(),"onClick:appendInner":K(),"onClick:prependInner":K(),...l(),...Xl(),...el(),...ta()},"VField"),Kr=gt()({name:"VField",inheritAttrs:!1,props:{id:String,...Yo(),...qr()},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{themeClasses:r}=la(e),{loaderClasses:i}=Zl(e),{focusClasses:s,isFocused:u,focus:c,blur:d}=Go(e),{InputIcon:v}=Ho(e),{roundedClasses:p}=tl(e),{rtlClasses:f}=Qt(),m=t.computed((()=>e.dirty||e.active)),g=t.computed((()=>!(e.singleLine||!e.label&&!n.label))),y=Nt(),b=t.computed((()=>e.id||`input-${y}`)),V=t.computed((()=>`${b.value}-messages`)),S=t.ref(),w=t.ref(),k=t.ref(),x=t.computed((()=>["plain","underlined"].includes(e.variant))),{backgroundColorClasses:N,backgroundColorStyles:C}=Za(t.toRef(e,"bgColor")),{textColorClasses:_,textColorStyles:I}=Xa(t.computed((()=>e.error||e.disabled?void 0:m.value&&u.value?e.color:e.baseColor)))
...
return t.createVNode("div",t.mergeProps({class:["v-field",{"v-field--active":m.value,"v-field--appended":h,"v-field--center-affix":e.centerAffix??!x.value,"v-field--disabled":e.disabled,"v-field--dirty":e.dirty,"v-field--error":e.error,"v-field--flat":e.flat,"v-field--has-background":!!e.bgColor,"v-field--persistent-clear":e.persistentClear,"v-field--prepended":o,"v-field--reverse":e.reverse,"v-field--single-line":e.singleLine,"v-field--no-label":!y(),[`v-field--variant-${e.variant}`]:!0},r.value,N.value,s.value,i.value,p.value,f,e.class],style:[C.value,e.style],onClick:B},l),[t.createVNode("div",{class:"v-field__overlay"},null),t.createVNode(Jl,{name:"v-field",active:!!e.loading,color:e.error?"error":"string"==typeof e.loading?e.loading:e.color},{default:n.loader}),o&&t.createVNode("div",{key:"prepend",class:"v-field__prepend-inner"},[e.prependInnerIcon&&t.createVNode(v,{key:"prepend-icon",name:"prependInner"},null),n["prepend-inner"]?.(P.value)]),t.createVNode("div",{class:"v-field__field","data-no-activator":""},[["filled","solo","solo-inverted","solo-filled"].includes(e.variant)&&g.value&&t.createVNode(Yr,{key:"floating-label",ref:w,class:[_.value],floating:!0,for:b.value,style:I.value},{default:()=>[y()]}),t.createVNode(Yr,{ref:S,for:b.value},{default:()=>[y()]}),n.default?.({...P.value,props:{id:b.value,class:"v-field__input","aria-describedby":V.value},focus:c,blur:d})]),u&&t.createVNode(Ea,{key:"clear"},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-field__clearable",onMousedown:e=>{e.preventDefault(),e.stopPropagation()}},[n.clear?n.clear():t.createVNode(v,{name:"clear"},null)]),[[t.vShow,e.dirty]])]}),h&&t.createVNode("div",{key:"append",class:"v-field__append-inner"},[n["append-inner"]?.(P.value),e.appendInnerIcon&&t.createVNode(v,{key:"append-icon",name:"appendInner"},null)]),t.createVNode("div",{class:["v-field__outline",_.value],style:I.value},[a&&t.createVNode(t.Fragment,null,[t.createVNode("div",{class:"v-field__outline__start"},null),g.value&&t.createVNode("div",{class:"v-field__outline__notch"},[t.createVNode(Yr,{ref:w,floating:!0,for:b.value},{default:()=>[y()]})]),t.createVNode("div",{class:"v-field__outline__end"},null)]),x.value&&g.value&&t.createVNode(Yr,{ref:w,floating:!0,for:b.value},{default:()=>[y()]})])])})),{controlRef:k}}})
function Xr(e){return x(e,Object.keys(Kr.props).filter((e=>!P(e)&&"class"!==e&&"style"!==e)))}const Zr=["color","file","time","date","datetime-local","week","month"],Jr=a({autofocus:Boolean,counter:[Boolean,Number,String],counterValue:[Number,Function],prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,suffix:String,role:String,type:{type:String,default:"text"},modelModifiers:Object,...Qo(),...qr()},"VTextField"),Qr=gt()({name:"VTextField",directives:{Intersect:Wa},inheritAttrs:!1,props:Jr(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const r=Ht(e,"modelValue"),{isFocused:i,focus:s,blur:u}=Go(e),c=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(r.value):"number"==typeof e.counterValue?e.counterValue:(r.value??"").toString().length)),d=t.computed((()=>l.maxlength?l.maxlength:!e.counter||"number"!=typeof e.counter&&"string"!=typeof e.counter?void 0:e.counter)),v=t.computed((()=>["plain","underlined"].includes(e.variant)))
...
t.nextTick((()=>{l.selectionStart=e[0],l.selectionEnd=e[1]}))}}return At((()=>{const a=!!(n.counter||!1!==e.counter&&null!=e.counter),o=!(!a&&!n.details),[s,k]=R(l),{modelValue:x,...N}=en.filterProps(e),C=Xr(e)
return t.createVNode(en,t.mergeProps({ref:f,modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-text-field",{"v-text-field--prefixed":e.prefix,"v-text-field--suffixed":e.suffix,"v-input--plain-underlined":v.value},e.class],style:e.style},s,N,{centerAffix:!v.value,focused:i.value}),{...n,default:a=>{let{id:l,isDisabled:o,isDirty:s,isReadonly:c,isValid:d}=a
return t.createVNode(Kr,t.mergeProps({ref:m,onMousedown:b,onClick:V,"onClick:clear":S,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"],role:e.role},C,{id:l.value,active:h.value||s.value,dirty:s.value||e.dirty,disabled:o.value,focused:i.value,error:!1===d.value}),{...n,default:a=>{let{props:{class:l,...i}}=a
...
return t.createVNode(t.Fragment,null,[e.prefix&&t.createVNode("span",{class:"v-text-field__prefix"},[t.createVNode("span",{class:"v-text-field__prefix__text"},[e.prefix])]),n.default?t.createVNode("div",{class:l,"data-no-activator":""},[n.default(),s]):t.cloneVNode(s,{class:l}),e.suffix&&t.createVNode("span",{class:"v-text-field__suffix"},[t.createVNode("span",{class:"v-text-field__suffix__text"},[e.suffix])])])}})},details:o?l=>t.createVNode(t.Fragment,null,[n.details?.(l),a&&t.createVNode(t.Fragment,null,[t.createVNode("span",null,null),t.createVNode(Wr,{active:e.persistentCounter||i.value,value:c.value,max:d.value},n.counter)])]):void 0})})),Or({},f,m,g)}}),ei=a({renderless:Boolean,...l()},"VVirtualScrollItem"),ti=gt()({name:"VVirtualScrollItem",inheritAttrs:!1,props:ei(),emits:{"update:height":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{resizeRef:r,contentRect:i}=Rt(void 0,"border")
t.watch((()=>i.value?.height),(e=>{null!=e&&o("update:height",e)})),At((()=>e.renderless?t.createVNode(t.Fragment,null,[n.default?.({itemRef:r})]):t.createVNode("div",t.mergeProps({ref:r,class:["v-virtual-scroll__item",e.class],style:e.style},l),[n.default?.()])))}}),ai=a({itemHeight:{type:[Number,String],default:null},height:[Number,String]},"virtual")
function li(e,a){const l=kr(),n=t.shallowRef(0)
...
n.value=l?Math.min(n.value,t):t,a===t&&l===n.value||(h[e]=t,S())}}}const oi=a({items:{type:Array,default:()=>[]},renderless:Boolean,...ai(),...l(),...Ma()},"VVirtualScroll"),ni=gt()({name:"VVirtualScroll",props:oi(),setup(e,a){let{slots:l}=a
const o=St("VVirtualScroll"),{dimensionStyles:n}=Fa(e),{containerRef:r,markerRef:i,handleScroll:s,handleScrollend:u,handleItemResize:c,scrollToIndex:d,paddingTop:v,paddingBottom:p,computedItems:f}=li(e,t.toRef(e,"items"))
...
r.value===document.documentElement?(document[t]("scroll",s,{passive:!0}),document[t]("scrollend",u)):(r.value?.[t]("scroll",s,{passive:!0}),r.value?.[t]("scrollend",u))}t.onMounted((()=>{r.value=Ct(o.vnode.el,!0),e(!0)})),t.onScopeDispose(e)})),At((()=>{const a=f.value.map((a=>t.createVNode(ti,{key:a.index,renderless:e.renderless,"onUpdate:height":e=>c(a.index,e)},{default:e=>l.default?.({item:a.raw,index:a.index,...e})})))
...
break}}}}}const ii=a({chips:Boolean,closableChips:Boolean,closeText:{type:String,default:"$vuetify.close"},openText:{type:String,default:"$vuetify.open"},eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,menu:Boolean,menuIcon:{type:Il,default:"$dropdown"},menuProps:{type:Object},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,itemColor:String,...Mn({itemChildren:!1})},"Select"),si=a({...ii(),...C(Jr({modelValue:null,role:"button"}),["validationValue","dirty","appendInnerIcon"]),...za({transition:{component:ha}})},"VSelect"),ui=gt()({name:"VSelect",props:si(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,a){let{slots:l}=a
const{t:n}=Jt(),r=t.ref(),i=t.ref(),s=t.ref(),u=Ht(e,"menu"),c=t.computed({get:()=>u.value,set:e=>{u.value&&!e&&i.value?.ΨopenChildren||(u.value=e)}}),{items:d,transformIn:v,transformOut:p}=On(e),f=Ht(e,"modelValue",[],(e=>v(null===e?[null]:T(e))),(t=>{const a=p(t)
return e.multiple?a:a[0]??null})),m=Xo(),g=t.computed((()=>f.value.map((e=>e.value)))),h=t.shallowRef(!1),y=t.computed((()=>c.value?e.closeText:e.openText))
let b,V=""
const S=t.computed((()=>e.hideSelected?d.value.filter((e=>!f.value.some((t=>t===e)))):d.value)),w=t.computed((()=>e.hideNoData&&!d.value.length||e.readonly||m?.isReadonly.value)),k=t.ref(),{onListScroll:x,onListKeydown:N}=ri(k,r)
...
o&&window.requestAnimationFrame((()=>{t>=0&&s.value?.scrollToIndex(t)}))}})),At((()=>{const a=!(!e.chips&&!l.chip),o=!!(!e.hideNoData||S.value.length||l["prepend-item"]||l["append-item"]||l["no-data"]),u=f.value.length>0,d=Qr.filterProps(e),v=u||!h.value&&e.label&&!e.persistentPlaceholder?void 0:e.placeholder
return t.createVNode(Qr,t.mergeProps({ref:r},d,{modelValue:f.value.map((e=>e.props.value)).join(", "),"onUpdate:modelValue":E,focused:h.value,"onUpdate:focused":e=>h.value=e,validationValue:f.externalValue,counterValue:f.value.length,dirty:u,class:["v-select",{"v-select--active-menu":c.value,"v-select--chips":!!e.chips,["v-select--"+(e.multiple?"multiple":"single")]:!0,"v-select--selected":f.value.length,"v-select--selection-slot":!!l.selection},e.class],style:e.style,inputmode:"none",placeholder:v,"onClick:clear":C,"onMousedown:control":_,onBlur:B,onKeydown:I,"aria-label":n(y.value),title:n(y.value)}),{...l,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(jr,t.mergeProps({ref:i,modelValue:c.value,"onUpdate:modelValue":e=>c.value=e,activator:"parent",contentClass:"v-select__content",disabled:w.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:A},e.menuProps),{default:()=>[o&&t.createVNode(Wn,{ref:k,selected:g.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:N,onFocusin:R,onScrollPassive:x,tabindex:"-1",color:e.itemColor??e.color},{default:()=>[l["prepend-item"]?.(),!S.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(Bn,{title:n(e.noDataText)},null)),t.createVNode(ni,{ref:s,renderless:!0,items:S.value},{default:a=>{let{item:o,index:n,itemRef:r}=a
const i=t.mergeProps(o.props,{ref:r,key:n,onClick:()=>P(o)})
return l.item?.({item:o,index:n,props:i})??t.createVNode(Bn,t.mergeProps(i,{role:"option"}),{prepend:a=>{let{isSelected:l}=a
return t.createVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(jo,{key:o.value,modelValue:l,ripple:!1,tabindex:"-1"},null):void 0,o.props.prependIcon&&t.createVNode(zl,{icon:o.props.prependIcon},null)])}})}}),l["append-item"]?.()]})]}),f.value.map(((o,n)=>{const r={"onClick:close":function(e){e.stopPropagation(),e.preventDefault(),P(o)},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=a?!!l.chip:!!l.selection,s=i?oe(a?l.chip({item:o,index:n,props:r}):l.selection({item:o,index:n})):void 0
if(!i||s)return t.createVNode("div",{key:o.value,class:"v-select__selection"},[a?l.chip?t.createVNode($a,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:o.title}}},{default:()=>[s]}):t.createVNode(cn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:o.title,disabled:o.props.disabled},r),null):s??t.createVNode("span",{class:"v-select__selection-text"},[o.title,e.multiple&&n<f.value.length-1&&t.createVNode("span",{class:"v-select__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,o=new Array(a),n=0;n<a;n++)o[n]=arguments[n]
return t.createVNode(t.Fragment,null,[l["append-inner"]?.(...o),e.menuIcon?t.createVNode(zl,{class:"v-select__menu-icon",icon:e.menuIcon},null):void 0])}})})),Or({isFocused:h,menu:c,select:P},r)}}),ci=(e,t,a)=>null==e||null==t?-1:e.toString().toLocaleLowerCase().indexOf(t.toString().toLocaleLowerCase()),di=a({customFilter:Function,customKeyFilter:Object,filterKeys:[Array,String],filterMode:{type:String,default:"intersection"},noFilter:Boolean},"filter")
function vi(e,a,l,o){const n=t.ref([]),r=t.ref(new Map),i=t.computed((()=>o?.transform?t.unref(a).map((e=>[e,o.transform(e)])):t.unref(a)))
return t.watchEffect((()=>{const s="function"==typeof l?l():t.unref(l),u="string"!=typeof s&&"number"!=typeof s?"":String(s),c=function(e,t,a){const l=[],o=a?.default??ci,n=!!a?.filterKeys&&T(a.filterKeys),r=Object.keys(a?.customKeyFilter??{}).length
...
o&&window.requestAnimationFrame((()=>{e>=0&&d.value?.scrollToIndex(e)}))}})),At((()=>{const a=!(!e.chips&&!l.chip),o=!!(!e.hideNoData||_.value.length||l["prepend-item"]||l["append-item"]||l["no-data"]),u=k.value.length>0,v=Qr.filterProps(e)
return t.createVNode(Qr,t.mergeProps({ref:r},v,{modelValue:w.value,"onUpdate:modelValue":W,focused:i.value,"onUpdate:focused":e=>i.value=e,validationValue:k.externalValue,counterValue:k.value.length,dirty:u,onInput:L,onChange:O,class:["v-autocomplete","v-autocomplete--"+(e.multiple?"multiple":"single"),{"v-autocomplete--active-menu":p.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selection-slot":!!l.selection,"v-autocomplete--selecting-index":f.value>-1},e.class],style:e.style,readonly:e.readonly,placeholder:u?void 0:e.placeholder,"onClick:clear":D,"onMousedown:control":$,onKeydown:F}),{...l,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(jr,t.mergeProps({ref:c,modelValue:p.value,"onUpdate:modelValue":e=>p.value=e,activator:"parent",contentClass:"v-autocomplete__content",disabled:B.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:z},e.menuProps),{default:()=>[o&&t.createVNode(Wn,{ref:A,selected:I.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:E,onFocusin:j,onFocusout:H,onScrollPassive:R,tabindex:"-1",color:e.itemColor??e.color},{default:()=>[l["prepend-item"]?.(),!_.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(Bn,{title:n(e.noDataText)},null)),t.createVNode(ni,{ref:d,renderless:!0,items:_.value},{default:a=>{let{item:o,index:n,itemRef:r}=a
...
return t.createVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(jo,{key:o.value,modelValue:l,ripple:!1,tabindex:"-1"},null):void 0,o.props.prependIcon&&t.createVNode(zl,{icon:o.props.prependIcon},null)])},title:()=>s.value?o.title:function(e,a,l){if(null==a)return e
...
if(!i||s)return t.createVNode("div",{key:o.value,class:["v-autocomplete__selection",n===f.value&&["v-autocomplete__selection--selected",V.value]],style:n===f.value?S.value:{}},[a?l.chip?t.createVNode($a,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:o.title}}},{default:()=>[s]}):t.createVNode(cn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:o.title,disabled:o.props.disabled},r),null):s??t.createVNode("span",{class:"v-autocomplete__selection-text"},[o.title,e.multiple&&n<k.value.length-1&&t.createVNode("span",{class:"v-autocomplete__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,o=new Array(a),r=0;r<a;r++)o[r]=arguments[r]
return t.createVNode(t.Fragment,null,[l["append-inner"]?.(...o),e.menuIcon?t.createVNode(zl,{class:"v-autocomplete__menu-icon",icon:e.menuIcon,onMousedown:M,onClick:ae,"aria-label":n(g.value),title:n(g.value)},null):void 0])}})})),Or({isFocused:i,isPristine:s,menu:p,search:w,filteredItems:N,select:Y},r)}}),mi=a({bordered:Boolean,color:String,content:[Number,String],dot:Boolean,floating:Boolean,icon:Il,inline:Boolean,label:{type:String,default:"$vuetify.badge"},max:[Number,String],modelValue:{type:Boolean,default:!0},offsetX:[Number,String],offsetY:[Number,String],textColor:String,...l(),...Yl({location:"top end"}),...el(),...ua(),...ta(),...za({transition:"scale-rotate-transition"})},"VBadge"),gi=gt()({name:"VBadge",inheritAttrs:!1,props:mi(),setup(e,a){const{backgroundColorClasses:l,backgroundColorStyles:o}=Za(t.toRef(e,"color")),{roundedClasses:n}=tl(e),{t:r}=Jt(),{textColorClasses:i,textColorStyles:s}=Xa(t.toRef(e,"textColor")),{themeClasses:u}=oa(),{locationStyles:c}=Gl(e,!0,(t=>(e.floating?e.dot?2:4:e.dot?8:12)+(["top","bottom"].includes(t)?+(e.offsetY??0):["left","right"].includes(t)?+(e.offsetX??0):0)))
...
return t.createVNode(e.tag,t.mergeProps({class:["v-badge",{"v-badge--bordered":e.bordered,"v-badge--dot":e.dot,"v-badge--floating":e.floating,"v-badge--inline":e.inline},e.class]},f,{style:e.style}),{default:()=>[t.createVNode("div",{class:"v-badge__wrapper"},[a.slots.default?.(),t.createVNode(ja,{transition:e.transition},{default:()=>[t.withDirectives(t.createVNode("span",t.mergeProps({class:["v-badge__badge",u.value,l.value,n.value,i.value],style:[o.value,s.value,e.inline?{}:c.value],"aria-atomic":"true","aria-label":r(e.label,d),"aria-live":"polite",role:"status"},p),[e.dot?void 0:a.slots.badge?a.slots.badge?.():e.icon?t.createVNode(zl,{icon:e.icon},null):v]),[[t.vShow,e.modelValue]])]})])]})})),{}}}),hi=a({color:String,density:String,...l()},"VBannerActions"),yi=gt()({name:"VBannerActions",props:hi(),setup(e,a){let{slots:l}=a
return vt({VBtn:{color:e.color,density:e.density,slim:!0,variant:"text"}}),At((()=>t.createVNode("div",{class:["v-banner-actions",e.class],style:e.style},[l.default?.()]))),{}}}),bi=ht("v-banner-text"),Vi=a({avatar:String,bgColor:String,color:String,icon:Il,lines:String,stacked:Boolean,sticky:Boolean,text:String,...Ga(),...l(),...cl(),...Ma(),...wr(),...Ja(),...Yl(),...eo(),...el(),...ua(),...ta()},"VBanner"),Si=gt()({name:"VBanner",props:Vi(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=Za(e,"bgColor"),{borderClasses:r}=qa(e),{densityClasses:i}=dl(e),{displayClasses:s,mobile:u}=kr(e),{dimensionStyles:c}=Fa(e),{elevationClasses:d}=Qa(e),{locationStyles:v}=Gl(e),{positionClasses:p}=to(e),{roundedClasses:f}=tl(e),{themeClasses:m}=la(e),g=t.toRef(e,"color"),h=t.toRef(e,"density")
vt({VBannerActions:{color:g,density:h}}),At((()=>{const a=!(!e.text&&!l.text),y=!(!e.avatar&&!e.icon),b=!(!y&&!l.prepend)
return t.createVNode(e.tag,{class:["v-banner",{"v-banner--stacked":e.stacked||u.value,"v-banner--sticky":e.sticky,[`v-banner--${e.lines}-line`]:!!e.lines},m.value,o.value,r.value,i.value,s.value,d.value,p.value,f.value,e.class],style:[n.value,c.value,v.value,e.style],role:"banner"},{default:()=>[b&&t.createVNode("div",{key:"prepend",class:"v-banner__prepend"},[l.prepend?t.createVNode($a,{key:"prepend-defaults",disabled:!y,defaults:{VAvatar:{color:g.value,density:h.value,icon:e.icon,image:e.avatar}}},l.prepend):t.createVNode(on,{key:"prepend-avatar",color:g.value,density:h.value,icon:e.icon,image:e.avatar},null)]),t.createVNode("div",{class:"v-banner__content"},[a&&t.createVNode(bi,{key:"text"},{default:()=>[l.text?.()??e.text]}),l.default?.()]),l.actions&&t.createVNode(yi,{key:"actions"},l.actions)]})}))}}),wi=a({bgColor:String,color:String,grow:Boolean,mode:{type:String,validator:e=>!e||["horizontal","shift"].includes(e)},height:{type:[Number,String],default:56},active:{type:Boolean,default:!0},...Ga(),...l(),...cl(),...Ja(),...el(),...$t({name:"bottom-navigation"}),...ua({tag:"header"}),...yl({modelValue:!0,selectedClass:"v-btn--selected"}),...ta()},"VBottomNavigation"),ki=gt()({name:"VBottomNavigation",props:wi(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=oa(),{borderClasses:n}=qa(e),{backgroundColorClasses:r,backgroundColorStyles:i}=Za(t.toRef(e,"bgColor")),{densityClasses:s}=dl(e),{elevationClasses:u}=Qa(e),{roundedClasses:c}=tl(e),{ssrBootStyles:d}=rl(),v=t.computed((()=>Number(e.height)-("comfortable"===e.density?8:0)-("compact"===e.density?16:0))),p=t.toRef(e,"active"),{layoutItemStyles:f}=Ft({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.computed((()=>"bottom")),layoutSize:t.computed((()=>p.value?v.value:0)),elementSize:v,active:p,absolute:t.toRef(e,"absolute")})
return Sl(e,kl),vt({VBtn:{color:t.toRef(e,"color"),density:t.toRef(e,"density"),stacked:t.computed((()=>"horizontal"!==e.mode)),variant:"text"}},{scoped:!0}),At((()=>t.createVNode(e.tag,{class:["v-bottom-navigation",{"v-bottom-navigation--active":p.value,"v-bottom-navigation--grow":e.grow,"v-bottom-navigation--shift":"shift"===e.mode},o.value,r.value,n.value,s.value,u.value,c.value,e.class],style:[i.value,f.value,{height:h(v.value),transform:`translateY(${h(p.value?0:100,"%")})`},d.value,e.style]},{default:()=>[l.default&&t.createVNode("div",{class:"v-bottom-navigation__content"},[l.default()])]}))),{}}}),xi=a({fullscreen:Boolean,retainFocus:{type:Boolean,default:!0},scrollable:Boolean,...$r({origin:"center center",scrollStrategy:"block",transition:{component:ha},zIndex:2400})},"VDialog"),Ni=gt()({name:"VDialog",props:xi(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const n=Ht(e,"modelValue"),{scopeId:r}=_r(),i=t.ref()
...
return t.createVNode($a,{root:"VDialog"},{default:()=>[l.default?.(...a)]})}})})),Or({},i)}}),Ci=a({inset:Boolean,...xi({transition:"bottom-sheet-transition"})},"VBottomSheet"),_i=gt()({name:"VBottomSheet",props:Ci(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=Ht(e,"modelValue")
return At((()=>{const a=Ni.filterProps(e)
return t.createVNode(Ni,t.mergeProps(a,{contentClass:["v-bottom-sheet__content",e.contentClass],modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-bottom-sheet",{"v-bottom-sheet--inset":e.inset},e.class],style:e.style}),l)})),{}}}),Ii=a({divider:[Number,String],...l()},"VBreadcrumbsDivider"),Pi=gt()({name:"VBreadcrumbsDivider",props:Ii(),setup(e,a){let{slots:l}=a
return At((()=>t.createVNode("li",{class:["v-breadcrumbs-divider",e.class],style:e.style},[l?.default?.()??e.divider]))),{}}}),Bi=a({active:Boolean,activeClass:String,activeColor:String,color:String,disabled:Boolean,title:String,...l(),...oo(),...ua({tag:"li"})},"VBreadcrumbsItem"),Ai=gt()({name:"VBreadcrumbsItem",props:Bi(),setup(e,a){let{slots:l,attrs:o}=a
const n=lo(e,o),r=t.computed((()=>e.active||n.isActive?.value)),i=t.computed((()=>r.value?e.activeColor:e.color)),{textColorClasses:s,textColorStyles:u}=Xa(i)
return At((()=>t.createVNode(e.tag,{class:["v-breadcrumbs-item",{"v-breadcrumbs-item--active":r.value,"v-breadcrumbs-item--disabled":e.disabled,[`${e.activeClass}`]:r.value&&e.activeClass},s.value,e.class],style:[u.value,e.style],"aria-current":r.value?"page":void 0},{default:()=>[n.isLink.value?t.createVNode("a",{class:"v-breadcrumbs-item--link",href:n.href.value,"aria-current":r.value?"page":void 0,onClick:n.navigate},[l.default?.()??e.title]):l.default?.()??e.title]}))),{}}}),Ri=a({activeClass:String,activeColor:String,bgColor:String,color:String,disabled:Boolean,divider:{type:String,default:"/"},icon:Il,items:{type:Array,default:()=>[]},...l(),...cl(),...el(),...ua({tag:"ul"})},"VBreadcrumbs"),Ti=gt()({name:"VBreadcrumbs",props:Ri(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=Za(t.toRef(e,"bgColor")),{densityClasses:r}=dl(e),{roundedClasses:i}=tl(e)
...
return t.createVNode(e.tag,{class:["v-breadcrumbs",o.value,r.value,i.value,e.class],style:[n.value,e.style]},{default:()=>[a&&t.createVNode("li",{key:"prepend",class:"v-breadcrumbs__prepend"},[l.prepend?t.createVNode($a,{key:"prepend-defaults",disabled:!e.icon,defaults:{VIcon:{icon:e.icon,start:!0}}},l.prepend):t.createVNode(zl,{key:"prepend-icon",start:!0,icon:e.icon},null)]),s.value.map(((e,a,o)=>{let{item:n,raw:r}=e
return t.createVNode(t.Fragment,null,[l.item?.({item:n,index:a})??t.createVNode(Ai,t.mergeProps({key:a,disabled:a>=o.length-1},"string"==typeof n?{title:n}:n),{default:l.title?()=>l.title?.({item:n,index:a}):void 0}),a<o.length-1&&t.createVNode(Pi,null,{default:l.divider?()=>l.divider?.({item:r,index:a}):void 0})])})),l.default?.()]})})),{}}}),Ei=gt()({name:"VCardActions",props:l(),setup(e,a){let{slots:l}=a
return vt({VBtn:{slim:!0,variant:"text"}}),At((()=>t.createVNode("div",{class:["v-card-actions",e.class],style:e.style},[l.default?.()]))),{}}}),Di=ht("v-card-subtitle"),$i=ht("v-card-title"),Mi=a({appendAvatar:String,appendIcon:Il,prependAvatar:String,prependIcon:Il,subtitle:String,title:String,...l(),...cl()},"VCardItem"),Fi=gt()({name:"VCardItem",props:Mi(),setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{class:["v-card-item",e.class],style:e.style},[o&&t.createVNode("div",{key:"prepend",class:"v-card-item__prepend"},[l.prepend?t.createVNode($a,{key:"prepend-defaults",disabled:!a,defaults:{VAvatar:{density:e.density,icon:e.prependIcon,image:e.prependAvatar}}},l.prepend):a&&t.createVNode(on,{key:"prepend-avatar",density:e.density,icon:e.prependIcon,image:e.prependAvatar},null)]),t.createVNode("div",{class:"v-card-item__content"},[i&&t.createVNode($i,{key:"title"},{default:()=>[l.title?.()??e.title]}),s&&t.createVNode(Di,{key:"subtitle"},{default:()=>[l.subtitle?.()??e.subtitle]}),l.default?.()]),r&&t.createVNode("div",{key:"append",class:"v-card-item__append"},[l.append?t.createVNode($a,{key:"append-defaults",disabled:!n,defaults:{VAvatar:{density:e.density,icon:e.appendIcon,image:e.appendAvatar}}},l.append):n&&t.createVNode(on,{key:"append-avatar",density:e.density,icon:e.appendIcon,image:e.appendAvatar},null)])])})),{}}}),Li=ht("v-card-text"),Oi=a({appendAvatar:String,appendIcon:Il,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:Il,ripple:{type:[Boolean,Object],default:!0},subtitle:String,text:String,title:String,...Ga(),...l(),...cl(),...Ma(),...Ja(),...Xl(),...Yl(),...eo(),...el(),...oo(),...ua(),...ta(),...fl({variant:"elevated"})},"VCard"),zi=gt()({name:"VCard",directives:{Ripple:ko},props:Oi(),setup(e,a){let{attrs:l,slots:o}=a
const{themeClasses:n}=la(e),{borderClasses:r}=qa(e),{colorClasses:i,colorStyles:s,variantClasses:u}=ml(e),{densityClasses:c}=dl(e),{dimensionStyles:d}=Fa(e),{elevationClasses:v}=Qa(e),{loaderClasses:p}=Zl(e),{locationStyles:f}=Gl(e),{positionClasses:m}=to(e),{roundedClasses:g}=tl(e),h=lo(e,l),y=t.computed((()=>!1!==e.link&&h.isLink.value)),b=t.computed((()=>!e.disabled&&!1!==e.link&&(e.link||h.isClickable.value)))
...
return t.withDirectives(t.createVNode(a,{class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":b.value},n.value,r.value,i.value,c.value,v.value,p.value,m.value,g.value,u.value,e.class],style:[s.value,d.value,f.value,e.style],href:h.href.value,onClick:b.value&&h.navigate,tabindex:e.disabled?-1:void 0},{default:()=>[x&&t.createVNode("div",{key:"image",class:"v-card__image"},[o.image?t.createVNode($a,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},o.image):t.createVNode(Ya,{key:"image-img",cover:!0,src:e.image},null)]),t.createVNode(Jl,{name:"v-card",active:!!e.loading,color:"boolean"==typeof e.loading?void 0:e.loading},{default:o.loader}),N&&t.createVNode(Fi,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:o.item,prepend:o.prepend,title:o.title,subtitle:o.subtitle,append:o.append}),C&&t.createVNode(Li,{key:"text"},{default:()=>[o.text?.()??e.text]}),o.default?.(),o.actions&&t.createVNode(Ei,null,{default:o.actions}),pl(b.value,"v-card")]}),[[t.resolveDirective("ripple"),b.value&&e.ripple]])})),{}}})
function ji(e,t){const a=e.changedTouches[0]
t.touchstartX=a.clientX,t.touchstartY=a.clientY,t.start?.({originalEvent:e,...t})}function Hi(e,t){const a=e.changedTouches[0]
...
e.offsetX=a-t,e.offsetY=o-l,Math.abs(e.offsetY)<.5*Math.abs(e.offsetX)&&(e.left&&a<t-16&&e.left(e),e.right&&a>t+16&&e.right(e)),Math.abs(e.offsetX)<.5*Math.abs(e.offsetY)&&(e.up&&o<l-16&&e.up(e),e.down&&o>l+16&&e.down(e))})(t)}function Wi(e,t){const a=e.changedTouches[0]
t.touchmoveX=a.clientX,t.touchmoveY=a.clientY,t.move?.({originalEvent:e,...t})}const Ui={mounted:function(e,t){const a=t.value,l=a?.parent?e.parentElement:e,o=a?.options??{passive:!0},n=t.instance?.$.uid
if(!l||!n)return
const r=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
const t={touchstartX:0,touchstartY:0,touchendX:0,touchendY:0,touchmoveX:0,touchmoveY:0,offsetX:0,offsetY:0,left:e.left,right:e.right,up:e.up,down:e.down,start:e.start,move:e.move,end:e.end}
return{touchstart:e=>ji(e,t),touchend:e=>Hi(e,t),touchmove:e=>Wi(e,t)}}(t.value)
...
w(o).forEach((e=>{a.removeEventListener(e,o[e])})),delete a._touchHandlers[l]}},Yi=Symbol.for("vuetify:v-window"),Gi=Symbol.for("vuetify:v-window-group"),qi=a({continuous:Boolean,nextIcon:{type:[Boolean,String,Function,Object],default:"$next"},prevIcon:{type:[Boolean,String,Function,Object],default:"$prev"},reverse:Boolean,showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||"hover"===e},touch:{type:[Object,Boolean],default:void 0},direction:{type:String,default:"horizontal"},modelValue:null,disabled:Boolean,selectedClass:{type:String,default:"v-window-item--active"},mandatory:{type:[Boolean,String],default:"force"},...l(),...ua(),...ta()},"VWindow"),Ki=gt()({name:"VWindow",directives:{Touch:Ui},props:qi(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=la(e),{isRtl:n}=Qt(),{t:r}=Jt(),i=Sl(e,Gi),s=t.ref(),u=t.computed((()=>n?!e.reverse:e.reverse)),c=t.shallowRef(!1),d=t.computed((()=>`v-window-${"vertical"===e.direction?"y":"x"}${(u.value?!c.value:c.value)?"-reverse":""}-transition`)),v=t.shallowRef(0),p=t.ref(void 0),f=t.computed((()=>i.items.value.findIndex((e=>i.selected.value.includes(e.id)))))
t.watch(f,((e,t)=>{const a=i.items.value.length,l=a-1
c.value=a<=2?e<t:e===l&&0===t||(0!==e||t!==l)&&e<t})),t.provide(Yi,{transition:d,isReversed:c,transitionCount:v,transitionHeight:p,rootRef:s})
const m=t.computed((()=>e.continuous||0!==f.value)),g=t.computed((()=>e.continuous||f.value!==i.items.value.length-1))
function h(){m.value&&i.prev()}function y(){g.value&&i.next()}const b=t.computed((()=>{const a=[],o={icon:n?e.nextIcon:e.prevIcon,class:"v-window__"+(u.value?"right":"left"),onClick:i.prev,ariaLabel:r("$vuetify.carousel.prev")}
a.push(m.value?l.prev?l.prev({props:o}):t.createVNode(No,o,null):t.createVNode("div",null,null))
const s={icon:n?e.prevIcon:e.nextIcon,class:"v-window__"+(u.value?"left":"right"),onClick:i.next,ariaLabel:r("$vuetify.carousel.next")}
...
return At((()=>t.withDirectives(t.createVNode(e.tag,{ref:s,class:["v-window",{"v-window--show-arrows-on-hover":"hover"===e.showArrows},o.value,e.class],style:e.style},{default:()=>[t.createVNode("div",{class:"v-window__container",style:{height:p.value}},[l.default?.({group:i}),!1!==e.showArrows&&t.createVNode("div",{class:"v-window__controls"},[b.value])]),l.additional?.({group:i})]}),[[t.resolveDirective("touch"),V.value]]))),{group:i}}}),Xi=a({color:String,cycle:Boolean,delimiterIcon:{type:Il,default:"$delimiter"},height:{type:[Number,String],default:500},hideDelimiters:Boolean,hideDelimiterBackground:Boolean,interval:{type:[Number,String],default:6e3,validator:e=>Number(e)>0},progress:[Boolean,String],verticalDelimiters:[Boolean,String],...qi({continuous:!0,mandatory:"force",showArrows:!0})},"VCarousel"),Zi=gt()({name:"VCarousel",props:Xi(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=Ht(e,"modelValue"),{t:n}=Jt(),r=t.ref()
let i=-1
function s(){e.cycle&&r.value&&(i=window.setTimeout(r.value.group.next,+e.interval>0?+e.interval:6e3))}function u(){window.clearTimeout(i),window.requestAnimationFrame(s)}return t.watch(o,u),t.watch((()=>e.interval),u),t.watch((()=>e.cycle),(e=>{e?u():window.clearTimeout(i)})),t.onMounted(s),At((()=>{const a=Ki.filterProps(e)
return t.createVNode(Ki,t.mergeProps({ref:r},a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-carousel",{"v-carousel--hide-delimiter-background":e.hideDelimiterBackground,"v-carousel--vertical-delimiters":e.verticalDelimiters},e.class],style:[{height:h(e.height)},e.style]}),{default:l.default,additional:a=>{let{group:r}=a
...
return l.item?l.item({props:o,item:e}):t.createVNode(No,t.mergeProps(e,o),null)}))]})]),e.progress&&t.createVNode(Kl,{class:"v-carousel__progress",color:"string"==typeof e.progress?e.progress:void 0,modelValue:(r.getItemIndex(o.value)+1)/r.items.value.length*100},null)])},prev:l.prev,next:l.next})})),{}}}),Ji=a({reverseTransition:{type:[Boolean,String],default:void 0},transition:{type:[Boolean,String],default:void 0},...l(),...bl(),...Nr()},"VWindowItem"),Qi=gt()({name:"VWindowItem",directives:{Touch:Ui},props:Ji(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(Yi),n=Vl(e,Gi),{isBooted:r}=rl()
...
return!!s.value&&{name:"string"!=typeof t?o.transition.value:t,onBeforeEnter:c,onAfterEnter:u,onEnterCancelled:d,onBeforeLeave:c,onAfterLeave:u,onLeaveCancelled:d,onEnter:v}})),{hasContent:f}=Cr(e,n.isSelected)
return At((()=>t.createVNode(ja,{transition:p.value,disabled:!r.value},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-window-item",n.selectedClass.value,e.class],style:e.style},[f.value&&l.default?.()]),[[t.vShow,n.isSelected.value]])]}))),{groupItem:n}}}),es=a({...Ua(),...Ji()},"VCarouselItem"),ts=gt()({name:"VCarouselItem",inheritAttrs:!1,props:es(),setup(e,a){let{slots:l,attrs:o}=a
At((()=>{const a=Ya.filterProps(e),n=Qi.filterProps(e)
return t.createVNode(Qi,t.mergeProps({class:"v-carousel-item"},n),{default:()=>[t.createVNode(Ya,t.mergeProps(o,a),l)]})}))}}),as=ht("v-code"),ls=mt({name:"VColorPickerCanvas",props:a({color:{type:Object},disabled:Boolean,dotSize:{type:[Number,String],default:10},height:{type:[Number,String],default:150},width:{type:[Number,String],default:300},...l()},"VColorPickerCanvas")(),emits:{"update:color":e=>!0,"update:position":e=>!0},setup(e,a){let{emit:l}=a
...
const os={h:0,s:0,v:1,a:1},ns={inputProps:{type:"number",min:0},inputs:[{label:"R",max:255,step:1,getValue:e=>Math.round(e.r),getColor:(e,t)=>({...e,r:Number(t)})},{label:"G",max:255,step:1,getValue:e=>Math.round(e.g),getColor:(e,t)=>({...e,g:Number(t)})},{label:"B",max:255,step:1,getValue:e=>Math.round(e.b),getColor:(e,t)=>({...e,b:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:Ye,from:qe},rs={inputProps:{type:"number",min:0},inputs:[{label:"H",max:360,step:1,getValue:e=>Math.round(e.h),getColor:(e,t)=>({...e,h:Number(t)})},{label:"S",max:1,step:.01,getValue:e=>Math.round(100*e.s)/100,getColor:(e,t)=>({...e,s:Number(t)})},{label:"L",max:1,step:.01,getValue:e=>Math.round(100*e.l)/100,getColor:(e,t)=>({...e,l:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:Ke,from:Xe},is={inputProps:{type:"text"},inputs:[{label:"HEXA",getValue:e=>e,getColor:(e,t)=>t}],to:lt,from:at},ss={rgb:{...ns,inputs:ns.inputs?.slice(0,3)},rgba:ns,hsl:{...rs,inputs:rs.inputs.slice(0,3)},hsla:rs,hex:{...is,inputs:[{label:"HEX",getValue:e=>e.slice(0,7),getColor:(e,t)=>t}]},hexa:is},us=e=>{let{label:a,...l}=e
return t.createVNode("div",{class:"v-color-picker-edit__input"},[t.createVNode("input",l,null),t.createVNode("span",null,[a])])},cs=mt({name:"VColorPickerEdit",props:a({color:Object,disabled:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys(ss).includes(e)},modes:{type:Array,default:()=>Object.keys(ss),validator:e=>Array.isArray(e)&&e.every((e=>Object.keys(ss).includes(e)))},...l()},"VColorPickerEdit")(),emits:{"update:color":e=>!0,"update:mode":e=>!0},setup(e,a){let{emit:l}=a
const o=t.computed((()=>e.modes.map((e=>({...ss[e],name:e}))))),n=t.computed((()=>{const t=o.value.find((t=>t.name===e.mode))
if(!t)return[]
...
o&&l("update:color",t.from(r(a??os,o.value)))}}}))}))
return At((()=>t.createVNode("div",{class:["v-color-picker-edit",e.class],style:e.style},[n.value?.map((e=>t.createVNode(us,e,null))),o.value.length>1&&t.createVNode(No,{icon:"$unfold",size:"x-small",variant:"plain",onClick:()=>{const t=o.value.findIndex((t=>t.name===e.mode))
l("update:mode",o.value[(t+1)%o.value.length].name)}},null)]))),{}}}),ds=Symbol.for("vuetify:v-slider")
function vs(e,t,a){const l="vertical"===a,o=t.getBoundingClientRect(),n="touches"in e?e.touches[0]:e
return l?n.clientY-(o.top+o.height/2):n.clientX-(o.left+o.width/2)}const ps=a({disabled:{type:Boolean,default:null},error:Boolean,readonly:{type:Boolean,default:null},max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>"boolean"==typeof e||"always"===e},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>"boolean"==typeof e||"always"===e},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,...el(),...Ja({elevation:2}),ripple:{type:Boolean,default:!0}},"Slider"),fs=e=>{const a=t.computed((()=>parseFloat(e.min))),l=t.computed((()=>parseFloat(e.max))),o=t.computed((()=>+e.step>0?parseFloat(e.step):0)),n=t.computed((()=>Math.max(D(o.value),D(a.value))))
...
return parseFloat(Math.min(i,l.value).toFixed(n.value))}}},ms=e=>{let{props:a,steps:l,onSliderStart:o,onSliderMove:n,onSliderEnd:r,getActiveThumb:i}=e
const{isRtl:s}=Qt(),u=t.toRef(a,"reverse"),c=t.computed((()=>"vertical"===a.direction)),d=t.computed((()=>c.value!==u.value)),{min:v,max:p,step:f,decimals:m,roundValue:h}=l,y=t.computed((()=>parseInt(a.thumbSize,10))),b=t.computed((()=>parseInt(a.tickSize,10))),V=t.computed((()=>parseInt(a.trackSize,10))),S=t.computed((()=>(p.value-v.value)/f.value)),w=t.toRef(a,"disabled"),k=t.computed((()=>a.error||a.disabled?void 0:a.thumbColor??a.color)),x=t.computed((()=>a.error||a.disabled?void 0:a.trackColor??a.color)),N=t.computed((()=>a.error||a.disabled?void 0:a.trackFillColor??a.color)),C=t.shallowRef(!1),_=t.shallowRef(0),I=t.ref(),P=t.ref()
...
return(t?d.value:d.value!==s)&&(c=1-c),h(v.value+c*(p.value-v.value))}const A=e=>{r({value:B(e)}),C.value=!1,_.value=0},R=e=>{P.value=i(e),P.value&&(P.value.focus(),C.value=!0,P.value.contains(e.target)?_.value=vs(e,P.value,a.direction):(_.value=0,n({value:B(e)})),o({value:B(e)}))},T={passive:!0,capture:!0}
...
return t.provide(ds,j),j},gs=a({focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0},ripple:{type:[Boolean,Object],default:!0},...l()},"VSliderThumb"),hs=gt()({name:"VSliderThumb",directives:{Ripple:ko},props:gs(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=t.inject(ds),{isRtl:r,rtlClasses:i}=Qt()
if(!n)throw new Error("[Vuetify] v-slider-thumb must be used inside v-slider or v-range-slider")
const{thumbColor:s,step:u,disabled:c,thumbSize:d,thumbLabel:v,direction:p,isReversed:f,vertical:m,readonly:g,elevation:y,mousePressed:b,decimals:V,indexFromEnd:w}=n,{textColorClasses:k,textColorStyles:x}=Xa(s),{pageup:N,pagedown:C,end:_,home:I,left:P,right:B,down:A,up:R}=S,T=[N,C,_,I,P,B,A,R],E=t.computed((()=>u.value?[1,2,3]:[1,5,10]))
function D(t){const a=function(t,a){if(!T.includes(t.key))return
t.preventDefault()
const l=u.value||.1,o=(e.max-e.min)/l
if([P,B,A,R].includes(t.key)){const e=(m.value?[r?P:B,f.value?A:R]:w.value!==r?[P,R]:[B,R]).includes(t.key)?1:-1,o=t.shiftKey?2:t.ctrlKey?1:0
a+=e*l*E.value[o]}else t.key===I?a=e.min:t.key===_?a=e.max:a-=(t.key===C?1:-1)*l*(o>100?o/10:10)
return Math.max(e.min,Math.min(e.max,a))}(t,e.modelValue)
null!=a&&o("update:modelValue",a)}return At((()=>{const a=h(w.value?100-e.position:e.position,"%"),{elevationClasses:o}=Qa(t.computed((()=>c.value?void 0:y.value)))
return t.createVNode("div",{class:["v-slider-thumb",{"v-slider-thumb--focused":e.focused,"v-slider-thumb--pressed":e.focused&&b.value},e.class,i],style:[{"--v-slider-thumb-position":a,"--v-slider-thumb-size":h(d.value)},e.style],role:"slider",tabindex:c.value?-1:0,"aria-valuemin":e.min,"aria-valuemax":e.max,"aria-valuenow":e.modelValue,"aria-readonly":!!g.value,"aria-orientation":p.value,onKeydown:g.value?void 0:D},[t.createVNode("div",{class:["v-slider-thumb__surface",k.value,o.value],style:{...x.value}},null),t.withDirectives(t.createVNode("div",{class:["v-slider-thumb__ripple",k.value],style:x.value},null),[[t.resolveDirective("ripple"),e.ripple,null,{circle:!0,center:!0}]]),t.createVNode(xa,{origin:"bottom center"},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-slider-thumb__label-container"},[t.createVNode("div",{class:["v-slider-thumb__label"]},[t.createVNode("div",null,[l["thumb-label"]?.({modelValue:e.modelValue})??e.modelValue.toFixed(u.value?V.value:1)])])]),[[t.vShow,v.value&&e.focused||"always"===v.value]])]})])})),{}}}),ys=a({start:{type:Number,required:!0},stop:{type:Number,required:!0},...l()},"VSliderTrack"),bs=gt()({name:"VSliderTrack",props:ys(),emits:{},setup(e,a){let{slots:l}=a
const o=t.inject(ds)
if(!o)throw new Error("[Vuetify] v-slider-track must be inside v-slider or v-range-slider")
const{color:n,parsedTicks:r,rounded:i,showTicks:s,tickSize:u,trackColor:c,trackFillColor:d,trackSize:v,vertical:p,min:f,max:m,indexFromEnd:g}=o,{roundedClasses:y}=tl(i),{backgroundColorClasses:b,backgroundColorStyles:V}=Za(d),{backgroundColorClasses:S,backgroundColorStyles:w}=Za(c),k=t.computed((()=>`inset-${p.value?"block":"inline"}-${g.value?"end":"start"}`)),x=t.computed((()=>p.value?"height":"width")),N=t.computed((()=>({[k.value]:"0%",[x.value]:"100%"}))),C=t.computed((()=>e.stop-e.start)),_=t.computed((()=>({[k.value]:h(e.start,"%"),[x.value]:h(C.value,"%")}))),I=t.computed((()=>{if(!s.value)return[]
...
return At((()=>t.createVNode("div",{class:["v-slider-track",y.value,e.class],style:[{"--v-slider-track-size":h(v.value),"--v-slider-tick-size":h(u.value)},e.style]},[t.createVNode("div",{class:["v-slider-track__background",S.value,{"v-slider-track__background--opacity":!!n.value||!d.value}],style:{...N.value,...w.value}},null),t.createVNode("div",{class:["v-slider-track__fill",b.value],style:{..._.value,...V.value}},null),s.value&&t.createVNode("div",{class:["v-slider-track__ticks",{"v-slider-track__ticks--always-show":"always"===s.value}]},[I.value])]))),{}}}),Vs=a({...Yo(),...ps(),...Qo(),modelValue:{type:[Number,String],default:0}},"VSlider"),Ss=gt()({name:"VSlider",props:Vs(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,start:e=>!0,end:e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=t.ref(),{rtlClasses:r}=Qt(),i=fs(e),s=Ht(e,"modelValue",void 0,(e=>i.roundValue(null==e?i.min.value:e))),{min:u,max:c,mousePressed:d,roundValue:v,onSliderMousedown:p,onSliderTouchstart:f,trackContainerRef:m,position:g,hasLabels:h,readonly:y}=ms({props:e,steps:i,onSliderStart:()=>{o("start",s.value)},onSliderEnd:e=>{let{value:t}=e
const a=v(t)
s.value=a,o("end",a)},onSliderMove:e=>{let{value:t}=e
return s.value=v(t)},getActiveThumb:()=>n.value?.$el}),{isFocused:b,focus:V,blur:S}=Go(e),w=t.computed((()=>g(s.value)))
return At((()=>{const a=en.filterProps(e),o=!!(e.label||l.label||l.prepend)
return t.createVNode(en,t.mergeProps({class:["v-slider",{"v-slider--has-labels":!!l["tick-label"]||h.value,"v-slider--focused":b.value,"v-slider--pressed":d.value,"v-slider--disabled":e.disabled},r,e.class],style:e.style},a,{focused:b.value}),{...l,prepend:o?a=>t.createVNode(t.Fragment,null,[l.label?.(a)??(e.label?t.createVNode(Eo,{id:a.id.value,class:"v-slider__label",text:e.label},null):void 0),l.prepend?.(a)]):void 0,default:a=>{let{id:o,messagesId:r}=a
return t.createVNode("div",{class:"v-slider__container",onMousedown:y.value?void 0:p,onTouchstartPassive:y.value?void 0:f},[t.createVNode("input",{id:o.value,name:e.name||o.value,disabled:!!e.disabled,readonly:!!e.readonly,tabindex:"-1",value:s.value},null),t.createVNode(bs,{ref:m,start:0,stop:w.value},{"tick-label":l["tick-label"]}),t.createVNode(hs,{ref:n,"aria-describedby":r.value,focused:b.value,min:u.value,max:c.value,modelValue:s.value,"onUpdate:modelValue":e=>s.value=e,position:w.value,elevation:e.elevation,onFocus:V,onBlur:S,ripple:e.ripple},{"thumb-label":l["thumb-label"]})])}})})),{}}}),ws=mt({name:"VColorPickerPreview",props:a({color:{type:Object},disabled:Boolean,hideAlpha:Boolean,...l()},"VColorPickerPreview")(),emits:{"update:color":e=>!0},setup(e,a){let{emit:l}=a
const o=new AbortController
async function n(){if(!i)return
const t=new window.EyeDropper
try{const a=at((await t.open({signal:o.signal})).sRGBHex)
l("update:color",{...e.color??os,...a})}catch(e){}}return t.onUnmounted((()=>o.abort())),At((()=>t.createVNode("div",{class:["v-color-picker-preview",{"v-color-picker-preview--hide-alpha":e.hideAlpha},e.class],style:e.style},[i&&t.createVNode("div",{class:"v-color-picker-preview__eye-dropper",key:"eyeDropper"},[t.createVNode(No,{onClick:n,icon:"$eyeDropper",variant:"plain",density:"comfortable"},null)]),t.createVNode("div",{class:"v-color-picker-preview__dot"},[t.createVNode("div",{style:{background:Je(e.color??os)}},null)]),t.createVNode("div",{class:"v-color-picker-preview__sliders"},[t.createVNode(Ss,{class:"v-color-picker-preview__track v-color-picker-preview__hue",modelValue:e.color?.h,"onUpdate:modelValue":t=>l("update:color",{...e.color??os,h:t}),step:0,min:0,max:360,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null),!e.hideAlpha&&t.createVNode(Ss,{class:"v-color-picker-preview__track v-color-picker-preview__alpha",modelValue:e.color?.a??1,"onUpdate:modelValue":t=>l("update:color",{...e.color??os,a:t}),step:1/256,min:0,max:1,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null)])]))),{}}})
...
const xs=mt({name:"VColorPickerSwatches",props:a({swatches:{type:Array,default:()=>function(e){return Object.keys(e).map((t=>{const a=e[t]
return a.base?[a.base,a.darken4,a.darken3,a.darken2,a.darken1,a.lighten1,a.lighten2,a.lighten3,a.lighten4,a.lighten5]:[a.black,a.white,a.transparent]}))}(ks)},disabled:Boolean,color:Object,maxHeight:[Number,String],...l()},"VColorPickerSwatches")(),emits:{"update:color":e=>!0},setup(e,a){let{emit:l}=a
...
return t.createVNode("div",{class:"v-color-picker-swatches__color",onClick:()=>n&&l("update:color",n)},[t.createVNode("div",{style:{background:r}},[e.color&&p(e.color,n)?t.createVNode(zl,{size:"x-small",icon:"$success",color:it(a,"#FFFFFF")>2?"white":"black"},null):void 0])])}))])))])]))),{}}}),Ns=a({color:String,...Ga(),...l(),...Ma(),...Ja(),...Yl(),...eo(),...el(),...ua(),...ta()},"VSheet"),Cs=gt()({name:"VSheet",props:Ns(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=la(e),{backgroundColorClasses:n,backgroundColorStyles:r}=Za(t.toRef(e,"color")),{borderClasses:i}=qa(e),{dimensionStyles:s}=Fa(e),{elevationClasses:u}=Qa(e),{locationStyles:c}=Gl(e),{positionClasses:d}=to(e),{roundedClasses:v}=tl(e)
return At((()=>t.createVNode(e.tag,{class:["v-sheet",o.value,n.value,i.value,u.value,d.value,v.value,e.class],style:[r.value,s.value,c.value,e.style]},l))),{}}}),_s=mt({name:"VColorPicker",props:a({canvasHeight:{type:[String,Number],default:150},disabled:Boolean,dotSize:{type:[Number,String],default:10},hideCanvas:Boolean,hideSliders:Boolean,hideInputs:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys(ss).includes(e)},modes:{type:Array,default:()=>Object.keys(ss),validator:e=>Array.isArray(e)&&e.every((e=>Object.keys(ss).includes(e)))},showSwatches:Boolean,swatches:Array,swatchesMaxHeight:{type:[Number,String],default:150},modelValue:{type:[Object,String]},...C(Ns({width:300}),["height","location","minHeight","maxHeight","minWidth","maxWidth"])},"VColorPicker")(),emits:{"update:modelValue":e=>!0,"update:mode":e=>!0},setup(e){const a=Ht(e,"mode"),l=t.ref(null),o=Ht(e,"modelValue",void 0,(e=>{if(null==e||""===e)return null
let t
...
return t.onMounted((()=>{e.modes.includes(a.value)||(a.value=e.modes[0])})),vt({VSlider:{color:void 0,trackColor:void 0,trackFillColor:void 0}}),At((()=>{const l=Cs.filterProps(e)
return t.createVNode(Cs,t.mergeProps({rounded:e.rounded,elevation:e.elevation,theme:e.theme,class:["v-color-picker",n,e.class],style:[{"--v-color-picker-color-hsv":Je({...o.value??os,a:1})},e.style]},l,{maxWidth:e.width}),{default:()=>[!e.hideCanvas&&t.createVNode(ls,{key:"canvas",color:o.value,"onUpdate:color":r,disabled:e.disabled,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(ws,{key:"preview",color:o.value,"onUpdate:color":r,hideAlpha:!a.value.endsWith("a"),disabled:e.disabled},null),!e.hideInputs&&t.createVNode(cs,{key:"edit",modes:e.modes,mode:a.value,"onUpdate:mode":e=>a.value=e,color:o.value,"onUpdate:color":r,disabled:e.disabled},null)]),e.showSwatches&&t.createVNode(xs,{key:"swatches",color:o.value,"onUpdate:color":r,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled},null)]})})),{}}})
const Is=a({autoSelectFirst:{type:[Boolean,String]},delimiters:Array,...di({filterKeys:["title"]}),...ii({hideNoData:!0,returnObject:!0}),...C(Jr({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...za({transition:!1})},"VCombobox"),Ps=gt()({name:"VCombobox",props:Is(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,a){let{emit:l,slots:n}=a
...
let g=!1
const h=t.computed((()=>i.value?.color)),y=t.computed((()=>f.value?e.closeText:e.openText)),{items:b,transformIn:V,transformOut:S}=On(e),{textColorClasses:w,textColorStyles:k}=Xa(h),x=Ht(e,"modelValue",[],(e=>V(T(e))),(t=>{const a=S(t)
return e.multiple?a:a[0]??null})),N=Xo(),C=t.shallowRef(e.multiple?"":x.value[0]?.title??""),_=t.computed({get:()=>C.value,set:t=>{if(C.value=t??"",e.multiple||(x.value=[Fn(e,t)]),t&&e.multiple&&e.delimiters?.length){const a=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
a.length>1&&(a.forEach((t=>{(t=t.trim())&&W(Fn(e,t))})),C.value="")}t||(m.value=-1),u.value=!t}})
t.watch(C,(e=>{g?t.nextTick((()=>g=!1)):s.value&&!f.value&&(f.value=!0),l("update:search",e)})),t.watch(x,(t=>{e.multiple||(C.value=t[0]?.title??"")}))
const{filteredItems:I,getMatches:P}=vi(e,b,(()=>u.value?"":_.value)),B=t.computed((()=>e.hideSelected?I.value.filter((e=>!x.value.some((t=>t.value===e.value)))):I.value)),R=t.computed((()=>x.value.map((e=>e.value)))),E=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&_.value===B.value[0]?.title)&&B.value.length>0&&!u.value&&!c.value)),D=t.computed((()=>e.hideNoData&&!b.value.length||e.readonly||N?.isReadonly.value)),$=t.ref(),{onListScroll:M,onListKeydown:F}=ri($,i)
...
const e=m.value+1
x.value[e]?m.value=e:(m.value=-1,i.value.setSelectionRange(0,0))}"Enter"===t.key&&_.value&&(W(Fn(e,_.value)),_.value="")}}function H(){s.value&&(u.value=!0,i.value?.focus())}function W(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
...
x.value=e?[a]:[],C.value=e?a.title:"",t.nextTick((()=>{f.value=!1,u.value=!0}))}}function U(e){s.value=!0,setTimeout((()=>{c.value=!0}))}function Y(e){c.value=!1}function G(t){(null==t||""===t&&!e.multiple)&&(x.value=[])}return t.watch(I,(t=>{!t.length&&e.hideNoData&&(f.value=!1)})),t.watch(s,((t,a)=>{t||t===a||(m.value=-1,f.value=!1,!E.value||c.value||x.value.some((e=>{let{value:t}=e
return t===B.value[0].value}))?e.multiple&&_.value&&W(Fn(e,_.value)):W(B.value[0]))})),t.watch(f,(()=>{if(!e.hideSelected&&f.value&&x.value.length){const t=B.value.findIndex((t=>x.value.some((a=>e.valueComparator(a.value,t.value)))))
o&&window.requestAnimationFrame((()=>{t>=0&&v.value?.scrollToIndex(t)}))}})),At((()=>{const a=!(!e.chips&&!n.chip),l=!!(!e.hideNoData||B.value.length||n["prepend-item"]||n["append-item"]||n["no-data"]),o=x.value.length>0,c=Qr.filterProps(e)
return t.createVNode(Qr,t.mergeProps({ref:i},c,{modelValue:_.value,"onUpdate:modelValue":[e=>_.value=e,G],focused:s.value,"onUpdate:focused":e=>s.value=e,validationValue:x.externalValue,counterValue:e.multiple?x.value.length:_.value.length,dirty:o,class:["v-combobox",{"v-combobox--active-menu":f.value,"v-combobox--chips":!!e.chips,"v-combobox--selection-slot":!!n.selection,"v-combobox--selecting-index":m.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0},e.class],style:e.style,readonly:e.readonly,placeholder:o?void 0:e.placeholder,"onClick:clear":L,"onMousedown:control":O,onKeydown:j}),{...n,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(jr,t.mergeProps({ref:d,modelValue:f.value,"onUpdate:modelValue":e=>f.value=e,activator:"parent",contentClass:"v-combobox__content",disabled:D.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:H},e.menuProps),{default:()=>[l&&t.createVNode(Wn,{ref:$,selected:R.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:F,onFocusin:U,onFocusout:Y,onScrollPassive:M,tabindex:"-1",color:e.itemColor??e.color},{default:()=>[n["prepend-item"]?.(),!B.value.length&&!e.hideNoData&&(n["no-data"]?.()??t.createVNode(Bn,{title:r(e.noDataText)},null)),t.createVNode(ni,{ref:v,renderless:!0,items:B.value},{default:a=>{let{item:l,index:o,itemRef:r}=a
const i=t.mergeProps(l.props,{ref:r,key:o,active:!(!E.value||0!==o)||void 0,onClick:()=>W(l,null)})
return n.item?.({item:l,index:o,props:i})??t.createVNode(Bn,i,{prepend:a=>{let{isSelected:o}=a
return t.createVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(jo,{key:l.value,modelValue:o,ripple:!1,tabindex:"-1"},null):void 0,l.props.prependIcon&&t.createVNode(zl,{icon:l.props.prependIcon},null)])},title:()=>u.value?l.title:function(e,a,l){if(null==a)return e
if(Array.isArray(a))throw new Error("Multiple matches is not implemented")
return"number"==typeof a&&~a?t.createVNode(t.Fragment,null,[t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(0,a)]),t.createVNode("span",{class:"v-combobox__mask"},[e.substr(a,l)]),t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(a+l)])]):e}(l.title,P(l)?.title,_.value?.length??0)})}}),n["append-item"]?.()]})]}),x.value.map(((l,o)=>{const r={"onClick:close":function(e){e.stopPropagation(),e.preventDefault(),W(l,!1)},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=a?!!n.chip:!!n.selection,s=i?oe(a?n.chip({item:l,index:o,props:r}):n.selection({item:l,index:o})):void 0
if(!i||s)return t.createVNode("div",{key:l.value,class:["v-combobox__selection",o===m.value&&["v-combobox__selection--selected",w.value]],style:o===m.value?k.value:{}},[a?n.chip?t.createVNode($a,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:l.title}}},{default:()=>[s]}):t.createVNode(cn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:l.title,disabled:l.props.disabled},r),null):s??t.createVNode("span",{class:"v-combobox__selection-text"},[l.title,e.multiple&&o<x.value.length-1&&t.createVNode("span",{class:"v-combobox__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,l=new Array(a),o=0;o<a;o++)l[o]=arguments[o]
return t.createVNode(t.Fragment,null,[n["append-inner"]?.(...l),e.hideNoData&&!e.items.length||!e.menuIcon?void 0:t.createVNode(zl,{class:"v-combobox__menu-icon",icon:e.menuIcon,onMousedown:z,onClick:ae,"aria-label":r(y.value),title:r(y.value)},null)])}})})),Or({isFocused:s,isPristine:u,menu:f,search:_,selectionIndex:m,filteredItems:I,select:W},i)}}),Bs=a({expandOnClick:Boolean,showExpand:Boolean,expanded:{type:Array,default:()=>[]}},"DataTable-expand"),As=Symbol.for("vuetify:datatable:expanded")
function Rs(e){const a=t.toRef(e,"expandOnClick"),l=Ht(e,"expanded",e.expanded,(e=>new Set(e)),(e=>[...e.values()]))
...
return t.provide(As,r),r}function Ts(){const e=t.inject(As)
if(!e)throw new Error("foo")
return e}const Es=a({groupBy:{type:Array,default:()=>[]}},"DataTable-group"),Ds=Symbol.for("vuetify:data-table-group")
...
return t.provide(Ds,r),r}function Fs(){const e=t.inject(Ds)
if(!e)throw new Error("Missing group!")
return e}function Ls(e,t){if(!e.length)return[]
const a=new Map
for(const l of e){const e=f(l.raw,t)
a.has(e)||a.set(e,[]),a.get(e).push(l)}return a}function Os(e,t){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"root"
if(!t.length)return[]
const o=Ls(e,t[0]),n=[],r=t.slice(1)
return o.forEach(((e,o)=>{const i=t[0],s=`${l}_${i}_${o}`
n.push({depth:a,id:s,key:i,value:o,items:r.length?Os(e,r,a+1,s):e,type:"group"})})),n}function zs(e,t){const a=[]
...
return zs(Os(e.value,a.value.map((e=>e.key))),l.value)}))}}function Hs(e){let{page:a,itemsPerPage:l,sortBy:o,groupBy:n,search:r}=e
const i=St("VDataTable"),s=t.computed((()=>({page:a.value,itemsPerPage:l.value,sortBy:o.value,groupBy:n.value,search:r.value})))
let u=null
t.watch(s,(()=>{p(u,s.value)||(u?.search!==s.value.search&&(a.value=1),i.emit("update:options",s.value),u=s.value)}),{deep:!0,immediate:!0})}const Ws=a({page:{type:[Number,String],default:1},itemsPerPage:{type:[Number,String],default:10}},"DataTable-paginate"),Us=Symbol.for("vuetify:data-table-pagination")
function Ys(e){return{page:Ht(e,"page",void 0,(e=>+(e??1))),itemsPerPage:Ht(e,"itemsPerPage",void 0,(e=>+(e??10)))}}function Gs(e){const{page:a,itemsPerPage:l,itemsLength:o}=e,n=t.computed((()=>-1===l.value?0:l.value*(a.value-1))),r=t.computed((()=>-1===l.value?o.value:Math.min(o.value,n.value+l.value))),i=t.computed((()=>-1===l.value||0===o.value?1:Math.ceil(o.value/l.value)))
...
return t.provide(Us,s),s}function qs(e){const{items:a,startIndex:l,stopIndex:o,itemsPerPage:n}=e
return{paginatedItems:t.computed((()=>n.value<=0?a.value:a.value.slice(l.value,o.value)))}}const Ks={showSelectAll:!1,allSelected:()=>[],select:e=>{let{items:t,value:a}=e
return new Set(a?[t[0]?.value]:[])},selectAll:e=>{let{selected:t}=e
return t}},Xs={showSelectAll:!0,allSelected:e=>{let{currentPage:t}=e
...
return Xs.select({items:a,value:t,selected:l})}},Zs={showSelectAll:!0,allSelected:e=>{let{allItems:t}=e
return t},select:e=>{let{items:t,value:a,selected:l}=e
for(const e of t)a?l.add(e.value):l.delete(e.value)
return l},selectAll:e=>{let{value:t,allItems:a,selected:l}=e
return Zs.select({items:a,value:t,selected:l})}},Js=a({showSelect:Boolean,selectStrategy:{type:[String,Object],default:"page"},modelValue:{type:Array,default:()=>[]},valueComparator:{type:Function,default:p}},"DataTable-select"),Qs=Symbol.for("vuetify:data-table-selection")
function eu(e,a){let{allItems:l,currentPage:o}=a
...
switch(e.selectStrategy){case"single":return Ks
case"all":return Zs
case"page":default:return Xs}}))
...
return t.provide(Qs,p),p}function tu(){const e=t.inject(Qs)
if(!e)throw new Error("Missing selection!")
return e}const au={"001":1,AD:1,AE:6,AF:6,AG:0,AI:1,AL:1,AM:1,AN:1,AR:1,AS:0,AT:1,AU:1,AX:1,AZ:1,BA:1,BD:0,BE:1,BG:1,BH:6,BM:1,BN:1,BR:0,BS:0,BT:0,BW:0,BY:1,BZ:0,CA:0,CH:1,CL:1,CM:1,CN:1,CO:0,CR:1,CY:1,CZ:1,DE:1,DJ:6,DK:1,DM:0,DO:0,DZ:6,EC:1,EE:1,EG:6,ES:1,ET:0,FI:1,FJ:1,FO:1,FR:1,GB:1,"GB-alt-variant":0,GE:1,GF:1,GP:1,GR:1,GT:0,GU:0,HK:0,HN:0,HR:1,HU:1,ID:0,IE:1,IL:0,IN:0,IQ:6,IR:6,IS:1,IT:1,JM:0,JO:6,JP:0,KE:0,KG:1,KH:0,KR:0,KW:6,KZ:1,LA:0,LB:1,LI:1,LK:1,LT:1,LU:1,LV:1,LY:6,MC:1,MD:1,ME:1,MH:0,MK:1,MM:0,MN:1,MO:0,MQ:1,MT:0,MV:5,MX:0,MY:1,MZ:0,NI:0,NL:1,NO:1,NP:0,NZ:1,OM:6,PA:0,PE:0,PH:0,PK:0,PL:1,PR:0,PT:0,PY:0,QA:6,RE:1,RO:1,RS:1,RU:1,SA:0,SD:6,SE:1,SG:0,SI:1,SK:1,SM:1,SV:0,SY:6,TH:0,TJ:1,TM:1,TR:1,TT:0,TW:0,UA:1,UM:0,US:0,UY:1,UZ:1,VA:1,VE:0,VI:0,VN:1,WS:0,XK:1,YE:0,ZA:0,ZW:0}
function lu(e){return new Date(e.getFullYear(),e.getMonth(),1)}function ou(e){return new Date(e.getFullYear(),e.getMonth()+1,0)}const nu=/^([12]\d{3}-([1-9]|0[1-9]|1[0-2])-([1-9]|0[1-9]|[12]\d|3[01]))$/
function ru(e){if(null==e)return new Date
if(e instanceof Date)return e
if("string"==typeof e){let t
if(nu.test(e))return function(e){const t=e.split("-").map(Number)
return new Date(t[0],t[1]-1,t[2])}(e)
if(t=Date.parse(e),!isNaN(t))return new Date(t)}return null}const iu=new Date(2e3,0,2)
function su(e,t,a,l){const o=ru(e)??new Date,n=l?.[t]
...
break
default:r=n??{timeZone:"UTC",timeZoneName:"short"}}return new Intl.DateTimeFormat(a,r).format(o)}function uu(e,t){return e.getTime()>t.getTime()}function cu(e,t){return e.getTime()===t.getTime()}class du{constructor(e){this.locale=e.locale,this.formats=e.formats}date(e){return ru(e)}toJsDate(e){return e}toISO(e){return function(e,t){const a=e.toJsDate(t)
...
let l=[]
const o=lu(e),n=ou(e),r=(o.getDay()-au[t.slice(-2).toUpperCase()]+7)%7,i=(n.getDay()-au[t.slice(-2).toUpperCase()]+7)%7
...
t.setDate(t.getDate()+e),l.push(t)}return a.push(l),a}(e,this.locale)}startOfMonth(e){return lu(e)}endOfMonth(e){return ou(e)}format(e,t){return su(e,t,this.locale,this.formats)}isEqual(e,t){return cu(e,t)}isValid(e){return function(e){const t=new Date(e)
return t instanceof Date&&!isNaN(t.getTime())}(e)}isWithinRange(e,t){return function(e,t){return uu(e,t[0])&&function(e,t){return e.getTime()<t.getTime()}(e,t[1])}(e,t)}isAfter(e,t){return uu(e,t)}isBefore(e,t){return!uu(e,t)&&!cu(e,t)}isSameDay(e,t){return function(e,t){return e.getDate()===t.getDate()&&e.getMonth()===t.getMonth()&&e.getFullYear()===t.getFullYear()}(e,t)}isSameMonth(e,t){return function(e,t){return e.getMonth()===t.getMonth()&&e.getFullYear()===t.getFullYear()}(e,t)}setMonth(e,t){return function(e,t){const a=new Date(e)
...
return"month"===a?l.getMonth()-o.getMonth()+12*(l.getFullYear()-o.getFullYear()):Math.floor((l.getTime()-o.getTime())/864e5)}(e,t,a)}getWeekdays(){return function(e){const t=au[e.slice(-2).toUpperCase()]
return g(7).map((a=>{const l=new Date(iu)
return l.setDate(iu.getDate()+t+a),new Intl.DateTimeFormat(e,{weekday:"narrow"}).format(l)}))}(this.locale)}getYear(e){return function(e){return e.getFullYear()}(e)}getMonth(e){return function(e){return e.getMonth()}(e)}getNextMonth(e){return function(e){return new Date(e.getFullYear(),e.getMonth()+1,1)}(e)}startOfDay(e){return function(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate())}(e)}endOfDay(e){return function(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate(),23,59,59,999)}(e)}startOfYear(e){return function(e){return new Date(e.getFullYear(),0,1)}(e)}endOfYear(e){return function(e){return new Date(e.getFullYear(),11,31)}(e)}}const vu=Symbol.for("vuetify:date-options"),pu=Symbol.for("vuetify:date-adapter")
function fu(e,t){const a=L({adapter:du,locale:{af:"af-ZA",bg:"bg-BG",ca:"ca-ES",ckb:"",cs:"cs-CZ",de:"de-DE",el:"el-GR",en:"en-US",et:"et-EE",fa:"fa-IR",fi:"fi-FI",hr:"hr-HR",hu:"hu-HU",he:"he-IL",id:"id-ID",it:"it-IT",ja:"ja-JP",ko:"ko-KR",lv:"lv-LV",lt:"lt-LT",nl:"nl-NL",no:"no-NO",pl:"pl-PL",pt:"pt-PT",ro:"ro-RO",ru:"ru-RU",sk:"sk-SK",sl:"sl-SI",srCyrl:"sr-SP",srLatn:"sr-SP",sv:"sv-SE",th:"th-TH",tr:"tr-TR",az:"az-AZ",uk:"uk-UA",vi:"vi-VN",zhHans:"zh-CN",zhHant:"zh-TW"}},e)
return{options:a,instance:mu(a,t)}}function mu(e,a){const l=t.reactive("function"==typeof e.adapter?new e.adapter({locale:e.locale[a.current.value]??a.current.value,formats:e.formats}):e.adapter)
return t.watch(a.current,(t=>{l.locale=e.locale[t]??t??l.locale})),l}function gu(){const e=t.inject(vu)
if(!e)throw new Error("[Vuetify] Could not find injected date options")
return mu(e,Jt())}const hu=a({sortBy:{type:Array,default:()=>[]},customKeySort:Object,multiSort:Boolean,mustSort:Boolean},"DataTable-sort"),yu=Symbol.for("vuetify:data-table-sort")
...
return a}(e,e.items)))}}const Nu=a({search:String,loading:Boolean,...l(),...wu(),...Js(),...hu(),...Ws({itemsPerPage:5}),...Bs(),...Es(),...di(),...ua()},"VDataIterator"),Cu=gt()({name:"VDataIterator",props:Nu(),emits:{"update:modelValue":e=>!0,"update:groupBy":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0},setup(e,a){let{slots:l}=a
const o=Ht(e,"groupBy"),n=t.toRef(e,"search"),{items:r}=xu(e),{filteredItems:i}=vi(e,r,n,{transform:e=>e.raw}),{sortBy:s,multiSort:u,mustSort:c}=bu(e),{page:d,itemsPerPage:v}=Ys(e),{toggleSort:p}=Vu({sortBy:s,multiSort:u,mustSort:c,page:d}),{sortByWithGroups:f,opened:m,extractRows:g,isGroupOpen:h,toggleGroup:y}=Ms({groupBy:o,sortBy:s}),{sortedItems:b}=Su(e,i,f),{flatItems:V}=js(b,o,m),S=t.computed((()=>V.value.length)),{startIndex:w,stopIndex:k,pageCount:x,prevPage:N,nextPage:C,setItemsPerPage:_,setPage:I}=Gs({page:d,itemsPerPage:v,itemsLength:S}),{paginatedItems:P}=qs({items:V,startIndex:w,stopIndex:k,itemsPerPage:v}),B=t.computed((()=>g(P.value))),{isSelected:A,select:R,selectAll:T,toggleSelect:E}=eu(e,{allItems:r,currentPage:B}),{isExpanded:D,toggleExpand:$}=Rs(e)
Hs({page:d,itemsPerPage:v,sortBy:s,groupBy:o,search:n})
...
const _u=a({activeColor:String,start:{type:[Number,String],default:1},modelValue:{type:Number,default:e=>e.start},disabled:Boolean,length:{type:[Number,String],default:1,validator:e=>e%1==0},totalVisible:[Number,String],firstIcon:{type:Il,default:"$first"},prevIcon:{type:Il,default:"$prev"},nextIcon:{type:Il,default:"$next"},lastIcon:{type:Il,default:"$last"},ariaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.root"},pageAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.page"},currentPageAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.currentPage"},firstAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.first"},previousAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.previous"},nextAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.next"},lastAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.last"},ellipsis:{type:String,default:"..."},showFirstLastPage:Boolean,...Ga(),...l(),...cl(),...Ja(),...el(),...Fl(),...ua({tag:"nav"}),...ta(),...fl({variant:"text"})},"VPagination"),Iu=gt()({name:"VPagination",props:_u(),emits:{"update:modelValue":e=>!0,first:e=>!0,prev:e=>!0,next:e=>!0,last:e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=Ht(e,"modelValue"),{t:r,n:i}=Jt(),{isRtl:s}=Qt(),{themeClasses:u}=la(e),{width:c}=kr(),d=t.shallowRef(-1)
vt(void 0,{scoped:!0})
...
return At((()=>t.createVNode("div",{class:"v-data-table-footer"},[l.prepend?.(),t.createVNode("div",{class:"v-data-table-footer__items-per-page"},[t.createVNode("span",null,[o(e.itemsPerPageText)]),t.createVNode(ui,{items:v.value,modelValue:c.value,"onUpdate:modelValue":e=>d(Number(e)),density:"compact",variant:"outlined","hide-details":!0},null)]),t.createVNode("div",{class:"v-data-table-footer__info"},[t.createVNode("div",null,[o(e.pageText,u.value?i.value+1:0,s.value,u.value)])]),t.createVNode("div",{class:"v-data-table-footer__pagination"},[t.createVNode(Iu,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,density:"comfortable","first-aria-label":e.firstPageLabel,"last-aria-label":e.lastPageLabel,length:r.value,"next-aria-label":e.nextPageLabel,"prev-aria-label":e.prevPageLabel,rounded:!0,"show-first-last-page":!0,"total-visible":e.showCurrentPage?1:0,variant:"plain"},null)])]))),{}}}),Au=(Ru={align:{type:String,default:"start"},fixed:Boolean,fixedOffset:[Number,String],height:[Number,String],lastFixed:Boolean,noPadding:Boolean,tag:String,width:[Number,String]},(Tu=(e,a)=>{let{slots:l}=a
const o=e.tag??"td"
return t.createVNode(o,{class:["v-data-table__td",{"v-data-table-column--fixed":e.fixed,"v-data-table-column--last-fixed":e.lastFixed,"v-data-table-column--no-padding":e.noPadding},`v-data-table-column--align-${e.align}`],style:{height:h(e.height),width:h(e.width),left:h(e.fixedOffset||null)}},{default:()=>[l.default?.()]})}).props=Ru,Tu)
var Ru,Tu
const Eu=a({headers:Array},"DataTable-header"),Du=Symbol.for("vuetify:data-table-headers"),$u={title:"",sortable:!1},Mu={...$u,width:48}
function Fu(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
if(e.children)for(const a of e.children)Fu(a,t)
else t.push(e)
return t}function Lu(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:new Set
for(const a of e)a.key&&t.add(a.key),a.children&&Lu(a.children,t)
return t}function Ou(e){if(e.key)return"data-table-group"===e.key?$u:["data-table-expand","data-table-select"].includes(e.key)?Mu:void 0}function zu(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
...
if(n.push({...a,rowspan:s??1,colspan:a.children?Fu(a).length:1}),a.children)for(const e of a.children){const t=i%1+r/Math.pow(10,l+1)
o.enqueue(e,l+s+t)}r+=1,e-=1}l+=1,a.push(n)}return{columns:e.map((e=>Fu(e))).flat(),headers:a}}function Hu(e){const t=[]
for(const a of e){const e={...Ou(a),...a},l=e.key??("string"==typeof e.value?e.value:null),o=e.value??l??null,n={...e,key:l,value:o,sortable:e.sortable??(null!=e.key||!!e.sort),children:e.children?Hu(e.children):void 0}
t.push(n)}return t}function Wu(e,a){const l=t.ref([]),o=t.ref([]),n=t.ref(),r=t.ref()
t.watchEffect((()=>{const i=(e.headers||Object.keys(e.items[0]??{}).map((e=>({key:e,title:t.capitalize(e)})))).slice(),s=Lu(i)
...
const c=Math.max(...u.map((e=>zu(e))))+1,d=ju(u,c)
...
return t.provide(Du,i),i}function Uu(){const e=t.inject(Du)
if(!e)throw new Error("Missing headers!")
return e}const Yu=a({color:String,sticky:Boolean,multiSort:Boolean,sortAscIcon:{type:Il,default:"$sortAsc"},sortDescIcon:{type:Il,default:"$sortDesc"},...Xl()},"VDataTableHeaders"),Gu=gt()({name:"VDataTableHeaders",props:Yu(),setup(e,a){let{slots:l}=a
const{toggleSort:o,sortBy:n,isSorted:r}=function(){const e=t.inject(yu)
if(!e)throw new Error("Missing sort!")
return e}(),{someSelected:i,allSelected:s,selectAll:u,showSelectAll:c}=tu(),{columns:d,headers:v}=Uu(),{loaderClasses:p}=Zl(e)
...
return a?"asc"===a.order?e.sortAscIcon:e.sortDescIcon:e.sortAscIcon}const{backgroundColorClasses:g,backgroundColorStyles:y}=Za(e,"color"),b=t.computed((()=>({headers:v.value,columns:d.value,toggleSort:o,isSorted:r,sortBy:n.value,someSelected:i.value,allSelected:s.value,selectAll:u,getSortIcon:m}))),V=a=>{let{column:d,x:v,y:b}=a
const V="data-table-select"===d.key||"data-table-expand"===d.key
return t.createVNode(Au,t.mergeProps({tag:"th",align:d.align,class:["v-data-table__th",{"v-data-table__th--sortable":d.sortable,"v-data-table__th--sorted":r(d),"v-data-table__th--fixed":d.fixed},p.value],style:{width:h(d.width),minWidth:h(d.minWidth),...f(d,b)},colspan:d.colspan,rowspan:d.rowspan,onClick:d.sortable?()=>o(d):void 0,fixed:d.fixed,lastFixed:d.lastFixed,noPadding:V},d.headerProps),{default:()=>{const a=`header.${d.key}`,v={column:d,selectAll:u,isSorted:r,toggleSort:o,sortBy:n.value,someSelected:i.value,allSelected:s.value,getSortIcon:m}
return l[a]?l[a](v):"data-table-select"===d.key?l["header.data-table-select"]?.(v)??(c&&t.createVNode(jo,{modelValue:s.value,indeterminate:i.value&&!s.value,"onUpdate:modelValue":u},null)):t.createVNode("div",{class:"v-data-table-header__content"},[t.createVNode("span",null,[d.title]),d.sortable&&t.createVNode(zl,{key:"icon",class:"v-data-table-header__sort-icon",icon:m(d)},null),e.multiSort&&r(d)&&t.createVNode("div",{key:"badge",class:["v-data-table-header__sort-badge",...g.value],style:y.value},[n.value.findIndex((e=>e.key===d.key))+1])])}})}
At((()=>t.createVNode(t.Fragment,null,[l.headers?l.headers(b.value):v.value.map(((e,a)=>t.createVNode("tr",null,[e.map(((e,l)=>t.createVNode(V,{column:e,x:l,y:a},null)))]))),e.loading&&t.createVNode("tr",{class:"v-data-table-progress"},[t.createVNode("th",{colspan:d.value.length},[t.createVNode(Jl,{name:"v-data-table-progress",active:!0,color:"boolean"==typeof e.loading?void 0:e.loading,indeterminate:!0},{default:l.loader})])])])))}}),qu=a({item:{type:Object,required:!0}},"VDataTableGroupHeaderRow"),Ku=gt()({name:"VDataTableGroupHeaderRow",props:qu(),setup(e,a){let{slots:l}=a
const{isGroupOpen:o,toggleGroup:n,extractRows:r}=Fs(),{isSelected:i,isSomeSelected:s,select:u}=tu(),{columns:c}=Uu(),d=t.computed((()=>r([e.item])))
...
return l["data-table-group"]?.({item:e.item,count:d.value.length,props:{icon:a,onClick:r}})??t.createVNode(Au,{class:"v-data-table-group-header-row__column"},{default:()=>[t.createVNode(No,{size:"small",variant:"text",icon:a,onClick:r},null),t.createVNode("span",null,[e.item.value]),t.createVNode("span",null,[t.createTextVNode("("),d.value.length,t.createTextVNode(")")])]})}if("data-table-select"===a.key){const e=i(d.value),a=s(d.value)&&!e,o=e=>u(d.value,e)
return l["data-table-select"]?.({props:{modelValue:e,indeterminate:a,"onUpdate:modelValue":o}})??t.createVNode("td",null,[t.createVNode(jo,{modelValue:e,indeterminate:a,"onUpdate:modelValue":o},null)])}return t.createVNode("td",null,null)}))])}}),Xu=a({index:Number,item:Object,cellProps:[Object,Function],onClick:K(),onContextmenu:K(),onDblclick:K()},"VDataTableRow"),Zu=gt()({name:"VDataTableRow",props:Xu(),setup(e,a){let{slots:l}=a
const{isSelected:o,toggleSelect:n}=tu(),{isExpanded:r,toggleExpand:i}=Ts(),{columns:s}=Uu()
...
return t.createVNode(Au,t.mergeProps({align:a.align,fixed:a.fixed,fixedOffset:a.fixedOffset,lastFixed:a.lastFixed,noPadding:"data-table-select"===a.key||"data-table-expand"===a.key,width:a.width},v,p),{default:()=>l[c]?l[c](d):"data-table-select"===a.key?l["item.data-table-select"]?.(d)??t.createVNode(jo,{disabled:!u.selectable,modelValue:o([u]),onClick:t.withModifiers((()=>n(u)),["stop"])},null):"data-table-expand"===a.key?l["item.data-table-expand"]?.(d)??t.createVNode(No,{icon:r(u)?"$collapse":"$expand",size:"small",variant:"text",onClick:t.withModifiers((()=>i(u)),["stop"])},null):t.toDisplayString(d.value)})}))])))}}),Ju=a({loading:[Boolean,String],loadingText:{type:String,default:"$vuetify.dataIterator.loadingText"},hideNoData:Boolean,items:{type:Array,default:()=>[]},noDataText:{type:String,default:"$vuetify.noDataText"},rowProps:[Object,Function],cellProps:[Object,Function]},"VDataTableRows"),Qu=gt()({name:"VDataTableRows",inheritAttrs:!1,props:Ju(),setup(e,a){let{attrs:l,slots:o}=a
const{columns:n}=Uu(),{expandOnClick:r,toggleExpand:i,isExpanded:s}=Ts(),{isSelected:u,toggleSelect:c}=tu(),{toggleGroup:d,isGroupOpen:v}=Fs(),{t:p}=Jt()
...
return o["group-header"]?o["group-header"](e):t.createVNode(Ku,t.mergeProps({key:`group-header_${a.id}`,item:a},Vt(l,":group-header",(()=>e))),o)}const f={index:p,item:a.raw,internalItem:a,columns:n.value,isExpanded:s,toggleExpand:i,isSelected:u,toggleSelect:c},m={...f,props:t.mergeProps({key:`item_${a.key??a.index}`,onClick:r.value?()=>{i(a)}:void 0,index:p,item:a,cellProps:e.cellProps},Vt(l,":row",(()=>f)),"function"==typeof e.rowProps?e.rowProps({item:f.item,index:f.index,internalItem:f.internalItem}):e.rowProps)}
return t.createVNode(t.Fragment,{key:m.props.key},[o.item?o.item(m):t.createVNode(Zu,m.props,o),s(a)&&o["expanded-row"]?.(f)])}))]):t.createVNode("tr",{class:"v-data-table-rows-no-data",key:"no-data"},[t.createVNode("td",{colspan:n.value.length},[o["no-data"]?.()??p(e.noDataText)])]))),{}}}),ec=a({fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,...l(),...cl(),...ua(),...ta()},"VTable"),tc=gt()({name:"VTable",props:ec(),setup(e,a){let{slots:l,emit:o}=a
const{themeClasses:n}=la(e),{densityClasses:r}=dl(e)
return At((()=>t.createVNode(e.tag,{class:["v-table",{"v-table--fixed-height":!!e.height,"v-table--fixed-header":e.fixedHeader,"v-table--fixed-footer":e.fixedFooter,"v-table--has-top":!!l.top,"v-table--has-bottom":!!l.bottom,"v-table--hover":e.hover},n.value,r.value,e.class],style:e.style},{default:()=>[l.top?.(),l.default?t.createVNode("div",{class:"v-table__wrapper",style:{height:h(e.height)}},[t.createVNode("table",null,[l.default()])]):l.wrapper?.(),l.bottom?.()]}))),{}}}),ac=a({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},rowProps:[Object,Function],cellProps:[Object,Function],returnObject:Boolean},"DataTable-items")
function lc(e,t,a){return t.map(((t,l)=>function(e,t,a,l){const o=e.returnObject?t:m(t,e.itemValue),n=m(t,e.itemSelectable,!0),r=l.reduce(((e,a)=>(null!=a.key&&(e[a.key]=m(t,a.value)),e)),{})
return{type:"item",key:e.returnObject?m(t,e.itemValue):o,index:a,value:o,selectable:n,columns:r,raw:t}}(e,t,l,a)))}function oc(e,a){return{items:t.computed((()=>lc(e,e.items,a.value)))}}const nc=a({...Ju(),width:[String,Number],search:String,...Bs(),...Es(),...Eu(),...ac(),...Js(),...hu(),...Yu(),...ec()},"DataTable"),rc=a({...Ws(),...nc(),...di(),...Pu()},"VDataTable"),ic=gt()({name:"VDataTable",props:rc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=$s(e),{sortBy:r,multiSort:i,mustSort:s}=bu(e),{page:u,itemsPerPage:c}=Ys(e),{columns:d,headers:v,sortFunctions:p,filterFunctions:f}=Wu(e,{groupBy:n,showSelect:t.toRef(e,"showSelect"),showExpand:t.toRef(e,"showExpand")}),{items:m}=oc(e,d),g=t.toRef(e,"search"),{filteredItems:h}=vi(e,m,g,{transform:e=>e.columns,customKeyFilter:f}),{toggleSort:y}=Vu({sortBy:r,multiSort:i,mustSort:s,page:u}),{sortByWithGroups:b,opened:V,extractRows:S,isGroupOpen:w,toggleGroup:k}=Ms({groupBy:n,sortBy:r}),{sortedItems:x}=Su(e,h,b,p),{flatItems:N}=js(x,n,V),C=t.computed((()=>N.value.length)),{startIndex:_,stopIndex:I,pageCount:P,setItemsPerPage:B}=Gs({page:u,itemsPerPage:c,itemsLength:C}),{paginatedItems:A}=qs({items:N,startIndex:_,stopIndex:I,itemsPerPage:c}),R=t.computed((()=>S(A.value))),{isSelected:T,select:E,selectAll:D,toggleSelect:$,someSelected:M,allSelected:F}=eu(e,{allItems:m,currentPage:R}),{isExpanded:L,toggleExpand:O}=Rs(e)
Hs({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:g}),vt({VDataTableRows:{hideNoData:t.toRef(e,"hideNoData"),noDataText:t.toRef(e,"noDataText"),loading:t.toRef(e,"loading"),loadingText:t.toRef(e,"loadingText")}})
...
return At((()=>{const a=Bu.filterProps(e),n=Gu.filterProps(e),r=Qu.filterProps(e),i=tc.filterProps(e)
return t.createVNode(tc,t.mergeProps({class:["v-data-table",{"v-data-table--show-select":e.showSelect,"v-data-table--loading":e.loading},e.class],style:e.style},i),{top:()=>o.top?.(z.value),default:()=>o.default?o.default(z.value):t.createVNode(t.Fragment,null,[o.colgroup?.(z.value),t.createVNode("thead",null,[t.createVNode(Gu,n,o)]),o.thead?.(z.value),t.createVNode("tbody",null,[o["body.prepend"]?.(z.value),o.body?o.body(z.value):t.createVNode(Qu,t.mergeProps(l,r,{items:A.value}),o),o["body.append"]?.(z.value)]),o.tbody?.(z.value),o.tfoot?.(z.value)]),bottom:()=>o.bottom?o.bottom(z.value):t.createVNode(t.Fragment,null,[t.createVNode(En,null,null),t.createVNode(Bu,a,{prepend:o["footer.prepend"]})])})})),{}}}),sc=a({...nc(),...Es(),...ai(),...di()},"VDataTableVirtual"),uc=gt()({name:"VDataTableVirtual",props:sc(),emits:{"update:modelValue":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=$s(e),{sortBy:r,multiSort:i,mustSort:s}=bu(e),{columns:u,headers:c,sortFunctions:d,filterFunctions:v}=Wu(e,{groupBy:n,showSelect:t.toRef(e,"showSelect"),showExpand:t.toRef(e,"showExpand")}),{items:p}=oc(e,u),f=t.toRef(e,"search"),{filteredItems:m}=vi(e,p,f,{transform:e=>e.columns,customKeyFilter:v}),{toggleSort:g}=Vu({sortBy:r,multiSort:i,mustSort:s}),{sortByWithGroups:y,opened:b,extractRows:V,isGroupOpen:S,toggleGroup:w}=Ms({groupBy:n,sortBy:r}),{sortedItems:k}=Su(e,m,y,d),{flatItems:x}=js(k,n,b),N=t.computed((()=>V(x.value))),{isSelected:C,select:_,selectAll:I,toggleSelect:P,someSelected:B,allSelected:A}=eu(e,{allItems:N,currentPage:N}),{isExpanded:R,toggleExpand:T}=Rs(e),{containerRef:E,markerRef:D,paddingTop:$,paddingBottom:M,computedItems:F,handleItemResize:L,handleScroll:O,handleScrollend:z}=li(e,x),j=t.computed((()=>F.value.map((e=>e.raw))))
Hs({sortBy:r,page:t.shallowRef(1),itemsPerPage:t.shallowRef(-1),groupBy:n,search:f}),vt({VDataTableRows:{hideNoData:t.toRef(e,"hideNoData"),noDataText:t.toRef(e,"noDataText"),loading:t.toRef(e,"loading"),loadingText:t.toRef(e,"loadingText")}})
...
At((()=>{const a=Gu.filterProps(e),n=Qu.filterProps(e),r=tc.filterProps(e)
return t.createVNode(tc,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r),{top:()=>o.top?.(H.value),wrapper:()=>t.createVNode("div",{ref:E,onScrollPassive:O,onScrollend:z,class:"v-table__wrapper",style:{height:h(e.height)}},[t.createVNode("table",null,[t.createVNode("thead",null,[t.createVNode(Gu,t.mergeProps(a,{sticky:e.fixedHeader}),o)]),t.createVNode("tbody",null,[t.createVNode("tr",{ref:D,style:{height:h($.value),border:0}},[t.createVNode("td",{colspan:u.value.length,style:{height:0,border:0}},null)]),o["body.prepend"]?.(H.value),t.createVNode(Qu,t.mergeProps(l,n,{items:j.value}),{...o,item:e=>t.createVNode(ti,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>L(e.internalItem.index,t)},{default:a=>{let{itemRef:l}=a
return o.item?.({...e,itemRef:l})??t.createVNode(Zu,t.mergeProps(e.props,{ref:l,key:e.internalItem.index,index:e.internalItem.index}),o)}})}),o["body.append"]?.(H.value),t.createVNode("tr",{style:{height:h(M.value),border:0}},[t.createVNode("td",{colspan:u.value.length,style:{height:0,border:0}},null)])])])]),bottom:()=>o.bottom?.(H.value)})}))}}),cc=a({itemsLength:{type:[Number,String],required:!0},...Ws(),...nc(),...Pu()},"VDataTableServer"),dc=gt()({name:"VDataTableServer",props:cc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:groupBy":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=$s(e),{sortBy:r,multiSort:i,mustSort:s}=bu(e),{page:u,itemsPerPage:c}=Ys(e),d=t.computed((()=>parseInt(e.itemsLength,10))),{columns:v,headers:p}=Wu(e,{groupBy:n,showSelect:t.toRef(e,"showSelect"),showExpand:t.toRef(e,"showExpand")}),{items:f}=oc(e,v),{toggleSort:m}=Vu({sortBy:r,multiSort:i,mustSort:s,page:u}),{opened:g,isGroupOpen:h,toggleGroup:y,extractRows:b}=Ms({groupBy:n,sortBy:r}),{pageCount:V,setItemsPerPage:S}=Gs({page:u,itemsPerPage:c,itemsLength:d}),{flatItems:w}=js(f,n,g),{isSelected:k,select:x,selectAll:N,toggleSelect:C,someSelected:_,allSelected:I}=eu(e,{allItems:f,currentPage:f}),{isExpanded:P,toggleExpand:B}=Rs(e),A=t.computed((()=>b(f.value)))
Hs({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:t.toRef(e,"search")}),t.provide("v-data-table",{toggleSort:m,sortBy:r}),vt({VDataTableRows:{hideNoData:t.toRef(e,"hideNoData"),noDataText:t.toRef(e,"noDataText"),loading:t.toRef(e,"loading"),loadingText:t.toRef(e,"loadingText")}})
...
At((()=>{const a=Bu.filterProps(e),n=Gu.filterProps(e),r=Qu.filterProps(e),i=tc.filterProps(e)
return t.createVNode(tc,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},i),{top:()=>o.top?.(R.value),default:()=>o.default?o.default(R.value):t.createVNode(t.Fragment,null,[o.colgroup?.(R.value),t.createVNode("thead",{class:"v-data-table__thead",role:"rowgroup"},[t.createVNode(Gu,t.mergeProps(n,{sticky:e.fixedHeader}),o)]),o.thead?.(R.value),t.createVNode("tbody",{class:"v-data-table__tbody",role:"rowgroup"},[o["body.prepend"]?.(R.value),o.body?o.body(R.value):t.createVNode(Qu,t.mergeProps(l,r,{items:w.value}),o),o["body.append"]?.(R.value)]),o.tbody?.(R.value),o.tfoot?.(R.value)]),bottom:()=>o.bottom?o.bottom(R.value):t.createVNode(Bu,a,{prepend:o["footer.prepend"]})})}))}}),vc=a({fluid:{type:Boolean,default:!1},...l(),...ua()},"VContainer"),pc=gt()({name:"VContainer",props:vc(),setup(e,a){let{slots:l}=a
const{rtlClasses:o}=Qt()
return At((()=>t.createVNode(e.tag,{class:["v-container",{"v-container--fluid":e.fluid},o,e.class],style:e.style},l))),{}}}),fc=mr.reduce(((e,t)=>(e[t]={type:[Boolean,String,Number],default:!1},e)),{}),mc=mr.reduce(((e,a)=>(e["offset"+t.capitalize(a)]={type:[String,Number],default:null},e)),{}),gc=mr.reduce(((e,a)=>(e["order"+t.capitalize(a)]={type:[String,Number],default:null},e)),{}),hc={col:Object.keys(fc),offset:Object.keys(mc),order:Object.keys(gc)}
function yc(e,t,a){let l=e
if(null!=a&&!1!==a){if(t){l+=`-${t.replace(e,"")}`}return"col"===e&&(l="v-"+l),"col"!==e||""!==a&&!0!==a?(l+=`-${a}`,l.toLowerCase()):l.toLowerCase()}}const bc=["auto","start","end","center","baseline","stretch"],Vc=a({cols:{type:[Boolean,String,Number],default:!1},...fc,offset:{type:[String,Number],default:null},...mc,order:{type:[String,Number],default:null},...gc,alignSelf:{type:String,default:null,validator:e=>bc.includes(e)},...l(),...ua()},"VCol"),Sc=gt()({name:"VCol",props:Vc(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>{const t=[]
let a
for(a in hc)hc[a].forEach((l=>{const o=e[l],n=yc(a,l,o)
n&&t.push(n)}))
const l=t.some((e=>e.startsWith("v-col-")))
return t.push({"v-col":!l||!e.cols,[`v-col-${e.cols}`]:e.cols,[`offset-${e.offset}`]:e.offset,[`order-${e.order}`]:e.order,[`align-self-${e.alignSelf}`]:e.alignSelf}),t}))
return()=>t.h(e.tag,{class:[o.value,e.class],style:e.style},l.default?.())}}),wc=["start","end","center"],kc=["space-between","space-around","space-evenly"]
function xc(e,a){return mr.reduce(((l,o)=>(l[e+t.capitalize(o)]=a(),l)),{})}const Nc=[...wc,"baseline","stretch"],Cc=e=>Nc.includes(e),_c=xc("align",(()=>({type:String,default:null,validator:Cc}))),Ic=[...wc,...kc],Pc=e=>Ic.includes(e),Bc=xc("justify",(()=>({type:String,default:null,validator:Pc}))),Ac=[...wc,...kc,"stretch"],Rc=e=>Ac.includes(e),Tc=xc("alignContent",(()=>({type:String,default:null,validator:Rc}))),Ec={align:Object.keys(_c),justify:Object.keys(Bc),alignContent:Object.keys(Tc)},Dc={align:"align",justify:"justify",alignContent:"align-content"}
function $c(e,t,a){let l=Dc[e]
if(null!=a){if(t){l+=`-${t.replace(e,"")}`}return l+=`-${a}`,l.toLowerCase()}}const Mc=a({dense:Boolean,noGutters:Boolean,align:{type:String,default:null,validator:Cc},..._c,justify:{type:String,default:null,validator:Pc},...Bc,alignContent:{type:String,default:null,validator:Rc},...Tc,...l(),...ua()},"VRow"),Fc=gt()({name:"VRow",props:Mc(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>{const t=[]
let a
for(a in Ec)Ec[a].forEach((l=>{const o=e[l],n=$c(a,l,o)
n&&t.push(n)}))
return t.push({"v-row--no-gutters":e.noGutters,"v-row--dense":e.dense,[`align-${e.align}`]:e.align,[`justify-${e.justify}`]:e.justify,[`align-content-${e.alignContent}`]:e.alignContent}),t}))
return()=>t.h(e.tag,{class:["v-row",o.value,e.class],style:e.style},l.default?.())}}),Lc=ht("v-spacer","div","VSpacer"),Oc=a({active:{type:[String,Array],default:void 0},disabled:{type:[Boolean,String,Array],default:!1},nextIcon:{type:[String],default:"$next"},prevIcon:{type:[String],default:"$prev"},modeIcon:{type:[String],default:"$subgroup"},text:String,viewMode:{type:String,default:"month"}},"VDatePickerControls"),zc=gt()({name:"VDatePickerControls",props:Oc(),emits:{"click:year":()=>!0,"click:month":()=>!0,"click:prev":()=>!0,"click:next":()=>!0,"click:text":()=>!0},setup(e,a){let{emit:l}=a
...
function s(){l("click:prev")}function u(){l("click:next")}function c(){l("click:year")}function d(){l("click:month")}return At((()=>t.createVNode("div",{class:["v-date-picker-controls"]},[t.createVNode(No,{class:"v-date-picker-controls__month-btn",disabled:o.value,text:e.text,variant:"text",rounded:!0,onClick:d},null),t.createVNode(No,{key:"mode-btn",class:"v-date-picker-controls__mode-btn",disabled:n.value,density:"comfortable",icon:e.modeIcon,variant:"text",onClick:c},null),t.createVNode(Lc,{key:"mode-spacer"},null),t.createVNode("div",{key:"month-buttons",class:"v-date-picker-controls__month"},[t.createVNode(No,{disabled:r.value,icon:e.prevIcon,variant:"text",onClick:s},null),t.createVNode(No,{disabled:i.value,icon:e.nextIcon,variant:"text",onClick:u},null)])]))),{}}}),jc=a({appendIcon:String,color:String,header:String,transition:String,onClick:K()},"VDatePickerHeader"),Hc=gt()({name:"VDatePickerHeader",props:jc(),emits:{click:()=>!0,"click:append":()=>!0},setup(e,a){let{emit:l,slots:o}=a
const{backgroundColorClasses:n,backgroundColorStyles:r}=Za(e,"color")
function i(){l("click")}function s(){l("click:append")}return At((()=>{const a=!(!o.default&&!e.header),l=!(!o.append&&!e.appendIcon)
return t.createVNode("div",{class:["v-date-picker-header",{"v-date-picker-header--clickable":!!e.onClick},n.value],style:r.value,onClick:i},[o.prepend&&t.createVNode("div",{key:"prepend",class:"v-date-picker-header__prepend"},[o.prepend()]),a&&t.createVNode(ja,{key:"content",name:e.transition},{default:()=>[t.createVNode("div",{key:e.header,class:"v-date-picker-header__content"},[o.default?.()??e.header])]}),l&&t.createVNode("div",{class:"v-date-picker-header__append"},[o.append?t.createVNode($a,{key:"append-defaults",disabled:!e.appendIcon,defaults:{VBtn:{icon:e.appendIcon,variant:"text"}}},{default:()=>[o.append?.()]}):t.createVNode(No,{key:"append-btn",icon:e.appendIcon,variant:"text",onClick:s},null)])])})),{}}}),Wc=a({allowedDates:[Array,Function],disabled:Boolean,color:String,month:[Number,String],hideWeekdays:Boolean,max:null,min:null,modelValue:Array,multiple:Boolean,showAdjacentMonths:Boolean,showWeek:Boolean,year:[Number,String]},"VDatePickerMonth"),Uc=gt()({name:"VDatePickerMonth",props:Wc(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=t.ref(),r=gu(),i=Ht(e,"modelValue",[],(e=>T(e))),s=t.computed((()=>i.value.length>0?r.date(i.value[0]):e.min?r.date(e.min):Array.isArray(e.allowedDates)?r.date(e.allowedDates[0]):r.date())),u=Ht(e,"year",void 0,(e=>{const t=null!=e?Number(e):r.getYear(s.value)
...
function i(e){n.value=e}return l.month?.({month:a,i:o,props:r})??t.createVNode(No,t.mergeProps({key:"month"},r,{onClick:()=>i(o)}),null)}))])]))),{}}}),qc=a({color:String,height:[String,Number],min:null,max:null,modelValue:Number},"VDatePickerYears"),Kc=gt()({name:"VDatePickerYears",props:qc(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return l.year?.({year:a,i:o,props:r})??t.createVNode(No,t.mergeProps({key:"month"},r),null)}))])]))),{}}}),Xc=ht("v-picker-title"),Zc=a({bgColor:String,landscape:Boolean,title:String,hideHeader:Boolean,...Ns()},"VPicker"),Jc=gt()({name:"VPicker",props:Zc(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=Za(t.toRef(e,"color"))
return At((()=>{const a=Cs.filterProps(e),r=!(!e.title&&!l.title)
return t.createVNode(Cs,t.mergeProps(a,{color:e.bgColor,class:["v-picker",{"v-picker--landscape":e.landscape,"v-picker--with-actions":!!l.actions},e.class],style:e.style}),{default:()=>[!e.hideHeader&&t.createVNode("div",{key:"header",class:[o.value],style:[n.value]},[r&&t.createVNode(Xc,{key:"picker-title"},{default:()=>[l.title?.()??e.title]}),l.header&&t.createVNode("div",{class:"v-picker__header"},[l.header()])]),t.createVNode("div",{class:"v-picker__body"},[l.default?.()]),l.actions&&t.createVNode($a,{defaults:{VBtn:{slim:!0,variant:"text"}}},{default:()=>[t.createVNode("div",{class:"v-picker__actions"},[l.actions()])]})]})})),{}}}),Qc=a({header:{type:String,default:"$vuetify.datePicker.header"},...Oc(),...Wc(),...C(Yc(),["modelValue"]),...C(qc(),["modelValue"]),...Zc({title:"$vuetify.datePicker.title"}),modelValue:null},"VDatePicker"),ed=gt()({name:"VDatePicker",props:Qc(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0,"update:viewMode":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=gu(),{t:r}=Jt(),i=Ht(e,"modelValue",void 0,(e=>T(e)),(t=>e.multiple?t:t[0])),s=Ht(e,"viewMode"),u=t.computed((()=>{const e=n.date(i.value?.[0])
...
function b(){c.value<11?c.value++:(d.value++,c.value=0,l("update:year",d.value)),l("update:month",c.value)}function V(){c.value>0?c.value--:(d.value--,c.value=11,l("update:year",d.value)),l("update:month",c.value)}function S(){s.value="months"===s.value?"month":"months"}function w(){s.value="year"===s.value?"month":"year"}return t.watch(c,(()=>{"months"===s.value&&S()})),t.watch(d,(()=>{"year"===s.value&&w()})),t.watch(i,((e,t)=>{const a=n.date(T(e)[0]),l=n.date(T(t)[0])
v.value=n.isBefore(a,l)})),At((()=>{const a=Jc.filterProps(e),l=zc.filterProps(e),n=Hc.filterProps(e),u=Uc.filterProps(e),v=C(Gc.filterProps(e),["modelValue"]),k=C(Kc.filterProps(e),["modelValue"]),x={header:p.value,transition:m.value}
return t.createVNode(Jc,t.mergeProps(a,{class:["v-date-picker",`v-date-picker--${s.value}`,{"v-date-picker--show-week":e.showWeek},e.class],style:e.style}),{title:()=>o.title?.()??t.createVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>o.header?t.createVNode($a,{defaults:{VDatePickerHeader:{...x}}},{default:()=>[o.header?.(x)]}):t.createVNode(Hc,t.mergeProps({key:"header"},n,x),o),default:()=>t.createVNode(t.Fragment,null,[t.createVNode(zc,t.mergeProps(l,{disabled:y.value,text:f.value,"onClick:next":b,"onClick:prev":V,"onClick:month":S,"onClick:year":w}),null),t.createVNode(ka,{hideOnLeave:!0},{default:()=>["months"===s.value?t.createVNode(Gc,t.mergeProps({key:"date-picker-months"},v,{modelValue:c.value,"onUpdate:modelValue":e=>c.value=e,min:g.value,max:h.value}),null):"year"===s.value?t.createVNode(Kc,t.mergeProps({key:"date-picker-years"},k,{modelValue:d.value,"onUpdate:modelValue":e=>d.value=e,min:g.value,max:h.value}),null):t.createVNode(Uc,t.mergeProps({key:"date-picker-month"},u,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,month:c.value,"onUpdate:month":e=>c.value=e,year:d.value,"onUpdate:year":e=>d.value=e,min:g.value,max:h.value}),null)]})]),actions:o.actions})})),{}}}),td=Symbol.for("vuetify:v-expansion-panel"),ad=["default","accordion","inset","popout"],ld=a({color:String,static:Boolean,variant:{type:String,default:"default",validator:e=>ad.includes(e)},readonly:Boolean,...l(),...yl(),...ua(),...ta()},"VExpansionPanels"),od=gt()({name:"VExpansionPanels",props:ld(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
Sl(e,td)
const{themeClasses:o}=la(e),n=t.computed((()=>e.variant&&`v-expansion-panels--variant-${e.variant}`))
return vt({VExpansionPanel:{color:t.toRef(e,"color")},VExpansionPanelTitle:{readonly:t.toRef(e,"readonly"),static:t.toRef(e,"static")}}),At((()=>t.createVNode(e.tag,{class:["v-expansion-panels",o.value,n.value,e.class],style:e.style},l))),{}}}),nd=a({...l(),...Nr()},"VExpansionPanelText"),rd=gt()({name:"VExpansionPanelText",props:nd(),setup(e,a){let{slots:l}=a
const o=t.inject(td)
if(!o)throw new Error("[Vuetify] v-expansion-panel-text needs to be placed inside v-expansion-panel")
const{hasContent:n,onAfterLeave:r}=Cr(e,o.isSelected)
return At((()=>t.createVNode(Ta,{onAfterLeave:r},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-expansion-panel-text",e.class],style:e.style},[l.default&&n.value&&t.createVNode("div",{class:"v-expansion-panel-text__wrapper"},[l.default?.()])]),[[t.vShow,o.isSelected.value]])]}))),{}}}),id=a({color:String,expandIcon:{type:Il,default:"$expand"},collapseIcon:{type:Il,default:"$collapse"},hideActions:Boolean,static:Boolean,ripple:{type:[Boolean,Object],default:!1},readonly:Boolean,...l()},"VExpansionPanelTitle"),sd=gt()({name:"VExpansionPanelTitle",directives:{Ripple:ko},props:id(),setup(e,a){let{slots:l}=a
const o=t.inject(td)
if(!o)throw new Error("[Vuetify] v-expansion-panel-title needs to be placed inside v-expansion-panel")
const{backgroundColorClasses:n,backgroundColorStyles:r}=Za(e,"color"),i=t.computed((()=>({collapseIcon:e.collapseIcon,disabled:o.disabled.value,expanded:o.isSelected.value,expandIcon:e.expandIcon,readonly:e.readonly})))
return At((()=>t.withDirectives(t.createVNode("button",{class:["v-expansion-panel-title",{"v-expansion-panel-title--active":o.isSelected.value,"v-expansion-panel-title--static":e.static},n.value,e.class],style:[r.value,e.style],type:"button",tabindex:o.disabled.value?-1:void 0,disabled:o.disabled.value,"aria-expanded":o.isSelected.value,onClick:e.readonly?void 0:o.toggle},[t.createVNode("span",{class:"v-expansion-panel-title__overlay"},null),l.default?.(i.value),!e.hideActions&&t.createVNode("span",{class:"v-expansion-panel-title__icon"},[l.actions?l.actions(i.value):t.createVNode(zl,{icon:o.isSelected.value?e.collapseIcon:e.expandIcon},null)])]),[[t.resolveDirective("ripple"),e.ripple]]))),{}}}),ud=a({title:String,text:String,bgColor:String,...l(),...Ja(),...bl(),...Nr(),...el(),...ua(),...id()},"VExpansionPanel"),cd=gt()({name:"VExpansionPanel",props:ud(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=Vl(e,td),{backgroundColorClasses:n,backgroundColorStyles:r}=Za(e,"bgColor"),{elevationClasses:i}=Qa(e),{roundedClasses:s}=tl(e),u=t.computed((()=>o?.disabled.value||e.disabled)),c=t.computed((()=>o.group.items.value.reduce(((e,t,a)=>(o.group.selected.value.includes(t.id)&&e.push(a),e)),[]))),d=t.computed((()=>{const e=o.group.items.value.findIndex((e=>e.id===o.id))
return!o.isSelected.value&&c.value.some((t=>t-e==1))})),v=t.computed((()=>{const e=o.group.items.value.findIndex((e=>e.id===o.id))
return!o.isSelected.value&&c.value.some((t=>t-e==-1))}))
return t.provide(td,o),vt({VExpansionPanelText:{eager:t.toRef(e,"eager")}}),At((()=>{const a=!(!l.text&&!e.text),c=!(!l.title&&!e.title)
return t.createVNode(e.tag,{class:["v-expansion-panel",{"v-expansion-panel--active":o.isSelected.value,"v-expansion-panel--before-active":d.value,"v-expansion-panel--after-active":v.value,"v-expansion-panel--disabled":u.value},s.value,n.value,e.class],style:[r.value,e.style]},{default:()=>[t.createVNode("div",{class:["v-expansion-panel__shadow",...i.value]},null),c&&t.createVNode(sd,{key:"title",collapseIcon:e.collapseIcon,color:e.color,expandIcon:e.expandIcon,hideActions:e.hideActions,ripple:e.ripple},{default:()=>[l.title?l.title():e.title]}),a&&t.createVNode(rd,{key:"text"},{default:()=>[l.text?l.text():e.text]}),l.default?.()]})})),{}}}),dd=a({chips:Boolean,counter:Boolean,counterSizeString:{type:String,default:"$vuetify.fileInput.counterSize"},counterString:{type:String,default:"$vuetify.fileInput.counter"},multiple:Boolean,showSize:{type:[Boolean,Number],default:!1,validator:e=>"boolean"==typeof e||[1e3,1024].includes(e)},...Qo({prependIcon:"$file"}),modelValue:{type:Array,default:()=>[],validator:e=>T(e).every((e=>null!=e&&"object"==typeof e))},...qr({clearable:!0})},"VFileInput"),vd=gt()({name:"VFileInput",inheritAttrs:!1,props:dd(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{t:r}=Jt(),i=Ht(e,"modelValue"),{isFocused:s,focus:u,blur:c}=Go(e),d=t.computed((()=>"boolean"!=typeof e.showSize?e.showSize:void 0)),v=t.computed((()=>(i.value??[]).reduce(((e,t)=>{let{size:a=0}=t
...
function S(){y.value!==document.activeElement&&y.value?.focus(),s.value||u()}function w(e){x(e)}function k(e){o("mousedown:control",e)}function x(e){y.value?.click(),o("click:control",e)}function N(a){a.stopPropagation(),S(),t.nextTick((()=>{i.value=[],Z(e["onClick:clear"],a)}))}return t.watch(i,(e=>{(!Array.isArray(e)||!e.length)&&y.value&&(y.value.value="")})),At((()=>{const a=!(!n.counter&&!e.counter),o=!(!a&&!n.details),[r,u]=R(l),{modelValue:d,...C}=en.filterProps(e),_=Xr(e)
return t.createVNode(en,t.mergeProps({ref:g,modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,class:["v-file-input",{"v-file-input--chips":!!e.chips,"v-input--plain-underlined":V.value},e.class],style:e.style,"onClick:prepend":w},r,C,{centerAffix:!V.value,focused:s.value}),{...n,default:a=>{let{id:l,isDisabled:o,isDirty:r,isReadonly:d,isValid:m}=a
return t.createVNode(Kr,t.mergeProps({ref:h,"prepend-icon":e.prependIcon,onMousedown:k,onClick:x,"onClick:clear":N,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"]},_,{id:l.value,active:b.value||r.value,dirty:r.value,disabled:o.value,focused:s.value,error:!1===m.value}),{...n,default:a=>{let{props:{class:l,...r}}=a
...
const t=e.target
i.value=[...t.files??[]]},onFocus:S,onBlur:c},r,u),null),t.createVNode("div",{class:l},[!!i.value?.length&&(n.selection?n.selection({fileNames:f.value,totalBytes:v.value,totalBytesReadable:p.value}):e.chips?f.value.map((a=>t.createVNode(cn,{key:a,size:"small",color:e.color},{default:()=>[a]}))):f.value.join(", "))])])}})},details:o?e=>t.createVNode(t.Fragment,null,[n.details?.(e),a&&t.createVNode(t.Fragment,null,[t.createVNode("span",null,null),t.createVNode(Wr,{active:!!i.value?.length,value:m.value},n.counter)])]):void 0})})),Or({},g,h,y)}}),pd=a({app:Boolean,color:String,height:{type:[Number,String],default:"auto"},...Ga(),...l(),...Ja(),...$t(),...el(),...ua({tag:"footer"}),...ta()},"VFooter"),fd=gt()({name:"VFooter",props:pd(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=la(e),{backgroundColorClasses:n,backgroundColorStyles:r}=Za(t.toRef(e,"color")),{borderClasses:i}=qa(e),{elevationClasses:s}=Qa(e),{roundedClasses:u}=tl(e),c=t.shallowRef(32),{resizeRef:d}=Rt((e=>{e.length&&(c.value=e[0].target.clientHeight)})),v=t.computed((()=>"auto"===e.height?c.value:parseInt(e.height,10))),{layoutItemStyles:p}=Ft({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.computed((()=>"bottom")),layoutSize:v,elementSize:t.computed((()=>"auto"===e.height?void 0:v.value)),active:t.computed((()=>e.app)),absolute:t.toRef(e,"absolute")})
return At((()=>t.createVNode(e.tag,{ref:d,class:["v-footer",o.value,n.value,i.value,s.value,u.value,e.class],style:[r.value,e.app?p.value:{height:h(e.height)},e.style]},l))),{}}}),md=a({...l(),...Ko()},"VForm"),gd=gt()({name:"VForm",props:md(),emits:{"update:modelValue":e=>!0,submit:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
i.value=l,a.value=!(t>0)&&(e===r.value.length||null)}),{deep:!0}),t.provide(qo,{register:e=>{let{id:t,validate:a,reset:l,resetValidation:o}=e
...
t&&r.value?.submit()})),t.preventDefault()}return At((()=>t.createVNode("form",{ref:r,class:["v-form",e.class],style:e.style,novalidate:!0,onReset:i,onSubmit:s},[l.default?.(n)]))),Or(n,r)}}),hd=a({disabled:Boolean,modelValue:{type:Boolean,default:void 0},...cr()},"VHover"),yd=gt()({name:"VHover",props:hd(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=Ht(e,"modelValue"),{runOpenDelay:o,runCloseDelay:n}=dr(e,(t=>!e.disabled&&(l.value=t)))
return()=>a.default?.({isHovering:l.value,props:{onMouseenter:o,onMouseleave:n}})}}),bd=a({color:String,direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},side:{type:String,default:"end",validator:e=>["start","end","both"].includes(e)},mode:{type:String,default:"intersect",validator:e=>["intersect","manual"].includes(e)},margin:[Number,String],loadMoreText:{type:String,default:"$vuetify.infiniteScroll.loadMore"},emptyText:{type:String,default:"$vuetify.infiniteScroll.empty"},...Ma(),...ua()},"VInfiniteScroll"),Vd=mt({name:"VInfiniteScrollIntersect",props:{side:{type:String,required:!0},rootRef:null,rootMargin:String},emits:{intersect:(e,t)=>!0},setup(e,a){let{emit:l}=a
const{intersectionRef:o,isIntersecting:n}=jl((e=>{}),e.rootMargin?{rootMargin:e.rootMargin}:void 0)
return t.watch(n,(async t=>{l("intersect",e.side,t)})),At((()=>t.createVNode("div",{class:"v-infinite-scroll-intersect",ref:o},[t.createTextVNode(" ")]))),{}}}),Sd=gt()({name:"VInfiniteScroll",props:bd(),emits:{load:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
return"error"===o?l.error?.(r):"empty"===o?l.empty?.(r)??t.createVNode("div",null,[g(e.emptyText)]):"manual"===e.mode?"loading"===o?l.loading?.(r)??t.createVNode(Wl,{indeterminate:!0,color:e.color},null):l["load-more"]?.(r)??t.createVNode(No,{variant:"outlined",color:e.color,onClick:n},{default:()=>[g(e.loadMoreText)]}):l.loading?.(r)??t.createVNode(Wl,{indeterminate:!0,color:e.color},null)}const{dimensionStyles:b}=Fa(e)
At((()=>{const a=e.tag,o="start"===e.side||"both"===e.side,u="end"===e.side||"both"===e.side,c="intersect"===e.mode
return t.createVNode(a,{ref:n,class:["v-infinite-scroll",`v-infinite-scroll--${e.direction}`,{"v-infinite-scroll--start":o,"v-infinite-scroll--end":u}],style:b.value},{default:()=>[t.createVNode("div",{class:"v-infinite-scroll__side"},[y("start",r.value)]),n.value&&o&&c&&t.createVNode(Vd,{key:"start",side:"start",onIntersect:f,rootRef:n.value,rootMargin:s.value},null),l.default?.(),n.value&&u&&c&&t.createVNode(Vd,{key:"end",side:"end",onIntersect:f,rootRef:n.value,rootMargin:s.value},null),t.createVNode("div",{class:"v-infinite-scroll__side"},[y("end",i.value)])]})}))}}),wd=Symbol.for("vuetify:v-item-group"),kd=a({...l(),...yl({selectedClass:"v-item--selected"}),...ua(),...ta()},"VItemGroup"),xd=gt()({name:"VItemGroup",props:kd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=la(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=Sl(e,wd)
return()=>t.createVNode(e.tag,{class:["v-item-group",o.value,e.class],style:e.style},{default:()=>[l.default?.({isSelected:n,select:r,next:i,prev:s,selected:u.value})]})}}),Nd=gt()({name:"VItem",props:bl(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const{isSelected:l,select:o,toggle:n,selectedClass:r,value:i,disabled:s}=Vl(e,wd)
return()=>a.default?.({isSelected:l.value,selectedClass:r.value,select:o,toggle:n,value:i.value,disabled:s.value})}}),Cd=ht("v-kbd"),_d=a({...l(),...Dt()},"VLayout"),Id=gt()({name:"VLayout",props:_d(),setup(e,a){let{slots:l}=a
const{layoutClasses:o,layoutStyles:n,getLayoutItem:r,items:i,layoutRef:s}=Lt(e)
return At((()=>t.createVNode("div",{ref:s,class:[o.value,e.class],style:[n.value,e.style]},[l.default?.()]))),{getLayoutItem:r,items:i}}}),Pd=a({position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...l(),...$t()},"VLayoutItem"),Bd=gt()({name:"VLayoutItem",props:Pd(),setup(e,a){let{slots:l}=a
...
return()=>t.createVNode("div",{class:["v-layout-item",e.class],style:[o.value,e.style]},[l.default?.()])}}),Ad=a({modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...l(),...Ma(),...ua(),...za({transition:"fade-transition"})},"VLazy"),Rd=gt()({name:"VLazy",directives:{intersect:Wa},props:Ad(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{dimensionStyles:o}=Fa(e),n=Ht(e,"modelValue")
function r(e){n.value||(n.value=e)}return At((()=>t.withDirectives(t.createVNode(e.tag,{class:["v-lazy",e.class],style:[o.value,e.style]},{default:()=>[n.value&&t.createVNode(ja,{transition:e.transition,appear:!0},{default:()=>[l.default?.()]})]}),[[t.resolveDirective("intersect"),{handler:r,options:e.options},null]]))),{}}}),Td=a({locale:String,fallbackLocale:String,messages:Object,rtl:{type:Boolean,default:void 0},...l()},"VLocaleProvider"),Ed=gt()({name:"VLocaleProvider",props:Td(),setup(e,a){let{slots:l}=a
const{rtlClasses:o}=function(e){const a=t.inject(Xt)
if(!a)throw new Error("[Vuetify] Could not find injected locale instance")
const l=a.provide(e),o=function(e,t,a){const l=a.rtl??t[e.current.value]??!1
return{isRtl:l,rtl:t,rtlClasses:l?"v-locale--is-rtl":"v-locale--is-ltr"}}(l,a.rtl,e),n={...l,...o}
return t.provide(Xt,n),n}(e)
return At((()=>t.createVNode("div",{class:["v-locale-provider",o,e.class],style:e.style},[l.default?.()]))),{}}}),Dd=a({scrollable:Boolean,...l(),...ua({tag:"main"})},"VMain"),$d=gt()({name:"VMain",props:Dd(),setup(e,a){let{slots:l}=a
const{mainStyles:o}=Mt(),{ssrBootStyles:n}=rl()
...
function Md(e){return(e<0?-1:1)*Math.sqrt(Math.abs(e))*1.41421356237}function Fd(e){if(e.length<2)return 0
if(2===e.length)return e[1].t===e[0].t?0:(e[1].d-e[0].d)/(e[1].t-e[0].t)
let t=0
for(let a=e.length-1;a>0;a--){if(e[a].t===e[a-1].t)continue
const l=Md(t),o=(e[a].d-e[a-1].d)/(e[a].t-e[a-1].t)
t+=(o-l)*Math.abs(o),a===e.length-1&&(t*=.5)}return 1e3*Md(t)}function Ld(){const e={}
...
o.push({t:e[0],d:e[1].clientX}),n.push({t:e[0],d:e[1].clientY})}return{x:Fd(o),y:Fd(n),get direction(){const{x:e,y:t}=this,[a,l]=[Math.abs(e),Math.abs(t)]
return a>l&&e>=0?"right":a>l&&e<=0?"left":l>a&&t>=0?"down":l>a&&t<=0?"up":function(){throw new Error}()}}}}}function Od(){throw new Error}const zd=["start","end","left","right","top","bottom"],jd=a({color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:{type:Boolean,default:null},railWidth:{type:[Number,String],default:56},scrim:{type:[Boolean,String],default:!0},image:String,temporary:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>zd.includes(e)},sticky:Boolean,...Ga(),...l(),...wr(),...Ja(),...$t(),...el(),...ua({tag:"nav"}),...ta()},"VNavigationDrawer"),Hd=gt()({name:"VNavigationDrawer",props:jd(),emits:{"update:modelValue":e=>!0,"update:rail":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{isRtl:r}=Qt(),{themeClasses:i}=la(e),{borderClasses:s}=qa(e),{backgroundColorClasses:u,backgroundColorStyles:c}=Za(t.toRef(e,"color")),{elevationClasses:d}=Qa(e),{displayClasses:v,mobile:p}=kr(e),{roundedClasses:f}=tl(e),m=ao(),g=Ht(e,"modelValue",null,(e=>!!e)),{ssrBootStyles:y}=rl(),{scopeId:b}=_r(),V=t.ref(),S=t.shallowRef(!1),w=t.computed((()=>e.rail&&e.expandOnHover&&S.value?Number(e.width):Number(e.rail?e.railWidth:e.width))),k=t.computed((()=>se(e.location,r))),x=t.computed((()=>!e.permanent&&(p.value||e.temporary))),N=t.computed((()=>e.sticky&&!x.value&&"bottom"!==k.value))
...
const i=t.computed((()=>["left","right"].includes(r.value))),{addMovement:s,endTouch:u,getVelocity:c}=Ld()
let d=!1
const v=t.shallowRef(!1),p=t.shallowRef(0),f=t.shallowRef(0)
let m
function g(e,t){return("left"===r.value?e:"right"===r.value?document.documentElement.clientWidth-e:"top"===r.value?e:"bottom"===r.value?document.documentElement.clientHeight-e:Od())-(t?o.value:0)}function h(e){let t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
const a="left"===r.value?(e-f.value)/o.value:"right"===r.value?(document.documentElement.clientWidth-e-f.value)/o.value:"top"===r.value?(e-f.value)/o.value:"bottom"===r.value?(document.documentElement.clientHeight-e-f.value)/o.value:Od()
return t?Math.max(0,Math.min(1,a)):a}function y(e){if(n.value)return
const t=e.changedTouches[0].clientX,c=e.changedTouches[0].clientY,v="left"===r.value?t<25:"right"===r.value?t>document.documentElement.clientWidth-25:"top"===r.value?c<25:"bottom"===r.value?c>document.documentElement.clientHeight-25:Od(),y=a.value&&("left"===r.value?t<o.value:"right"===r.value?t>document.documentElement.clientWidth-o.value:"top"===r.value?c<o.value:"bottom"===r.value?c>document.documentElement.clientHeight-o.value:Od());(v||y||a.value&&l.value)&&(d=!0,m=[t,c],f.value=g(i.value?t:c,a.value),p.value=h(i.value?t:c),u(e),s(e))}function b(e){const t=e.changedTouches[0].clientX,a=e.changedTouches[0].clientY
...
a.value=n?t.direction===({left:"right",right:"left",top:"down",bottom:"up"}[r.value]||Od()):p.value>.5}const S=t.computed((()=>v.value?{transform:"left"===r.value?`translateX(calc(-100% + ${p.value*o.value}px))`:"right"===r.value?`translateX(calc(100% - ${p.value*o.value}px))`:"top"===r.value?`translateY(calc(-100% + ${p.value*o.value}px))`:"bottom"===r.value?`translateY(calc(100% - ${p.value*o.value}px))`:Od(),transition:"none"}:void 0))
...
return t.createVNode("div",t.mergeProps({class:["v-otp-input",{"v-otp-input--divided":!!e.divider},e.class],style:[e.style]},a),[t.createVNode("div",{ref:m,class:"v-otp-input__content",style:[r.value]},[p.value.map(((a,l)=>t.createVNode(t.Fragment,null,[e.divider&&0!==l&&t.createVNode("span",{class:"v-otp-input__divider"},[e.divider]),t.createVNode(Kr,{focused:i.value&&e.focusAll||f.value===l,key:l},{...n,default:()=>t.createVNode("input",{ref:e=>g.value[l]=e,"aria-label":d(e.label,l+1),autofocus:0===l&&e.autofocus,autocomplete:"one-time-code",class:["v-otp-input__field"],disabled:e.disabled,inputmode:"number"===e.type?"numeric":"text",min:"number"===e.type?0:void 0,maxlength:"1",placeholder:e.placeholder,type:"number"===e.type?"text":e.type,value:c.value[l],onInput:y,onFocus:e=>{return t=l,s(),void(f.value=t)
...
var t,a}},null)})]))),t.createVNode("input",t.mergeProps({class:"v-otp-input-input",type:"hidden"},o,{value:c.value.join("")}),null),t.createVNode(Mr,{contained:!0,"content-class":"v-otp-input__loader","model-value":!!e.loading,persistent:!0},{default:()=>[n.loader?.()??t.createVNode(Wl,{color:"boolean"==typeof e.loading?void 0:e.loading,indeterminate:!0,size:"24",width:"2"},null)]}),n.default?.()])])})),{blur:()=>{g.value?.some((e=>e.blur()))},focus:()=>{g.value?.[0].focus()},reset:function(){c.value=[]},isFocused:i}}})
const Gd=a({scale:{type:[Number,String],default:.5},...l()},"VParallax"),qd=gt()({name:"VParallax",props:Gd(),setup(e,a){let{slots:l}=a
const{intersectionRef:o,isIntersecting:n}=jl(),{resizeRef:r,contentRect:i}=Rt(),{height:s}=kr(),u=t.ref()
let c
...
e.style.setProperty("transform",`translateY(${r}px) scale(${v})`)})))}return At((()=>t.createVNode(Ya,{class:["v-parallax",{"v-parallax--active":n.value},e.class],style:e.style,ref:u,cover:!0,onLoadstart:p,onLoad:p},l))),{}}}),Kd=a({...Lo({falseIcon:"$radioOff",trueIcon:"$radioOn"})},"VRadio"),Xd=gt()({name:"VRadio",props:Kd(),setup(e,a){let{slots:l}=a
return At((()=>t.createVNode(Oo,t.mergeProps(e,{class:["v-radio",e.class],style:e.style,type:"radio"}),l))),{}}}),Zd=a({height:{type:[Number,String],default:"auto"},...Qo(),...C($o(),["multiple"]),trueIcon:{type:Il,default:"$radioOn"},falseIcon:{type:Il,default:"$radioOff"},type:{type:String,default:"radio"}},"VRadioGroup"),Jd=gt()({name:"VRadioGroup",inheritAttrs:!1,props:Zd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const n=Nt(),r=t.computed((()=>e.id||`radio-group-${n}`)),i=Ht(e,"modelValue")
return At((()=>{const[a,n]=R(l),s=en.filterProps(e),u=Oo.filterProps(e),c=o.label?o.label({label:e.label,props:{for:r.value}}):e.label
return t.createVNode(en,t.mergeProps({class:["v-radio-group",e.class],style:e.style},a,s,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,id:r.value}),{...o,default:a=>{let{id:l,messagesId:r,isDisabled:s,isReadonly:d}=a
return t.createVNode(t.Fragment,null,[c&&t.createVNode(Eo,{id:l.value},{default:()=>[c]}),t.createVNode(Fo,t.mergeProps(u,{id:l.value,"aria-describedby":r.value,defaultsTarget:"VRadio",trueIcon:e.trueIcon,falseIcon:e.falseIcon,type:e.type,disabled:s.value,readonly:d.value,"aria-labelledby":c?l.value:void 0,multiple:!1},n,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e}),o)])}})})),{}}}),Qd=a({...Yo(),...Qo(),...ps(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},"VRangeSlider"),ev=gt()({name:"VRangeSlider",props:Qd(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,end:e=>!0,start:e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=t.ref(),r=t.ref(),i=t.ref(),{rtlClasses:s}=Qt()
const u=fs(e),c=Ht(e,"modelValue",void 0,(e=>e?.length?e.map((e=>u.roundValue(e))):[0,0])),{activeThumbRef:d,hasLabels:v,max:p,min:f,mousePressed:m,onSliderMousedown:g,onSliderTouchstart:h,position:y,trackContainerRef:b}=ms({props:e,steps:u,onSliderStart:()=>{o("start",c.value)},onSliderEnd:t=>{let{value:a}=t
...
const a=vs(t,n.value.$el,e.direction),l=vs(t,r.value.$el,e.direction),o=Math.abs(a),i=Math.abs(l)
return o<i||o===i&&a<0?n.value.$el:r.value.$el}}),{isFocused:V,focus:S,blur:w}=Go(e),k=t.computed((()=>y(c.value[0]))),x=t.computed((()=>y(c.value[1])))
return At((()=>{const a=en.filterProps(e),o=!!(e.label||l.label||l.prepend)
return t.createVNode(en,t.mergeProps({class:["v-slider","v-range-slider",{"v-slider--has-labels":!!l["tick-label"]||v.value,"v-slider--focused":V.value,"v-slider--pressed":m.value,"v-slider--disabled":e.disabled},s,e.class],style:e.style,ref:i},a,{focused:V.value}),{...l,prepend:o?a=>t.createVNode(t.Fragment,null,[l.label?.(a)??(e.label?t.createVNode(Eo,{class:"v-slider__label",text:e.label},null):void 0),l.prepend?.(a)]):void 0,default:a=>{let{id:o,messagesId:i}=a
return t.createVNode("div",{class:"v-slider__container",onMousedown:g,onTouchstartPassive:h},[t.createVNode("input",{id:`${o.value}_start`,name:e.name||o.value,disabled:!!e.disabled,readonly:!!e.readonly,tabindex:"-1",value:c.value[0]},null),t.createVNode("input",{id:`${o.value}_stop`,name:e.name||o.value,disabled:!!e.disabled,readonly:!!e.readonly,tabindex:"-1",value:c.value[1]},null),t.createVNode(bs,{ref:b,start:k.value,stop:x.value},{"tick-label":l["tick-label"]}),t.createVNode(hs,{ref:n,"aria-describedby":i.value,focused:V&&d.value===n.value?.$el,modelValue:c.value[0],"onUpdate:modelValue":e=>c.value=[e,c.value[1]],onFocus:e=>{S(),d.value=n.value?.$el,c.value[0]===c.value[1]&&c.value[1]===f.value&&e.relatedTarget!==r.value?.$el&&(n.value?.$el.blur(),r.value?.$el.focus())},onBlur:()=>{w(),d.value=void 0},min:f.value,max:c.value[1],position:k.value,ripple:e.ripple},{"thumb-label":l["thumb-label"]}),t.createVNode(hs,{ref:r,"aria-describedby":i.value,focused:V&&d.value===r.value?.$el,modelValue:c.value[1],"onUpdate:modelValue":e=>c.value=[c.value[0],e],onFocus:e=>{S(),d.value=r.value?.$el,c.value[0]===c.value[1]&&c.value[0]===p.value&&e.relatedTarget!==n.value?.$el&&(r.value?.$el.blur(),n.value?.$el.focus())},onBlur:()=>{w(),d.value=void 0},min:c.value[0],max:p.value,position:x.value,ripple:e.ripple},{"thumb-label":l["thumb-label"]})])}})})),{}}}),tv=a({name:String,itemAriaLabel:{type:String,default:"$vuetify.rating.ariaLabel.item"},activeColor:String,color:String,clearable:Boolean,disabled:Boolean,emptyIcon:{type:Il,default:"$ratingEmpty"},fullIcon:{type:Il,default:"$ratingFull"},halfIncrements:Boolean,hover:Boolean,length:{type:[Number,String],default:5},readonly:Boolean,modelValue:{type:[Number,String],default:0},itemLabels:Array,itemLabelPosition:{type:String,default:"top",validator:e=>["top","bottom"].includes(e)},ripple:Boolean,...l(),...cl(),...Fl(),...ua(),...ta()},"VRating"),av=gt()({name:"VRating",props:tv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{t:o}=Jt(),{themeClasses:n}=la(e),r=Ht(e,"modelValue"),i=t.computed((()=>E(parseFloat(r.value),0,+e.length))),s=t.computed((()=>g(Number(e.length),1))),u=t.computed((()=>s.value.flatMap((t=>e.halfIncrements?[t-.5,t]:[t])))),c=t.shallowRef(-1),d=t.computed((()=>u.value.map((t=>{const a=e.hover&&c.value>-1,l=i.value>=t,o=c.value>=t,n=(a?o:l)?e.fullIcon:e.emptyIcon,r=e.activeColor??e.color
...
a.includes(",")?t=iv(a):a.includes("@")?t=nv(a):a&&t.push(rv(a))}return[ov(e,t)]}function iv(e){return e.replace(/\s/g,"").split(",").map(rv)}const sv=a({boilerplate:Boolean,color:String,loading:Boolean,loadingText:{type:String,default:"$vuetify.loading"},type:{type:[String,Array],default:"ossein"},...Ma(),...Ja(),...ta()},"VSkeletonLoader"),uv=gt()({name:"VSkeletonLoader",props:sv(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=Za(t.toRef(e,"color")),{dimensionStyles:r}=Fa(e),{elevationClasses:i}=Qa(e),{themeClasses:s}=la(e),{t:u}=Jt(),c=t.computed((()=>rv(T(e.type).join(","))))
...
return u<=n?n=Math.max(u-v,0):c<=d&&(n=Math.min(n-(c-d-v),l-a)),n}const vv=Symbol.for("vuetify:v-slide-group"),pv=a({centerActive:Boolean,direction:{type:String,default:"horizontal"},symbol:{type:null,default:vv},nextIcon:{type:Il,default:"$next"},prevIcon:{type:Il,default:"$prev"},showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||["always","desktop","mobile"].includes(e)},...l(),...wr(),...ua(),...yl({selectedClass:"v-slide-group-item--active"})},"VSlideGroup"),fv=gt()({name:"VSlideGroup",props:pv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{isRtl:n}=Qt(),{displayClasses:r,mobile:i}=kr(e),s=Sl(e,e.symbol),u=t.shallowRef(!1),c=t.shallowRef(0),d=t.shallowRef(0),v=t.shallowRef(0),p=t.computed((()=>"horizontal"===e.direction)),{resizeRef:f,contentRect:m}=Rt(),{resizeRef:g,contentRect:h}=Rt(),y=t.computed((()=>s.selected.value.length?s.items.value.findIndex((e=>e.id===s.selected.value[0])):-1)),b=t.computed((()=>s.selected.value.length?s.items.value.findIndex((e=>e.id===s.selected.value[s.selected.value.length-1])):-1))
if(o){let a=-1
...
return Math.min(l-a,Math.max(0,s))}({selectedElement:t,containerSize:d.value,contentSize:v.value,isRtl:n,isHorizontal:p.value}):u.value&&(c.value=dv({selectedElement:t,containerSize:d.value,contentSize:v.value,isRtl:n,currentScrollOffset:c.value,isHorizontal:p.value})):c.value=0}}))}))}const V=t.shallowRef(!1)
let S=0,w=0
function k(e){const t=p.value?"clientX":"clientY",a=n&&p.value?-1:1
w=a*c.value,S=e.touches[0][t],V.value=!0}function x(e){if(!u.value)return
const t=p.value?"clientX":"clientY",a=n&&p.value?-1:1
...
function I(e){if(_.value=!0,u.value&&g.value)for(const t of e.composedPath())for(const e of g.value.children)if(e===t)return void(c.value=dv({selectedElement:e,containerSize:d.value,contentSize:v.value,isRtl:n,currentScrollOffset:c.value,isHorizontal:p.value}))}function P(e){_.value=!1}function B(e){_.value||e.relatedTarget&&g.value?.contains(e.relatedTarget)||R()}function A(e){g.value&&(p.value?"ArrowRight"===e.key?R(n?"prev":"next"):"ArrowLeft"===e.key&&R(n?"next":"prev"):"ArrowDown"===e.key?R("next"):"ArrowUp"===e.key&&R("prev"),"Home"===e.key?R("first"):"End"===e.key&&R("last"))}function R(e){if(g.value)if(e)if("next"===e){const e=g.value.querySelector(":focus")?.nextElementSibling
...
return At((()=>t.createVNode(e.tag,{class:["v-slide-group",{"v-slide-group--vertical":!p.value,"v-slide-group--has-affixes":M.value,"v-slide-group--is-overflowing":u.value},r.value,e.class],style:e.style,tabindex:_.value||s.selected.value.length?-1:0,onFocus:B},{default:()=>[M.value&&t.createVNode("div",{key:"prev",class:["v-slide-group__prev",{"v-slide-group__prev--disabled":!F.value}],onClick:()=>F.value&&T("prev")},[l.prev?.($.value)??t.createVNode(ka,null,{default:()=>[t.createVNode(zl,{icon:n?e.nextIcon:e.prevIcon},null)]})]),t.createVNode("div",{key:"container",ref:f,class:"v-slide-group__container",onScroll:C},[t.createVNode("div",{ref:g,class:"v-slide-group__content",style:D.value,onTouchstartPassive:k,onTouchmovePassive:x,onTouchendPassive:N,onFocusin:I,onFocusout:P,onKeydown:A},[l.default?.($.value)])]),M.value&&t.createVNode("div",{key:"next",class:["v-slide-group__next",{"v-slide-group__next--disabled":!L.value}],onClick:()=>L.value&&T("next")},[l.next?.($.value)??t.createVNode(ka,null,{default:()=>[t.createVNode(zl,{icon:n?e.prevIcon:e.nextIcon},null)]})])]}))),{selected:s.selected,scrollTo:T,scrollOffset:c,focus:R}}}),mv=gt()({name:"VSlideGroupItem",props:bl(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const l=Vl(e,vv)
return()=>a.default?.({isSelected:l.isSelected.value,select:l.select,toggle:l.toggle,selectedClass:l.selectedClass.value})}})
const gv=a({multiLine:Boolean,text:String,timer:[Boolean,String],timeout:{type:[Number,String],default:5e3},vertical:Boolean,...Yl({location:"bottom"}),...eo(),...el(),...fl(),...ta(),...C($r({transition:"v-snackbar-transition"}),["persistent","noClickAnimation","scrim","scrollStrategy"])},"VSnackbar"),hv=gt()({name:"VSnackbar",props:gv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=Ht(e,"modelValue"),{locationStyles:n}=Gl(e),{positionClasses:r}=to(e),{scopeId:i}=_r(),{themeClasses:s}=la(e),{colorClasses:u,colorStyles:c,variantClasses:d}=ml(e),{roundedClasses:v}=tl(e),p=function(e){const a=t.shallowRef(e)
let l=-1
...
return t.createVNode(Mr,t.mergeProps({ref:f,class:["v-snackbar",{"v-snackbar--active":o.value,"v-snackbar--multi-line":e.multiLine&&!e.vertical,"v-snackbar--timer":!!e.timer,"v-snackbar--vertical":e.vertical},r.value,e.class],style:e.style},a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,contentProps:t.mergeProps({class:["v-snackbar__wrapper",s.value,u.value,v.value,d.value],style:[n.value,c.value],onPointerenter:V,onPointerleave:S},a.contentProps),persistent:!0,noClickAnimation:!0,scrim:!1,scrollStrategy:"none",_disableGlobalStack:!0},i),{default:()=>[pl(!1,"v-snackbar"),e.timer&&t.createVNode("div",{key:"timer",class:"v-snackbar__timer"},[t.createVNode(Kl,{ref:m,active:!g.value,color:"string"==typeof e.timer?e.timer:"info",max:e.timeout,"model-value":p.time.value},null)]),h&&t.createVNode("div",{key:"content",class:"v-snackbar__content",role:"status","aria-live":"polite"},[l.text?.()??e.text,l.default?.()]),l.actions&&t.createVNode($a,{defaults:{VBtn:{variant:"text",ripple:!1,slim:!0}}},{default:()=>[t.createVNode("div",{class:"v-snackbar__actions"},[l.actions()])]})],activator:l.activator})})),Or({},f)}}),yv=a({color:String,disabled:{type:[Boolean,String],default:!1},prevText:{type:String,default:"$vuetify.stepper.prev"},nextText:{type:String,default:"$vuetify.stepper.next"}},"VStepperActions"),bv=gt()({name:"VStepperActions",props:yv(),emits:{"click:prev":()=>!0,"click:next":()=>!0},setup(e,a){let{emit:l,slots:o}=a
const{t:n}=Jt()
function r(){l("click:prev")}function i(){l("click:next")}return At((()=>{const a={onClick:r},l={onClick:i}
return t.createVNode("div",{class:"v-stepper-actions"},[t.createVNode($a,{defaults:{VBtn:{disabled:["prev",!0].includes(e.disabled),text:n(e.prevText),variant:"text"}}},{default:()=>[o.prev?.({props:a})??t.createVNode(No,a,null)]}),t.createVNode($a,{defaults:{VBtn:{color:e.color,disabled:["next",!0].includes(e.disabled),text:n(e.nextText),variant:"tonal"}}},{default:()=>[o.next?.({props:l})??t.createVNode(No,l,null)]})])})),{}}}),Vv=ht("v-stepper-header"),Sv=a({color:String,title:String,subtitle:String,complete:Boolean,completeIcon:{type:String,default:"$complete"},editable:Boolean,editIcon:{type:String,default:"$edit"},error:Boolean,errorIcon:{type:String,default:"$error"},icon:String,ripple:{type:[Boolean,Object],default:!0},rules:{type:Array,default:()=>[]},...bl()},"VStepperItem"),wv=gt()({name:"VStepperItem",directives:{Ripple:ko},props:Sv(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=Vl(e,Iv,!0),n=t.computed((()=>o?.value.value??e.value)),r=t.computed((()=>e.rules.every((e=>!0===e())))),i=t.computed((()=>!e.disabled&&e.editable)),s=t.computed((()=>e.error||!r.value)),u=t.computed((()=>e.complete||e.rules.length>0&&r.value)),c=t.computed((()=>s.value?e.errorIcon:u.value?e.completeIcon:e.editable?e.editIcon:e.icon)),d=t.computed((()=>({canEdit:i.value,hasError:s.value,hasCompleted:u.value,title:e.title,subtitle:e.subtitle,step:n.value,value:e.value})))
return At((()=>{const a=(!o||o.isSelected.value||u.value||i.value)&&!s.value&&!e.disabled,r=!(!e.title&&!l.title),v=!(!e.subtitle&&!l.subtitle)
return t.withDirectives(t.createVNode("button",{class:["v-stepper-item",{"v-stepper-item--complete":u.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":s.value},o?.selectedClass.value],disabled:!e.editable,onClick:function(){o?.toggle()}},[t.createVNode(on,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:a?e.color:void 0,size:24},{default:()=>[l.icon?.(d.value)??(c.value?t.createVNode(zl,{icon:c.value},null):n.value)]}),t.createVNode("div",{class:"v-stepper-item__content"},[r&&t.createVNode("div",{key:"title",class:"v-stepper-item__title"},[l.title?.(d.value)??e.title]),v&&t.createVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[l.subtitle?.(d.value)??e.subtitle]),l.default?.(d.value)])]),[[t.resolveDirective("ripple"),e.ripple&&e.editable,null]])})),{}}}),kv=Symbol.for("vuetify:v-stepper"),xv=a({...C(qi(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),Nv=gt()({name:"VStepperWindow",props:xv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return At((()=>{const a=Ki.filterProps(e)
return t.createVNode(Ki,t.mergeProps({_as:"VStepperWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:"v-stepper-window",mandatory:!1,touch:!1}),l)})),{}}}),Cv=a({...Ji()},"VStepperWindowItem"),_v=gt()({name:"VStepperWindowItem",props:Cv(),setup(e,a){let{slots:l}=a
return At((()=>{const a=Qi.filterProps(e)
return t.createVNode(Qi,t.mergeProps({_as:"VStepperWindowItem"},a,{class:"v-stepper-window-item"}),l)})),{}}}),Iv=Symbol.for("vuetify:v-stepper"),Pv=a({altLabels:Boolean,bgColor:String,editable:Boolean,hideActions:Boolean,items:{type:Array,default:()=>[]},itemTitle:{type:String,default:"title"},itemValue:{type:String,default:"value"},mobile:Boolean,nonLinear:Boolean,flat:Boolean,...yl({mandatory:"force",selectedClass:"v-stepper-item--selected"}),...Ns(),..._(yv(),["prevText","nextText"])},"VStepper"),Bv=gt()({name:"VStepper",props:Pv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{items:o,next:n,prev:r,selected:i}=Sl(e,Iv),{color:s,editable:u,prevText:c,nextText:d}=t.toRefs(e),v=t.computed((()=>e.items.map(((t,a)=>({title:m(t,e.itemTitle,t),value:m(t,e.itemValue,a+1),raw:t}))))),p=t.computed((()=>o.value.findIndex((e=>i.value.includes(e.id)))))
return vt({VStepperItem:{editable:u,prevText:c,nextText:d},VStepperActions:{color:s,disabled:t.computed((()=>e.disabled?e.disabled:0===p.value?"prev":p.value===o.value.length-1&&"next")),prevText:c,nextText:d}}),At((()=>{const a=Cs.filterProps(e),o=!(!l.header&&!e.items.length),i=e.items.length>0,s=!(e.hideActions||!i&&!l.actions)
return t.createVNode(Cs,t.mergeProps(a,{color:e.bgColor,class:["v-stepper",{"v-stepper--alt-labels":e.altLabels,"v-stepper--flat":e.flat,"v-stepper--non-linear":e.nonLinear,"v-stepper--mobile":e.mobile},e.class],style:e.style}),{default:()=>[o&&t.createVNode(Vv,{key:"stepper-header"},{default:()=>[v.value.map(((e,a)=>t.createVNode(t.Fragment,null,[!!a&&t.createVNode(En,null,null),t.createVNode(wv,e,{default:l[`header-item.${e.value}`]??l.header,icon:l.icon,title:l.title,subtitle:l.subtitle})])))]}),i&&t.createVNode(Nv,{key:"stepper-window"},{default:()=>[v.value.map((e=>t.createVNode(_v,{value:e.value},{default:()=>l[`item.${e.value}`]?.(e)??l.item?.(e)})))]}),l.default?.({prev:r,next:n}),s&&(l.actions?.({next:n,prev:r})??t.createVNode(bv,{key:"stepper-actions","onClick:prev":r,"onClick:next":n},l))]})})),{prev:r,next:n}}}),Av=a({indeterminate:Boolean,inset:Boolean,flat:Boolean,loading:{type:[Boolean,String],default:!1},...Qo(),...Lo()},"VSwitch"),Rv=gt()({name:"VSwitch",inheritAttrs:!1,props:Av(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:indeterminate":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const n=Ht(e,"indeterminate"),r=Ht(e,"modelValue"),{loaderClasses:i}=Zl(e),{isFocused:s,focus:u,blur:c}=Go(e),d=t.ref(),v=t.computed((()=>"string"==typeof e.loading&&""!==e.loading?e.loading:e.color)),p=Nt(),f=t.computed((()=>e.id||`switch-${p}`))
function m(){n.value&&(n.value=!1)}function g(e){e.stopPropagation(),e.preventDefault(),d.value?.input?.click()}return At((()=>{const[a,p]=R(l),h=en.filterProps(e),y=Oo.filterProps(e)
return t.createVNode(en,t.mergeProps({class:["v-switch",{"v-switch--inset":e.inset},{"v-switch--indeterminate":n.value},i.value,e.class]},a,h,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,id:f.value,focused:s.value,style:e.style}),{...o,default:a=>{let{id:l,messagesId:i,isDisabled:s,isReadonly:f,isValid:h}=a
return t.createVNode(Oo,t.mergeProps({ref:d},y,{modelValue:r.value,"onUpdate:modelValue":[e=>r.value=e,m],id:l.value,"aria-describedby":i.value,type:"checkbox","aria-checked":n.value?"mixed":void 0,disabled:s.value,readonly:f.value,onFocus:u,onBlur:c},p),{...o,default:e=>{let{backgroundColorClasses:a,backgroundColorStyles:l}=e
...
return t.createVNode(t.Fragment,null,[l,t.createVNode("div",{class:["v-switch__thumb",{"v-switch__thumb--filled":n||e.loading},e.inset?void 0:r.value],style:e.inset?void 0:i.value},[t.createVNode(xa,null,{default:()=>[e.loading?t.createVNode(Jl,{name:"v-switch",active:!0,color:!1===h.value?void 0:v.value},{default:e=>o.loader?o.loader(e):t.createVNode(Wl,{active:e.isActive,color:e.color,indeterminate:!0,size:"16",width:"2"},null)}):n&&t.createVNode(zl,{key:n,icon:n,size:"x-small"},null)]})])])}})}})})),{}}}),Tv=a({color:String,height:[Number,String],window:Boolean,...l(),...Ja(),...$t(),...el(),...ua(),...ta()},"VSystemBar"),Ev=gt()({name:"VSystemBar",props:Tv(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=la(e),{backgroundColorClasses:n,backgroundColorStyles:r}=Za(t.toRef(e,"color")),{elevationClasses:i}=Qa(e),{roundedClasses:s}=tl(e),{ssrBootStyles:u}=rl(),c=t.computed((()=>e.height??(e.window?32:24))),{layoutItemStyles:d}=Ft({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.shallowRef("top"),layoutSize:c,elementSize:c,active:t.computed((()=>!0)),absolute:t.toRef(e,"absolute")})
...
const{textColorClasses:n,textColorStyles:r}=Xa(e,"sliderColor"),i=t.computed((()=>"horizontal"===e.direction)),s=t.shallowRef(!1),u=t.ref(),c=t.ref()
...
return t.createVNode(No,t.mergeProps({symbol:Dv,ref:u,class:["v-tab",e.class],style:e.style,tabindex:s.value?0:-1,role:"tab","aria-selected":String(s.value),active:!1},a,o,{block:e.fixed,maxWidth:e.fixed?300:void 0,"onGroup:selected":d}),{...l,default:()=>t.createVNode(t.Fragment,null,[l.default?.()??e.text,!e.hideSlider&&t.createVNode("div",{ref:c,class:["v-tab__slider",n.value],style:r.value},null)])})})),{}}})
const Fv=a({alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,sliderColor:String,...pv({mandatory:"force"}),...cl(),...ua()},"VTabs"),Lv=gt()({name:"VTabs",props:Fv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=Ht(e,"modelValue"),n=t.computed((()=>{return(t=e.items)?t.map((e=>y(e)?e:{text:e,value:e})):[]
var t})),{densityClasses:r}=dl(e),{backgroundColorClasses:i,backgroundColorStyles:s}=Za(t.toRef(e,"bgColor"))
...
return t.createVNode(fv,t.mergeProps(a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-tabs",`v-tabs--${e.direction}`,`v-tabs--align-tabs-${e.alignTabs}`,{"v-tabs--fixed-tabs":e.fixedTabs,"v-tabs--grow":e.grow,"v-tabs--stacked":e.stacked},r.value,i.value,e.class],style:[{"--v-tabs-height":h(e.height)},s.value,e.style],role:"tablist",symbol:Dv}),{default:()=>[l.default?l.default():n.value.map((e=>t.createVNode(Mv,t.mergeProps(e,{key:e.text}),null)))]})})),{}}}),Ov=a({autoGrow:Boolean,autofocus:Boolean,counter:[Boolean,Number,String],counterValue:Function,prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,noResize:Boolean,rows:{type:[Number,String],default:5,validator:e=>!isNaN(parseFloat(e))},maxRows:{type:[Number,String],validator:e=>!isNaN(parseFloat(e))},suffix:String,modelModifiers:Object,...Qo(),...qr()},"VTextarea"),zv=gt()({name:"VTextarea",directives:{Intersect:Wa},inheritAttrs:!1,props:Ov(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const r=Ht(e,"modelValue"),{isFocused:i,focus:s,blur:u}=Go(e),c=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(r.value):(r.value||"").toString().length)),d=t.computed((()=>l.maxlength?l.maxlength:!e.counter||"number"!=typeof e.counter&&"string"!=typeof e.counter?void 0:e.counter))
...
return t.watchEffect((()=>{e.autoGrow||(N.value=+e.rows)})),t.onMounted(_),t.watch(r,_),t.watch((()=>e.rows),_),t.watch((()=>e.maxRows),_),t.watch((()=>e.density),_),t.watch(x,(e=>{e?(I=new ResizeObserver(_),I.observe(x.value)):I?.disconnect()})),t.onBeforeUnmount((()=>{I?.disconnect()})),At((()=>{const a=!!(n.counter||e.counter||e.counterValue),o=!(!a&&!n.details),[s,h]=R(l),{modelValue:_,...I}=en.filterProps(e),P=Xr(e)
return t.createVNode(en,t.mergeProps({ref:p,modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-textarea v-text-field",{"v-textarea--prefixed":e.prefix,"v-textarea--suffixed":e.suffix,"v-text-field--prefixed":e.prefix,"v-text-field--suffixed":e.suffix,"v-textarea--auto-grow":e.autoGrow,"v-textarea--no-resize":e.noResize||e.autoGrow,"v-input--plain-underlined":C.value},e.class],style:e.style},s,I,{centerAffix:1===N.value&&!C.value,focused:i.value}),{...n,default:a=>{let{id:l,isDisabled:o,isDirty:s,isReadonly:c,isValid:d}=a
return t.createVNode(Kr,t.mergeProps({ref:f,style:{"--v-textarea-control-height":m.value},onClick:V,onMousedown:S,"onClick:clear":w,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"]},P,{id:l.value,active:y.value||s.value,centerAffix:1===N.value&&!C.value,dirty:s.value||e.dirty,disabled:o.value,focused:i.value,error:!1===d.value}),{...n,default:a=>{let{props:{class:l,...n}}=a
return t.createVNode(t.Fragment,null,[e.prefix&&t.createVNode("span",{class:"v-text-field__prefix"},[e.prefix]),t.withDirectives(t.createVNode("textarea",t.mergeProps({ref:g,class:l,value:r.value,onInput:k,autofocus:e.autofocus,readonly:c.value,disabled:o.value,placeholder:e.placeholder,rows:e.rows,name:e.name,onFocus:b,onBlur:u},n,h),null),[[t.resolveDirective("intersect"),{handler:v},null,{once:!0}]]),e.autoGrow&&t.withDirectives(t.createVNode("textarea",{class:[l,"v-textarea__sizer"],id:`${n.id}-sizer`,"onUpdate:modelValue":e=>r.value=e,ref:x,readonly:!0,"aria-hidden":"true"},null),[[t.vModelText,r.value]]),e.suffix&&t.createVNode("span",{class:"v-text-field__suffix"},[e.suffix])])}})},details:o?l=>t.createVNode(t.Fragment,null,[n.details?.(l),a&&t.createVNode(t.Fragment,null,[t.createVNode("span",null,null),t.createVNode(Wr,{active:e.persistentCounter||i.value,value:c.value,max:d.value},n.counter)])]):void 0})})),Or({},p,f,g)}}),jv=a({withBackground:Boolean,...l(),...ta(),...ua()},"VThemeProvider"),Hv=gt()({name:"VThemeProvider",props:jv(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=la(e)
return()=>e.withBackground?t.createVNode(e.tag,{class:["v-theme-provider",o.value,e.class],style:e.style},{default:()=>[l.default?.()]}):l.default?.()}}),Wv=a({align:{type:String,default:"center",validator:e=>["center","start"].includes(e)},direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},justify:{type:String,default:"auto",validator:e=>["auto","center"].includes(e)},side:{type:String,validator:e=>null==e||["start","end"].includes(e)},lineInset:{type:[String,Number],default:0},lineThickness:{type:[String,Number],default:2},lineColor:String,truncateLine:{type:String,validator:e=>["start","end","both"].includes(e)},...l(),...cl(),...ua(),...ta()},"VTimeline"),Uv=gt()({name:"VTimeline",props:Wv(),setup(e,a){let{slots:l}=a
...
case"end":return t[1]
default:return null}}))
return At((()=>t.createVNode(e.tag,{class:["v-timeline",`v-timeline--${e.direction}`,`v-timeline--align-${e.align}`,`v-timeline--justify-${e.justify}`,s.value,{"v-timeline--inset-line":!!e.lineInset},o.value,n.value,i.value,r,e.class],style:[{"--v-timeline-line-thickness":h(e.lineThickness)},e.style]},l))),{}}}),Yv=a({dotColor:String,fillDot:Boolean,hideDot:Boolean,icon:Il,iconColor:String,lineColor:String,...l(),...el(),...Fl(),...Ja()},"VTimelineDivider"),Gv=gt()({name:"VTimelineDivider",props:Yv(),setup(e,a){let{slots:l}=a
const{sizeClasses:o,sizeStyles:n}=Ll(e,"v-timeline-divider__dot"),{backgroundColorStyles:r,backgroundColorClasses:i}=Za(t.toRef(e,"dotColor")),{roundedClasses:s}=tl(e,"v-timeline-divider__dot"),{elevationClasses:u}=Qa(e),{backgroundColorClasses:c,backgroundColorStyles:d}=Za(t.toRef(e,"lineColor"))
return At((()=>t.createVNode("div",{class:["v-timeline-divider",{"v-timeline-divider--fill-dot":e.fillDot},e.class],style:e.style},[t.createVNode("div",{class:["v-timeline-divider__before",c.value],style:d.value},null),!e.hideDot&&t.createVNode("div",{key:"dot",class:["v-timeline-divider__dot",u.value,s.value,o.value],style:n.value},[t.createVNode("div",{class:["v-timeline-divider__inner-dot",i.value,s.value],style:r.value},[l.default?t.createVNode($a,{key:"icon-defaults",disabled:!e.icon,defaults:{VIcon:{color:e.iconColor,icon:e.icon,size:e.size}}},l.default):t.createVNode(zl,{key:"icon",color:e.iconColor,icon:e.icon,size:e.size},null)])]),t.createVNode("div",{class:["v-timeline-divider__after",c.value],style:d.value},null)]))),{}}}),qv=a({density:String,dotColor:String,fillDot:Boolean,hideDot:Boolean,hideOpposite:{type:Boolean,default:void 0},icon:Il,iconColor:String,lineInset:[Number,String],...l(),...Ma(),...Ja(),...el(),...Fl(),...ua()},"VTimelineItem"),Kv=gt()({name:"VTimelineItem",props:qv(),setup(e,a){let{slots:l}=a
const{dimensionStyles:o}=Fa(e),n=t.shallowRef(0),r=t.ref()
return t.watch(r,(e=>{e&&(n.value=e.$el.querySelector(".v-timeline-divider__dot")?.getBoundingClientRect().width??0)}),{flush:"post"}),At((()=>t.createVNode("div",{class:["v-timeline-item",{"v-timeline-item--fill-dot":e.fillDot},e.class],style:[{"--v-timeline-dot-size":h(n.value),"--v-timeline-line-inset":e.lineInset?`calc(var(--v-timeline-dot-size) / 2 + ${h(e.lineInset)})`:h(0)},e.style]},[t.createVNode("div",{class:"v-timeline-item__body",style:o.value},[l.default?.()]),t.createVNode(Gv,{ref:r,hideDot:e.hideDot,icon:e.icon,iconColor:e.iconColor,size:e.size,elevation:e.elevation,dotColor:e.dotColor,fillDot:e.fillDot,rounded:e.rounded},{default:l.icon}),"compact"!==e.density&&t.createVNode("div",{class:"v-timeline-item__opposite"},[!e.hideOpposite&&l.opposite?.()])]))),{}}}),Xv=a({...l(),...fl({variant:"text"})},"VToolbarItems"),Zv=gt()({name:"VToolbarItems",props:Xv(),setup(e,a){let{slots:l}=a
...
return l.default?.(...a)??e.text}})})),Or({},s)}}),ep=gt()({name:"VValidation",props:Zo(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=Jo(e,"validation")
return()=>a.default?.(l)}})
var tp=Object.freeze({__proto__:null,VAlert:Ro,VAlertTitle:Po,VApp:sa,VAppBar:sl,VAppBarNavIcon:_o,VAppBarTitle:Io,VAutocomplete:fi,VAvatar:on,VBadge:gi,VBanner:Si,VBannerActions:yi,VBannerText:bi,VBottomNavigation:ki,VBottomSheet:_i,VBreadcrumbs:Ti,VBreadcrumbsDivider:Pi,VBreadcrumbsItem:Ai,VBtn:No,VBtnGroup:hl,VBtnToggle:Nl,VCard:zi,VCardActions:Ei,VCardItem:Fi,VCardSubtitle:Di,VCardText:Li,VCardTitle:$i,VCarousel:Zi,VCarouselItem:ts,VCheckbox:an,VCheckboxBtn:jo,VChip:cn,VChipGroup:sn,VClassIcon:El,VCode:as,VCol:Sc,VColorPicker:_s,VCombobox:Ps,VComponentIcon:Al,VContainer:pc,VCounter:Wr,VDataIterator:Cu,VDataTable:ic,VDataTableFooter:Bu,VDataTableRow:Zu,VDataTableRows:Qu,VDataTableServer:dc,VDataTableVirtual:uc,VDatePicker:ed,VDatePickerControls:zc,VDatePickerHeader:Hc,VDatePickerMonth:Uc,VDatePickerMonths:Gc,VDatePickerYears:Kc,VDefaultsProvider:$a,VDialog:Ni,VDialogBottomTransition:Sa,VDialogTopTransition:wa,VDialogTransition:ha,VDivider:En,VExpandTransition:Ta,VExpandXTransition:Ea,VExpansionPanel:cd,VExpansionPanelText:rd,VExpansionPanelTitle:sd,VExpansionPanels:od,VFabTransition:Va,VFadeTransition:ka,VField:Kr,VFieldLabel:Yr,VFileInput:vd,VFooter:fd,VForm:gd,VHover:yd,VIcon:zl,VImg:Ya,VInfiniteScroll:Sd,VInput:en,VItem:Nd,VItemGroup:xd,VKbd:Cd,VLabel:Eo,VLayout:Id,VLayoutItem:Bd,VLazy:Rd,VLigatureIcon:Tl,VList:Wn,VListGroup:Cn,VListImg:Un,VListItem:Bn,VListItemAction:Gn,VListItemMedia:Kn,VListItemSubtitle:_n,VListItemTitle:In,VListSubheader:Rn,VLocaleProvider:Ed,VMain:$d,VMenu:jr,VMessages:Uo,VNavigationDrawer:Hd,VNoSsr:Wd,VOtpInput:Yd,VOverlay:Mr,VPagination:Iu,VParallax:qd,VProgressCircular:Wl,VProgressLinear:Kl,VRadio:Xd,VRadioGroup:Jd,VRangeSlider:ev,VRating:av,VResponsive:Oa,VRow:Fc,VScaleTransition:xa,VScrollXReverseTransition:Ca,VScrollXTransition:Na,VScrollYReverseTransition:Ia,VScrollYTransition:_a,VSelect:ui,VSelectionControl:Oo,VSelectionControlGroup:Fo,VSheet:Cs,VSkeletonLoader:uv,VSlideGroup:fv,VSlideGroupItem:mv,VSlideXReverseTransition:Ba,VSlideXTransition:Pa,VSlideYReverseTransition:Ra,VSlideYTransition:Aa,VSlider:Ss,VSnackbar:hv,VSpacer:Lc,VStepper:Bv,VStepperActions:bv,VStepperHeader:Vv,VStepperItem:wv,VStepperWindow:Nv,VStepperWindowItem:_v,VSvgIcon:Rl,VSwitch:Rv,VSystemBar:Ev,VTab:Mv,VTable:tc,VTabs:Lv,VTextField:Qr,VTextarea:zv,VThemeProvider:Hv,VTimeline:Uv,VTimelineItem:Kv,VToolbar:ol,VToolbarItems:Zv,VToolbarTitle:da,VTooltip:Qv,VValidation:ep,VVirtualScroll:ni,VWindow:Ki,VWindowItem:Qi})
...
var sp=Object.freeze({__proto__:null,ClickOutside:Er,Intersect:Wa,Mutate:lp,Resize:op,Ripple:ko,Scroll:ip,Touch:Ui})
function up(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
const{blueprint:a,...l}=e,n=L(a,l),{aliases:r={},components:i={},directives:s={}}=n,u=ct(n.defaults),c=Sr(n.display,n.ssr),d=aa(n.theme),v=$l(n.icons),p=Zt(n.locale),f=fu(n.date,p),m=e=>{for(const t in s)e.directive(t,s[t])
for(const t in i)e.component(t,i[t])
for(const t in r)e.component(t,mt({...r[t],name:t,aliasName:r[t].name}))
if(d.install(e),e.provide(ut,u),e.provide(gr,c),e.provide(ea,d),e.provide(Pl,v),e.provide(Xt,p),e.provide(vu,f.options),e.provide(pu,f.instance),o&&n.ssr)if(e.$nuxt)e.$nuxt.hook("app:suspense:resolve",(()=>{c.update()}))
else{const{mount:a}=e
e.mount=function(){const l=a(...arguments)
return t.nextTick((()=>c.update())),e.mount=a,l}}Nt.reset(),("boolean"!=typeof __VUE_OPTIONS_API__||__VUE_OPTIONS_API__)&&e.mixin({computed:{$vuetify(){return t.reactive({defaults:cp.call(this,ut),display:cp.call(this,gr),theme:cp.call(this,ea),icons:cp.call(this,Pl),locale:cp.call(this,Xt),date:cp.call(this,pu)})}}})}
...
if(a&&e in a)return a[e]}up.version="3.4.3"
const dp=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return up({components:tp,directives:sp,...e})},vp="3.4.3"
...
return l(),a},e.useDisplay=kr,e.useLayout=Mt,e.useLocale=Jt,e.useRtl=Qt,e.useTheme=oa,e.version=vp}))
