...
(function (global, factory) {
  ...
  const VApp = genericComponent()({
    ...
    setup(props, _ref) {
      ...
      useRender(() => vue.createVNode("div", {
        "ref": layoutRef,
        "class": ['v-application', theme.themeClasses.value, layoutClasses.value, rtlClasses, props.class],
        "style": [props.style]
      }, [vue.createVNode("div", {
    ...
    setup(props, _ref) {
      ...
      useRender(() => {
        ...
        return vue.createVNode(props.tag, {
          ...
          }, backgroundColorClasses.value, borderClasses.value, elevationClasses.value, roundedClasses.value, themeClasses.value, rtlClasses, props.class],
  ...
  function useLocation(props) {
    ...
    const locationStyles = vue.computed(() => {
      ...
      const {
        side,
        align
      } = parseAnchor(props.location.split(' ').length > 1 ? props.location : `${props.location} center`, isRtl);
  ...
  const VProgressLinear = genericComponent()({
    ...
    setup(props, _ref) {
      ...
      const isReversed = vue.computed(() => isRtl !== props.reverse);
      ...
      useRender(() => vue.createVNode(props.tag, {
        ...
        }, roundedClasses.value, themeClasses.value, rtlClasses, props.class],
        "style": [{
    ...
    setup(props, _ref) {
      ...
      useRender(() => {
        ...
        return vue.createVNode("div", {
          ...
          }, densityClasses.value, rtlClasses, validationClasses.value, props.class],
          "style": props.style
    ...
    setup(props, _ref) {
      ...
      useRender(() => vue.createVNode(vue.Fragment, null, [slots.activator?.({
        ...
        default: () => [vue.createVNode("div", vue.mergeProps({
          ...
          }, themeClasses.value, rtlClasses, props.class],
    ...
    setup(props, _ref) {
      ...
      useRender(() => {
        ...
        return vue.createVNode("div", vue.mergeProps({
          ...
          }, themeClasses.value, backgroundColorClasses.value, focusClasses.value, loaderClasses.value, roundedClasses.value, rtlClasses, props.class],
          "style": [backgroundColorStyles.value, props.style],
          "onClick": onClick
  ...
  const VWindow = genericComponent()({
    ...
    setup(props, _ref) {
      ...
      const isRtlReverse = vue.computed(() => isRtl ? !props.reverse : props.reverse);
    ...
    setup(props, _ref) {
      ...
      function parseKeydown(e, value) {
        ...
        if ([left, right, down, up].includes(e.key)) {
          const increase = vertical.value ? [isRtl ? left : right, isReversed.value ? down : up] : indexFromEnd.value !== isRtl ? [left, up] : [right, up];
    ...
    setup(props) {
      ...
      useRender(() => {
        ...
        return vue.createVNode(VSheet, vue.mergeProps({
          ...
          "elevation": props.elevation,
          "theme": props.theme,
          "class": ['v-color-picker', rtlClasses, props.class],
          "style": [{
  ...
  const VLocaleProvider = genericComponent()({
    ...
    setup(props, _ref) {
      ...
      useRender(() => vue.createVNode("div", {
        "class": ['v-locale-provider', rtlClasses, props.class],
        "style": props.style
      }, [slots.default?.()]));
      return {};
    }
  ...
  const VNavigationDrawer = genericComponent()({
    ...
    setup(props, _ref) {
      ...
      const location = vue.computed(() => {
        return toPhysical(props.location, isRtl);
      });
  ...
  const VTimeline = genericComponent()({
    ...
    setup(props, _ref) {
      ...
      useRender(() => vue.createVNode(props.tag, {
        ...
        }, themeClasses.value, densityClasses.value, sideClasses.value, rtlClasses, props.class],
        "style": [{
